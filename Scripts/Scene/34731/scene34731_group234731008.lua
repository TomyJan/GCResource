...
monsters = {
	...
	{ config_id = 8002, monster_id = 20011103, pos = { x = -4.986, y = -0.102, z = 9.978 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 8003, monster_id = 20011103, pos = { x = 5.061, y = -0.102, z = 9.892 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 8004, monster_id = 20010702, pos = { x = -2.026, y = -0.102, z = -14.077 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 8005, monster_id = 22010302, pos = { x = 0.006, y = -0.102, z = -9.999 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1026 }, isElite = true },
	{ config_id = 8006, monster_id = 20011103, pos = { x = -0.006, y = -0.102, z = 9.892 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 8017, monster_id = 23010201, pos = { x = 0.006, y = -0.102, z = -10.034 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 6106 }, isElite = true },
	{ config_id = 8018, monster_id = 23010301, pos = { x = -4.986, y = -0.102, z = -10.039 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 8019, monster_id = 23010301, pos = { x = 5.061, y = -0.102, z = -10.126 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true }
}
...
suites = {
	...
	},
	{
		-- suite_id = 2,
		-- description = suite_2,
		monsters = { 8001, 8002, 8003, 8004, 8005, 8006 },
		gadgets = { 8009 },
		regions = { },
...
function action_EVENT_ANY_MONSTER_LIVE_8010(context, evt)
	...
	-- 从234731005的变量TPL_TIME中取出对应值并开启挑战
	  local tpl_time = ScriptLib.GetGroupVariableValueByGroup(context, "TPL_TIME", 234731005)
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 234731008, 9, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
...
function action_EVENT_CHALLENGE_SUCCESS_8012(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 234731005) then
...
function action_EVENT_CHALLENGE_FAIL_8013(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 234731008, suite = 1 }) then
...
function action_EVENT_ANY_MONSTER_DIE_8020(context, evt)
	...
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 234731008, 3)
