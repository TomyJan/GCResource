...
function action_EVENT_GADGET_CREATE_13004(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 245000013, 13001, {4007}) then
...
function action_EVENT_SELECT_OPTION_13005(context, evt)
	-- 删除指定group： 245000013 ；指定config：13001；物件身上指定option：4007；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 245000013, 13001, 4007) then
