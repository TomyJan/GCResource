...
gadgets = {
	...
	[1045] = { config_id = 1045, gadget_id = 70710126, pos = { x = 35.106, y = -7.697, z = -19.723 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	[1046] = { config_id = 1046, gadget_id = 70290167, pos = { x = 34.964, y = -3.992, z = 9.157 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	[1044] = { config_id = 1044, shape = RegionShape.SPHERE, radius = 4, pos = { x = 35.136, y = -7.696, z = -19.843 } }
}

-- 触发器
triggers = {
	{ config_id = 1001044, name = "ENTER_REGION_1044", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_1044", action = "action_EVENT_ENTER_REGION_1044" }
}
...
suites = {
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 1001, 1002, 1004, 1005, 1041, 1042, 1043, 1045, 1046 },
		regions = { 1044 },
		triggers = { "ENTER_REGION_1044" },
		rand_weight = 100
	}
}
...
-- 触发操作
function action_EVENT_ENTER_REGION_1044(context, evt)
		-- 卸载指定gadget
		if 0 ~= ScriptLib.RemoveEntityByConfigId(context, 245000001, EntityType.GADGET, 1045 ) then
