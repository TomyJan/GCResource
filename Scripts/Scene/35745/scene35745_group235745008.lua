...
-- 怪物
monsters = {
	{ config_id = 8001, monster_id = 24010101, pos = { x = 0.051, y = -0.102, z = -5.038 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 100, vision_level = VisionLevelType.VISION_LEVEL_NORMAL },
	{ config_id = 8003, monster_id = 24010101, pos = { x = -6.079, y = -0.102, z = 0.022 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 100, vision_level = VisionLevelType.VISION_LEVEL_NORMAL },
	{ config_id = 8004, monster_id = 24010101, pos = { x = 6.086, y = -0.102, z = 0.022 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 100, vision_level = VisionLevelType.VISION_LEVEL_NORMAL }
}
...
function action_EVENT_ANY_MONSTER_LIVE_8010(context, evt)
	...
	-- 从235745005的变量TPL_TIME中取出对应值并开启挑战
