...
-- 怪物
monsters = {
	{ config_id = 4001, monster_id = 26120301, pos = { x = 0.034, y = -0.102, z = 10.010 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1026 }, isElite = true, pose_id = 101 },
	{ config_id = 4004, monster_id = 26050601, pos = { x = 0.034, y = -0.102, z = -10.047 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 6106 }, isElite = true },
	{ config_id = 4005, monster_id = 26051101, pos = { x = -10.052, y = -0.102, z = -0.120 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4006, monster_id = 26051001, pos = { x = 10.075, y = -0.102, z = -0.141 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4007, monster_id = 26120101, pos = { x = -10.052, y = -0.102, z = -0.120 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 201 },
	{ config_id = 4008, monster_id = 26120201, pos = { x = 10.075, y = -0.102, z = -0.141 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, affix = { 6101 }, isElite = true, pose_id = 201 }
}
