...
-- 装置
gadgets = {
	{ config_id = 11001, gadget_id = 44000006, pos = { x = 319.962, y = 0.350, z = -159.600 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 11002, gadget_id = 70360156, pos = { x = 319.962, y = 0.100, z = -159.817 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
function action_EVENT_GADGET_CREATE_11003(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 247017011, 11002, {7}) then
...
function action_EVENT_SELECT_OPTION_11004(context, evt)
	...
	-- 删除指定group： 247017011 ；指定config：11002；物件身上指定option：7；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 247017011, 11002, 7) then
