...
-- 装置
gadgets = {
	{ config_id = 7001, gadget_id = 44000006, pos = { x = 159.949, y = 0.300, z = 0.426 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7002, gadget_id = 70360156, pos = { x = 159.949, y = 0.050, z = 0.210 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
function action_EVENT_GADGET_CREATE_7003(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 247017007, 7002, {7}) then
...
function action_EVENT_SELECT_OPTION_7004(context, evt)
	...
	-- 删除指定group： 247017007 ；指定config：7002；物件身上指定option：7；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 247017007, 7002, 7) then
