...
gadgets = {
	...
	{ config_id = 37042, gadget_id = 70310154, pos = { x = 35.432, y = 2.232, z = 403.326 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 37043, gadget_id = 70360291, pos = { x = 35.432, y = 2.232, z = 410.688 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
...
regions = {
	...
	{ config_id = 37044, shape = RegionShape.CUBIC, size = { x = 4.500, y = 10.000, z = 10.000 }, pos = { x = 35.432, y = 2.232, z = 408.485 } },
