...
-- 装置
gadgets = {
	{ config_id = 8001, gadget_id = 44000006, pos = { x = 160.082, y = 0.300, z = -79.704 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8002, gadget_id = 70360156, pos = { x = 160.082, y = 0.050, z = -79.920 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
function action_EVENT_GADGET_CREATE_8003(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 247018008, 8002, {7}) then
...
function action_EVENT_SELECT_OPTION_8004(context, evt)
	...
	-- 删除指定group： 247018008 ；指定config：8002；物件身上指定option：7；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 247018008, 8002, 7) then
