...
-- 怪物
monsters = {
	{ config_id = 8003, monster_id = 22010404, pos = { x = 0.004, y = -0.102, z = 9.987 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true, affix = { 6104 }, isElite = true },
	{ config_id = 8007, monster_id = 21020801, pos = { x = -0.015, y = -0.102, z = -10.080 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1027 }, isElite = true }
}
...
function action_EVENT_ANY_MONSTER_LIVE_8002(context, evt)
	...
	-- 从234738005的变量TPL_TIME中取出对应值并开启挑战
