...
-- 装置
gadgets = {
	{ config_id = 3001, gadget_id = 70360010, pos = { x = 0.022, y = -0.450, z = 10.125 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
function action_EVENT_SELECT_OPTION_3003(context, evt)
	...
	-- 删除指定group： 235742003 ；指定config：3001；物件身上指定option：175；
...
function action_EVENT_SELECT_OPTION_3004(context, evt)
	...
	-- 删除指定group： 235742003 ；指定config：3001；物件身上指定option：176；
