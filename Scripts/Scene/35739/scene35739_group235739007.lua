...
-- 怪物
monsters = {
	{ config_id = 7001, monster_id = 23010601, pos = { x = 0.014, y = -0.102, z = 12.993 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1028 }, isElite = true },
	{ config_id = 7002, monster_id = 25310301, pos = { x = 4.013, y = -0.102, z = 9.905 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7003, monster_id = 25310101, pos = { x = -3.998, y = -0.102, z = 9.835 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 1 },
	{ config_id = 7004, monster_id = 23020102, pos = { x = 0.014, y = -0.102, z = -7.005 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 6105 }, isElite = true },
	{ config_id = 7005, monster_id = 25210201, pos = { x = 6.113, y = -0.102, z = -4.001 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7006, monster_id = 25210201, pos = { x = -6.043, y = -0.102, z = -4.071 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true }
}
