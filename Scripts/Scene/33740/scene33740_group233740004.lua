...
-- 怪物
monsters = {
	{ config_id = 4001, monster_id = 24030101, pos = { x = 0.076, y = -0.102, z = 10.101 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true, affix = { 5227 }, pose_id = 101, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE },
	{ config_id = 4004, monster_id = 24030201, pos = { x = -5.080, y = -0.102, z = -9.983 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 4009, monster_id = 24030201, pos = { x = 5.049, y = -0.102, z = -9.993 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 }
}
...
function action_EVENT_CHALLENGE_SUCCESS_4014(context, evt)
	...
	-- 改变指定group组233740003中， configid为3001的gadget的state
