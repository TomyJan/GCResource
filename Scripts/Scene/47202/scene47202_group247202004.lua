...
-- 怪物
monsters = {
	{ config_id = 4006, monster_id = 23010501, pos = { x = 240.310, y = 162.231, z = 447.760 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4007, monster_id = 23010201, pos = { x = 246.270, y = 162.052, z = 448.069 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4008, monster_id = 23020101, pos = { x = 243.099, y = 161.991, z = 447.886 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true }
}
...
function action_EVENT_SELECT_OPTION_4003(context, evt)
	...
	-- 删除指定group： 247202004 ；指定config：4001；物件身上指定option：7；
...
function action_EVENT_VARIABLE_CHANGE_4005(context, evt)
	...
	-- 改变指定group组247202001中， configid为1020的gadget的state
...
function action_EVENT_ANY_MONSTER_DIE_4012(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 247202004, 3)
