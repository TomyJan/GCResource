...
-- 怪物
monsters = {
	{ config_id = 11006, monster_id = 26090801, pos = { x = 181.077, y = 144.022, z = 372.096 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 11007, monster_id = 26090701, pos = { x = 175.606, y = 144.022, z = 366.859 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 11008, monster_id = 26090701, pos = { x = 185.970, y = 144.022, z = 366.877 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 11009, monster_id = 26090101, pos = { x = 181.147, y = 144.022, z = 361.515 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 11010, monster_id = 26090101, pos = { x = 177.039, y = 144.022, z = 362.547 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 11011, monster_id = 26090601, pos = { x = 177.158, y = 144.022, z = 370.804 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 }
}
...
function action_EVENT_GADGET_CREATE_11002(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 247202011, 11001, {7}) then
...
function action_EVENT_SELECT_OPTION_11003(context, evt)
	...
	ScriptLib.AutoMonsterTide(context, 1, defs.group_1, {11006,11007,11008,11009,11010,11011}, 6, 4, 4)
