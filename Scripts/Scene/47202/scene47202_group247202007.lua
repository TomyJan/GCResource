...
-- 装置
gadgets = {
	{ config_id = 7001, gadget_id = 70330407, pos = { x = 181.014, y = 148.512, z = 419.612 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, server_global_value_config = {SGV_BulletType = 2} },
	{ config_id = 7002, gadget_id = 70220103, pos = { x = 181.067, y = 150.751, z = 405.398 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	...
	{ config_id = 7005, gadget_id = 70220103, pos = { x = 180.985, y = 150.776, z = 328.610 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7006, gadget_id = 70220103, pos = { x = 180.978, y = 150.833, z = 292.312 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7008, gadget_id = 70220103, pos = { x = 180.984, y = 152.528, z = 419.612 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7009, gadget_id = 70220103, pos = { x = 181.027, y = 152.464, z = 313.060 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 7011, gadget_id = 70220103, pos = { x = 182.039, y = 150.893, z = 440.904 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
...
suites = {
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 7001, 7002, 7004, 7005, 7006, 7008, 7009, 7011, 7013, 7014 },
		regions = { 7003, 7007 },
