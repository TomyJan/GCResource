...
-- 怪物
monsters = {
	{ config_id = 12006, monster_id = 24040201, pos = { x = 135.660, y = 194.727, z = 362.557 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 11, disableWander = true, affix = { 1007 }, pose_id = 1 },
	{ config_id = 12007, monster_id = 24040301, pos = { x = 135.704, y = 194.752, z = 367.477 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 11, disableWander = true, affix = { 1007 }, pose_id = 1 },
	{ config_id = 12008, monster_id = 24030101, pos = { x = 131.636, y = 194.592, z = 365.124 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 11, disableWander = true, affix = { 1007 }, pose_id = 101 }
}
...
function action_EVENT_SELECT_OPTION_12003(context, evt)
	...
	-- 删除指定group： 247202012 ；指定config：12001；物件身上指定option：7；
