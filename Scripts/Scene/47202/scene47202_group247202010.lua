...
-- 怪物
monsters = {
	{ config_id = 10006, monster_id = 25210302, pos = { x = 334.359, y = 179.017, z = 267.099 }, rot = { x = 0.000, y = 315.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 10007, monster_id = 25210401, pos = { x = 330.972, y = 179.017, z = 263.433 }, rot = { x = 0.000, y = 315.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 10008, monster_id = 25210203, pos = { x = 329.093, y = 179.017, z = 261.827 }, rot = { x = 0.000, y = 315.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 10009, monster_id = 25210502, pos = { x = 332.780, y = 179.017, z = 265.184 }, rot = { x = 0.000, y = 315.000, z = 0.000 }, level = 1, disableWander = true }
}
...
function action_EVENT_GADGET_CREATE_10002(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 247202010, 10001, {7}) then
...
function action_EVENT_SELECT_OPTION_10003(context, evt)
	...
	-- 删除指定group： 247202010 ；指定config：10001；物件身上指定option：7；
