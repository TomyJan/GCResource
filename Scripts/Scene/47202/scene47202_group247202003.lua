...
-- 怪物
monsters = {
	{ config_id = 3006, monster_id = 24010101, pos = { x = 334.309, y = 154.820, z = 365.085 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 100 },
	{ config_id = 3007, monster_id = 24020101, pos = { x = 330.557, y = 154.979, z = 362.135 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 100 },
	{ config_id = 3008, monster_id = 24020201, pos = { x = 330.414, y = 154.820, z = 367.913 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 100 }
}
...
function action_EVENT_SELECT_OPTION_3003(context, evt)
	...
	-- 添加suite2的新内容，刷怪
	    ScriptLib.AddExtraGroupSuite(context, 247202003, 2)
	...
	-- 删除指定group： 247202003 ；指定config：3001；物件身上指定option：7；
...
function action_EVENT_VARIABLE_CHANGE_3005(context, evt)
	...
	-- 改变指定group组247202001中， configid为1019的gadget的state
...
function action_EVENT_ANY_MONSTER_DIE_3009(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 247202003, 3)
