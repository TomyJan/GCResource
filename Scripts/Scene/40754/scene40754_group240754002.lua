...
-- 怪物
monsters = {
	{ config_id = 2001, monster_id = 26090701, pos = { x = 5.337, y = 9.082, z = -3.312 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, pose_id = 101 },
	{ config_id = 2002, monster_id = 26090201, pos = { x = 0.910, y = 9.082, z = -5.101 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, pose_id = 101 },
	{ config_id = 2003, monster_id = 26090201, pos = { x = -2.316, y = 9.082, z = -5.077 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, pose_id = 101 },
	{ config_id = 2004, monster_id = 26090701, pos = { x = -5.081, y = 9.082, z = -3.065 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, pose_id = 101 },
	{ config_id = 2005, monster_id = 26090101, pos = { x = 4.556, y = 9.082, z = 4.639 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, pose_id = 101 },
	{ config_id = 2006, monster_id = 26090201, pos = { x = 1.092, y = 9.082, z = 6.020 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, pose_id = 101 },
	{ config_id = 2007, monster_id = 26090201, pos = { x = -2.078, y = 9.082, z = 5.852 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, pose_id = 101 },
	{ config_id = 2008, monster_id = 26090101, pos = { x = -5.336, y = 9.082, z = 4.514 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, pose_id = 101 },
	{ config_id = 2009, monster_id = 26090401, pos = { x = 5.337, y = 9.082, z = -3.312 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, pose_id = 101 },
	{ config_id = 2010, monster_id = 26090201, pos = { x = 0.910, y = 9.082, z = -5.101 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, pose_id = 101 },
	{ config_id = 2011, monster_id = 26090201, pos = { x = -2.316, y = 9.082, z = -5.077 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, pose_id = 101 },
	{ config_id = 2012, monster_id = 26090401, pos = { x = -5.081, y = 9.082, z = -3.065 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, pose_id = 101 }
}
...
function action_EVENT_CHALLENGE_FAIL_2024(context, evt)
	-- 改变指定group组240754001中， configid为1001的gadget的state
