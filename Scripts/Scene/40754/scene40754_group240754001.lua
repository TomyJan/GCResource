...
-- 装置
gadgets = {
	{ config_id = 1001, gadget_id = 70360010, pos = { x = -0.044, y = 8.821, z = 0.041 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, state = GadgetState.GearStop }
}
...
function action_EVENT_SELECT_OPTION_1004(context, evt)
	...
	-- 删除指定group： 240754001 ；指定config：1001；物件身上指定option：7；
	...
	if 0 ~= ScriptLib.AutoMonsterTide(context, 1, 240754002, {2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012}, 12, 4, 4) then
		return -1
	end
