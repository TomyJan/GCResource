...
-- 怪物
monsters = {
	{ config_id = 3001, monster_id = 21020101, pos = { x = 0.012, y = -0.102, z = -10.058 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1031 } },
	{ config_id = 3002, monster_id = 25070101, pos = { x = -10.129, y = -0.102, z = -3.086 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 3003, monster_id = 21020701, pos = { x = -9.937, y = -0.102, z = 0.000 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 3010, monster_id = 21020201, pos = { x = 10.004, y = -0.102, z = -0.064 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 3011, monster_id = 25210301, pos = { x = 10.034, y = -0.102, z = 0.068 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1031 } },
	{ config_id = 3012, monster_id = 25010601, pos = { x = 9.985, y = -0.102, z = -3.086 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1031 } },
	{ config_id = 3013, monster_id = 25010401, pos = { x = 10.034, y = -0.102, z = 2.923 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1031 } },
	{ config_id = 3018, monster_id = 25010301, pos = { x = 3.003, y = -0.102, z = 9.999 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 3019, monster_id = 25070101, pos = { x = 4.096, y = -0.102, z = -10.061 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 3020, monster_id = 25210401, pos = { x = 0.030, y = -0.102, z = -10.045 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1031 } },
	{ config_id = 3022, monster_id = 25010501, pos = { x = -3.062, y = -0.102, z = 9.969 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 3023, monster_id = 25070101, pos = { x = -4.007, y = -0.102, z = -10.037 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 3027, monster_id = 25310301, pos = { x = -0.017, y = -0.102, z = -10.000 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 3028, monster_id = 25210201, pos = { x = -9.961, y = -0.102, z = -0.022 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 3029, monster_id = 25070101, pos = { x = -10.080, y = -0.102, z = 2.923 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 3030, monster_id = 25210201, pos = { x = 10.048, y = -0.102, z = -0.022 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 3033, monster_id = 21020801, pos = { x = -0.004, y = -0.102, z = 10.088 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1031 } },
	{ config_id = 3042, monster_id = 25210101, pos = { x = 0.022, y = -0.102, z = 10.012 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1031 } }
}
...
suites = {
	...
	},
	{
		-- suite_id = 2,
		-- description = ,
		monsters = { 3018, 3019, 3020, 3022, 3023 },
		gadgets = { 3006, 3024 },
		regions = { },
	...
	},
	{
		-- suite_id = 3,
		-- description = ,
		monsters = { 3002, 3011, 3012, 3013, 3029 },
		gadgets = { 3006, 3024 },
		regions = { },
...
function action_EVENT_ANY_MONSTER_LIVE_3007(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 2, 188, 233739003, 4, 3024, 0) then
...
function action_EVENT_CHALLENGE_SUCCESS_3008(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 1, 233739001) then
	...
	-- 改变指定group组233739002中， configid为2001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 233739002, 2001, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 233739002, 2001, {176}) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_wok_options_by_configid")
		return -1
	end
	
	-- 改变指定group组233739009中， configid为9001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 233739009, 9001, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 改变指定group组233739009中， configid为9002的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 233739009, 9002, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
...
function action_EVENT_CHALLENGE_FAIL_3009(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 233739003, suite = 1 }) then
	...
	-- 改变指定group组233739002中， configid为2001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 233739002, 2001, GadgetState.GearAction2) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
...
function action_EVENT_ANY_MONSTER_LIVE_3015(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 188, 233739003, 14, 3024, 0) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge")
		return -1
	end
...
function action_EVENT_CHALLENGE_SUCCESS_3016(context, evt)
	-- 改变指定group组233739002中， configid为2001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 233739002, 2001, GadgetState.GearAction1) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 将本组内变量名为 "stage" 的变量设置为 2
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 233739001) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	  return -1
	end
...
function action_EVENT_ANY_MONSTER_DIE_3026(context, evt)
	-- 添加suite4的新内容
	    ScriptLib.AddExtraGroupSuite(context, 233739003, 4)
...
function action_EVENT_ANY_MONSTER_DIE_3032(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 233739003, 3)
...
function action_EVENT_ANY_MONSTER_DIE_3035(context, evt)
	-- 添加suite6的新内容
	    ScriptLib.AddExtraGroupSuite(context, 233739003, 6)
