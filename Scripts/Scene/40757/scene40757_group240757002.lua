...
-- 怪物
monsters = {
	{ config_id = 2001, monster_id = 26090101, pos = { x = 5.337, y = 9.082, z = -3.312 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1008 }, pose_id = 101 },
	{ config_id = 2002, monster_id = 26090201, pos = { x = 0.910, y = 9.082, z = -5.101 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1008 }, pose_id = 101 },
	{ config_id = 2003, monster_id = 26090201, pos = { x = -2.316, y = 9.082, z = -5.077 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1008 }, pose_id = 101 },
	{ config_id = 2004, monster_id = 26090101, pos = { x = -5.081, y = 9.082, z = -3.065 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1008 }, pose_id = 101 },
	{ config_id = 2005, monster_id = 26090201, pos = { x = 5.337, y = 9.082, z = -5.502 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1008 }, pose_id = 101 },
	{ config_id = 2006, monster_id = 26120301, pos = { x = 0.910, y = 9.082, z = -7.290 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1008 }, pose_id = 101 },
	{ config_id = 2007, monster_id = 26120301, pos = { x = -0.869, y = 9.082, z = -8.978 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1008 }, pose_id = 101 },
	{ config_id = 2008, monster_id = 26120101, pos = { x = -2.316, y = 9.082, z = -7.267 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1008 }, pose_id = 201 },
	{ config_id = 2009, monster_id = 26090101, pos = { x = -5.081, y = 9.082, z = -5.254 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1008 }, pose_id = 101 }
}
...
suites = {
	...
	},
	{
		-- suite_id = 2,
		-- description = suite_2,
		monsters = { 2001, 2002, 2003, 2004, 2007 },
		gadgets = { 2021 },
		regions = { },
...
function action_EVENT_CHALLENGE_FAIL_2024(context, evt)
	-- 改变指定group组240757001中， configid为1001的gadget的state
