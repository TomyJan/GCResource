...
-- 装置
gadgets = {
	{ config_id = 4002, gadget_id = 70360001, pos = { x = 0.660, y = 0.000, z = 5.666 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, room = 1 }
}

-- 区域
regions = {
	-- 进入乌有亭触发完成
	{ config_id = 4001, shape = RegionShape.SPHERE, radius = 5, pos = { x = 0.304, y = 0.000, z = 7.329 }, room = 1 }
}
