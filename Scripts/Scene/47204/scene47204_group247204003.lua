...
-- 怪物
monsters = {
	{ config_id = 3006, monster_id = 23010101, pos = { x = 330.432, y = 154.979, z = 365.032 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 3007, monster_id = 23010501, pos = { x = 330.130, y = 154.979, z = 361.128 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 3008, monster_id = 23010601, pos = { x = 330.343, y = 154.979, z = 368.705 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true }
}
...
function action_EVENT_SELECT_OPTION_3003(context, evt)
	...
	-- 添加suite2的新内容，刷怪
	    ScriptLib.AddExtraGroupSuite(context, 247204003, 2)
	...
	-- 删除指定group： 247204003 ；指定config：3001；物件身上指定option：7；
...
function action_EVENT_VARIABLE_CHANGE_3005(context, evt)
	...
	-- 改变指定group组247204001中， configid为1019的gadget的state
