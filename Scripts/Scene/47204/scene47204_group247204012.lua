...
-- 怪物
monsters = {
	{ config_id = 12006, monster_id = 24020401, pos = { x = 135.600, y = 194.592, z = 362.655 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 11, disableWander = true, affix = { 1007 }, pose_id = 100 },
	{ config_id = 12007, monster_id = 24020201, pos = { x = 135.600, y = 194.592, z = 367.458 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 11, disableWander = true, affix = { 1007 }, pose_id = 100 },
	{ config_id = 12008, monster_id = 24010301, pos = { x = 130.863, y = 194.592, z = 364.812 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 11, disableWander = true, affix = { 1007 }, pose_id = 100 }
}
...
function action_EVENT_SELECT_OPTION_12003(context, evt)
	...
	-- 添加suite2的新内容，刷怪空气墙
	    ScriptLib.AddExtraGroupSuite(context, 247204012, 2)
	
	-- 删除指定group： 247204012 ；指定config：12001；物件身上指定option：7；
...
function condition_EVENT_VARIABLE_CHANGE_12004(context, evt)
	...
	-- 判断变量"success"为0
	if ScriptLib.GetGroupVariableValueByGroup(context, "success", 247204001) ~= 0 then
			return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_12010(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 247204012, 3)
