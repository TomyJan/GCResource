...
-- 怪物
monsters = {
	{ config_id = 9006, monster_id = 25060101, pos = { x = 323.080, y = 163.189, z = 482.625 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 9007, monster_id = 25060101, pos = { x = 325.820, y = 163.189, z = 482.511 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 9008, monster_id = 25010201, pos = { x = 320.662, y = 163.189, z = 482.195 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 9009, monster_id = 25010201, pos = { x = 328.214, y = 163.189, z = 482.210 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 9010, monster_id = 25070101, pos = { x = 324.593, y = 163.189, z = 484.390 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true }
}
...
function action_EVENT_GADGET_CREATE_9002(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 247204009, 9001, {7}) then
...
function action_EVENT_SELECT_OPTION_9003(context, evt)
	...
	-- 创建编号为1（该怪物潮的识别id)的怪物潮，创建怪物总数为5，场上怪物最少4只，最多4只
	ScriptLib.AutoMonsterTide(context, 1, defs.group_1, {9006,9007,9008,9009,9010}, 5, 4, 4)
	...
	-- 删除指定group： 247204009 ；指定config：9001；物件身上指定option：7；
