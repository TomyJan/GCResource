...
-- 怪物
monsters = {
	{ config_id = 4006, monster_id = 25210303, pos = { x = 239.219, y = 162.354, z = 446.590 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4007, monster_id = 25210201, pos = { x = 247.426, y = 162.354, z = 446.531 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4008, monster_id = 25210402, pos = { x = 241.845, y = 162.354, z = 446.721 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4009, monster_id = 25210501, pos = { x = 244.645, y = 162.406, z = 446.568 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4010, monster_id = 25210101, pos = { x = 238.634, y = 162.354, z = 443.036 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4011, monster_id = 25310101, pos = { x = 248.049, y = 162.354, z = 443.036 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 1 }
}
...
function action_EVENT_SELECT_OPTION_4003(context, evt)
	...
	-- 刷怪
	ScriptLib.AutoMonsterTide(context, 1, defs.group_1, {4006,4007,4008,4009,4010,4011}, 6, 4, 4)
	...
	-- 删除指定group： 247204004 ；指定config：4001；物件身上指定option：7；
...
function action_EVENT_VARIABLE_CHANGE_4005(context, evt)
	...
	-- 改变指定group组247204001中， configid为1020的gadget的state
