...
monsters = {
	...
	{ config_id = 11007, monster_id = 26091001, pos = { x = 175.606, y = 144.022, z = 366.859 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 11008, monster_id = 26091001, pos = { x = 185.970, y = 144.022, z = 366.877 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 11009, monster_id = 26090901, pos = { x = 178.775, y = 144.022, z = 361.515 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 11010, monster_id = 26090901, pos = { x = 183.856, y = 144.022, z = 361.482 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 }
}
...
function action_EVENT_GADGET_CREATE_11002(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 247204011, 11001, {7}) then
