...
-- 怪物
monsters = {
	[1001] = { config_id = 1001, monster_id = 20040402, pos = { x = 0.178, y = 0.073, z = -0.034 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 5232 } },
	[1006] = { config_id = 1006, monster_id = 20040402, pos = { x = 0.178, y = 0.073, z = -0.034 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 5233 } },
	[1007] = { config_id = 1007, monster_id = 20040402, pos = { x = 0.178, y = 0.073, z = -0.034 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 5234 } },
	[1008] = { config_id = 1008, monster_id = 20040402, pos = { x = 0.178, y = 0.073, z = -0.034 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 5214, 5235, 5236 }, isElite = true }
}
...
gadgets = {
	...
	[1009] = { config_id = 1009, gadget_id = 44000456, pos = { x = 0.000, y = 0.000, z = 0.000 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	[1010] = { config_id = 1010, gadget_id = 44000006, pos = { x = 0.197, y = 0.086, z = 17.427 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
function action_EVENT_SELECT_OPTION_1005(context, evt)
	...
	-- 删除指定group： 240061001 ；指定config：1003；物件身上指定option：175；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 240061001, 1003, 175) then
