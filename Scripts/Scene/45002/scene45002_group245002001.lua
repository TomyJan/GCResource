...
gadgets = {
	...
	[1044] = { config_id = 1044, gadget_id = 70290167, pos = { x = 34.964, y = -3.995, z = 8.933 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 }
}
...
suites = {
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 1001, 1002, 1004, 1005, 1041, 1042, 1043, 1044 },
		regions = { },
		triggers = { },
		rand_weight = 100
	}
