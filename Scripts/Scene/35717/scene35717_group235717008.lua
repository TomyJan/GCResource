...
-- 怪物
monsters = {
	{ config_id = 8001, monster_id = 23030102, pos = { x = -4.036, y = -0.102, z = -14.087 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 9002 } },
	{ config_id = 8002, monster_id = 23030102, pos = { x = 4.025, y = -0.102, z = -14.105 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 9002 } },
	{ config_id = 8003, monster_id = 23020102, pos = { x = -4.036, y = -0.102, z = 10.016 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 8004, monster_id = 23020102, pos = { x = 4.025, y = -0.102, z = 9.998 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true }
}
...
-- 触发器
triggers = {
	{ config_id = 1008005, name = "ANY_MONSTER_LIVE_8005", event = EventType.EVENT_ANY_MONSTER_LIVE, source = "", condition = "condition_EVENT_ANY_MONSTER_LIVE_8005", action = "action_EVENT_ANY_MONSTER_LIVE_8005" },
...
suites = {
	...
	},
	{
		...
		gadgets = { 8008 },
		regions = { },
		triggers = { "ANY_MONSTER_LIVE_8005", "ANY_MONSTER_DIE_8009", "CHALLENGE_SUCCESS_8011", "CHALLENGE_FAIL_8012" },
		rand_weight = 100
	},
	{
		-- suite_id = 3,
...
function action_EVENT_ANY_MONSTER_LIVE_8005(context, evt)
	...
	-- 从235717005的变量TPL_TIME中取出对应值并开启挑战
	  local tpl_time = ScriptLib.GetGroupVariableValueByGroup(context, "TPL_TIME", 235717005)
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 235717008, 4, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
...
function action_EVENT_ANY_MONSTER_DIE_8009(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 235717008, 3)
...
function action_EVENT_CHALLENGE_SUCCESS_8011(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 235717005) then
...
function action_EVENT_CHALLENGE_FAIL_8012(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 235717008, suite = 1 }) then
