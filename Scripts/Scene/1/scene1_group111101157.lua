...
local defs = {
	group_ID = 111101157,
	gadget_thunderThelfID = 157001,
	pointarray_ID = 110100041,
	maxPointCount = 14,
	gadget_Reward_1 = 157002,
	pointInfo = {5,10,14} 
}
...
-- 装置
gadgets = {
	{ config_id = 157001, gadget_id = 70350292, pos = { x = 2954.481, y = 268.788, z = -1319.468 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, start_route = false, persistent = true, is_use_point_array = true },
	{ config_id = 157002, gadget_id = 70211121, pos = { x = 2961.228, y = 268.631, z = -1299.536 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "解谜高级蒙德", isOneoff = true, persistent = true },
	{ config_id = 157003, gadget_id = 70350292, pos = { x = 2958.861, y = 268.640, z = -1302.358 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, start_route = false, persistent = true, is_use_point_array = true }
}
...
triggers = {
	...
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1157005, name = "AVATAR_NEAR_PLATFORM_157005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_157005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_157005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 157001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_157004", "AVATAR_NEAR_PLATFORM_157005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			...
			{ config_id = 157003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_157004(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_157005(context, evt)
