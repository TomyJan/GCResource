...
local defs = {
	group_ID = 111101151,
	gadget_thunderThelfID = 151001,
	pointarray_ID = 110100040,
	maxPointCount = 14,
	gadget_Reward_1 = 151002,
	pointInfo = {4,8,12,14} 
}
...
-- 装置
gadgets = {
	{ config_id = 151001, gadget_id = 70350292, pos = { x = 2635.754, y = 252.165, z = -1671.133 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, start_route = false, persistent = true, is_use_point_array = true },
	{ config_id = 151002, gadget_id = 70211121, pos = { x = 2627.061, y = 251.350, z = -1657.507 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 6, drop_tag = "解谜高级蒙德", isOneoff = true, persistent = true },
	{ config_id = 151003, gadget_id = 70350292, pos = { x = 2628.915, y = 251.336, z = -1657.820 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, start_route = false, persistent = true, is_use_point_array = true }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1151004, name = "PLATFORM_REACH_POINT_151004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_151004", action = "action_EVENT_PLATFORM_REACH_POINT_151004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1151005, name = "AVATAR_NEAR_PLATFORM_151005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_151005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_151005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 151001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_151004", "AVATAR_NEAR_PLATFORM_151005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			...
			{ config_id = 151003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_151004(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_151005(context, evt)
