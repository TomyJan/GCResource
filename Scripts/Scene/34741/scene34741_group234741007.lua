...
-- 怪物
monsters = {
	{ config_id = 7001, monster_id = 23010601, pos = { x = 0.032, y = -0.102, z = -10.174 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1028 }, isElite = true },
	{ config_id = 7002, monster_id = 25310101, pos = { x = -6.864, y = -0.102, z = -10.021 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 1 },
	{ config_id = 7003, monster_id = 25310101, pos = { x = 7.069, y = -0.102, z = -10.089 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 1 },
	{ config_id = 7004, monster_id = 25310101, pos = { x = 0.032, y = -0.102, z = 9.972 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1026 }, isElite = true, pose_id = 1 },
	{ config_id = 7005, monster_id = 23010601, pos = { x = -6.864, y = -0.102, z = 10.126 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7006, monster_id = 23010601, pos = { x = 7.069, y = -0.102, z = 10.058 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7021, monster_id = 25210201, pos = { x = -10.019, y = -0.102, z = 0.008 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7022, monster_id = 25210201, pos = { x = 10.017, y = -0.102, z = 0.002 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true }
}
...
suites = {
	...
	},
	{
		-- suite_id = 3,
		-- description = ,
		monsters = { 7004, 7005, 7006, 7021, 7022 },
		gadgets = { 7010 },
		regions = { },
		triggers = { "ANY_MONSTER_DIE_7007", "CHALLENGE_SUCCESS_7014", "CHALLENGE_FAIL_7015" },
		rand_weight = 100
	},
	{
		-- suite_id = 4,
...
function action_EVENT_CHALLENGE_SUCCESS_7014(context, evt)
	...
	-- 改变指定group组234741006中， configid为6001的gadget的state
