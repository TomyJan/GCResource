...
-- 装置
gadgets = {
	{ config_id = 34001, gadget_id = 70350292, pos = { x = 219.622, y = 209.899, z = -315.372 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, start_route = false, persistent = true, is_use_point_array = true, area_id = 210 },
	{ config_id = 34002, gadget_id = 70211160, pos = { x = 193.283, y = 211.790, z = -257.890 }, rot = { x = 0.000, y = 187.765, z = 0.000 }, level = 16, drop_tag = "渊下宫活动低级稻妻", isOneoff = true, persistent = true, area_id = 210 },
	{ config_id = 34003, gadget_id = 70350292, pos = { x = 199.000, y = 210.795, z = -261.174 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, start_route = false, persistent = true, is_use_point_array = true, area_id = 210 }
}
