...
local defs = {
	group_ID = 177008017,
	gadget_thunderThelfID = 17001,
	pointarray_ID = 700800004,
	maxPointCount = 14,
	gadget_Reward_1 = 17002,
	pointInfo = {5,10,13,14} 
}
...
-- 装置
gadgets = {
	{ config_id = 17001, gadget_id = 70350292, pos = { x = -228.735, y = 238.712, z = 358.772 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, start_route = false, persistent = true, is_use_point_array = true, area_id = 210 },
	{ config_id = 17002, gadget_id = 70211160, pos = { x = -320.858, y = 263.212, z = 386.182 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 16, drop_tag = "渊下宫活动低级稻妻", isOneoff = true, persistent = true, area_id = 210 },
	{ config_id = 17003, gadget_id = 70350292, pos = { x = -318.376, y = 263.063, z = 382.829 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, start_route = false, persistent = true, is_use_point_array = true, area_id = 210 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1017004, name = "PLATFORM_REACH_POINT_17004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_17004", action = "action_EVENT_PLATFORM_REACH_POINT_17004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1017005, name = "AVATAR_NEAR_PLATFORM_17005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_17005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_17005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 17001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_17004", "AVATAR_NEAR_PLATFORM_17005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			...
			{ config_id = 17003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_17004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_17004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_17005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_17005(context, evt)
