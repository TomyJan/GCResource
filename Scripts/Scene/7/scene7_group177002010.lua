...
-- 装置
gadgets = {
	{ config_id = 10001, gadget_id = 70350292, pos = { x = 1355.034, y = 180.233, z = 832.692 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, start_route = false, persistent = true, is_use_point_array = true, area_id = 210 },
	{ config_id = 10002, gadget_id = 70211161, pos = { x = 1307.207, y = 229.443, z = 707.905 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 16, drop_tag = "渊下宫活动中级稻妻", isOneoff = true, persistent = true, area_id = 210 },
	{ config_id = 10003, gadget_id = 70350292, pos = { x = 1307.189, y = 228.662, z = 710.188 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, start_route = false, persistent = true, is_use_point_array = true, area_id = 210 }
}
