...
-- 装置
gadgets = {
	{ config_id = 14001, gadget_id = 70350292, pos = { x = -132.477, y = 229.258, z = 224.499 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, start_route = false, persistent = true, is_use_point_array = true, area_id = 210 },
	{ config_id = 14002, gadget_id = 70211160, pos = { x = -173.043, y = 223.125, z = 213.228 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 16, drop_tag = "渊下宫活动低级稻妻", isOneoff = true, persistent = true, area_id = 210 },
	{ config_id = 14003, gadget_id = 70350292, pos = { x = -171.244, y = 223.417, z = 213.291 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, start_route = false, persistent = true, is_use_point_array = true, area_id = 210 }
}
