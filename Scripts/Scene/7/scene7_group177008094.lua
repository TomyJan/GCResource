...
-- 装置
gadgets = {
	{ config_id = 94001, gadget_id = 70290275, pos = { x = -177.341, y = 223.848, z = 211.683 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 36, area_id = 210 }
}

-- 区域
regions = {
	{ config_id = 94002, shape = RegionShape.SPHERE, radius = 2, pos = { x = -177.495, y = 224.028, z = 211.241 }, area_id = 210 }
}
