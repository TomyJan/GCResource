...
local defs = {
	group_ID = 177006099,
	gadget_thunderThelfID = 99001,
	pointarray_ID = 700600025,
	maxPointCount = 16,
	gadget_Reward_1 = 99002,
	pointInfo = {3,5,7,11,14,16} 
}
...
-- 装置
gadgets = {
	{ config_id = 99001, gadget_id = 70350292, pos = { x = 450.229, y = 179.511, z = -191.762 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, start_route = false, persistent = true, is_use_point_array = true, area_id = 210 },
	{ config_id = 99002, gadget_id = 70211160, pos = { x = 409.565, y = 188.705, z = -290.710 }, rot = { x = 0.000, y = 261.956, z = 0.000 }, level = 16, drop_tag = "渊下宫活动低级稻妻", isOneoff = true, persistent = true, area_id = 210 },
	{ config_id = 99003, gadget_id = 70350292, pos = { x = 406.239, y = 190.414, z = -291.593 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, start_route = false, persistent = true, is_use_point_array = true, area_id = 210 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1099004, name = "PLATFORM_REACH_POINT_99004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_99004", action = "action_EVENT_PLATFORM_REACH_POINT_99004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1099005, name = "AVATAR_NEAR_PLATFORM_99005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_99005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_99005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 99001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_99004", "AVATAR_NEAR_PLATFORM_99005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 99002, state = 0 },
			{ config_id = 99003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_99004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_99004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_99005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_99005(context, evt)
