...
-- 装置
gadgets = {
	{ config_id = 94001, gadget_id = 70330152, pos = { x = 479.954, y = 172.730, z = 897.693 }, rot = { x = 4.876, y = 359.582, z = 6.107 }, level = 1, persistent = true, interact_id = 92, arguments = {10}, area_id = 210 }
}

-- 区域
regions = {
	{ config_id = 94002, shape = RegionShape.SPHERE, radius = 8, pos = { x = 477.247, y = 175.428, z = 894.969 }, area_id = 210 }
}
