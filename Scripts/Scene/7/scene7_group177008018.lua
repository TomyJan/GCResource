...
local defs = {
	group_ID = 177008018,
	gadget_thunderThelfID = 18001,
	pointarray_ID = 700800005,
	maxPointCount = 15,
	gadget_Reward_1 = 18002,
	pointInfo = {2,3,5,7,9,11,12,14,15} 
}
...
-- 装置
gadgets = {
	{ config_id = 18001, gadget_id = 70350292, pos = { x = -156.006, y = 242.185, z = 174.766 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, start_route = false, persistent = true, is_use_point_array = true, area_id = 210 },
	{ config_id = 18002, gadget_id = 70211160, pos = { x = -141.684, y = 209.600, z = 211.500 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 16, drop_tag = "渊下宫活动低级稻妻", isOneoff = true, persistent = true, area_id = 210 },
	{ config_id = 18003, gadget_id = 70350292, pos = { x = -141.585, y = 209.600, z = 210.108 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, start_route = false, persistent = true, is_use_point_array = true, area_id = 210 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1018004, name = "PLATFORM_REACH_POINT_18004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_18004", action = "action_EVENT_PLATFORM_REACH_POINT_18004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1018005, name = "AVATAR_NEAR_PLATFORM_18005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_18005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_18005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 18001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_18004", "AVATAR_NEAR_PLATFORM_18005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 18002, state = 0 },
			{ config_id = 18003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_18004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_18004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_18005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_18005(context, evt)
