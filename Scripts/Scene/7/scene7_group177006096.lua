...
local defs = {
	group_ID = 177006096,
	gadget_thunderThelfID = 96001,
	pointarray_ID = 700600022,
	maxPointCount = 7,
	gadget_Reward_1 = 96002,
	pointInfo = {1,3,5,7} 
}
...
-- 装置
gadgets = {
	{ config_id = 96001, gadget_id = 70350292, pos = { x = 125.010, y = 185.616, z = -423.914 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, start_route = false, persistent = true, is_use_point_array = true, area_id = 210 },
	{ config_id = 96002, gadget_id = 70211160, pos = { x = 157.514, y = 200.809, z = -334.136 }, rot = { x = 9.459, y = 249.482, z = 6.450 }, level = 26, drop_tag = "渊下宫活动低级稻妻", isOneoff = true, persistent = true, area_id = 210 },
	{ config_id = 96003, gadget_id = 70350292, pos = { x = 147.666, y = 207.258, z = -338.535 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, start_route = false, persistent = true, is_use_point_array = true, area_id = 210 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1096004, name = "PLATFORM_REACH_POINT_96004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_96004", action = "action_EVENT_PLATFORM_REACH_POINT_96004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1096005, name = "AVATAR_NEAR_PLATFORM_96005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_96005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_96005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 96001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_96004", "AVATAR_NEAR_PLATFORM_96005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 96002, state = 0 },
			{ config_id = 96003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_96004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_96004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_96005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_96005(context, evt)
