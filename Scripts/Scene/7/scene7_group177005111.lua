...
local defs = {
	...
	pointarray_ID = 700500020,
	maxPointCount = 12,
	gadget_Reward_1 = 111002,
	pointInfo = {4,9,12} 
}
...
-- 装置
gadgets = {
	{ config_id = 111001, gadget_id = 70350292, pos = { x = 318.528, y = 163.409, z = 950.820 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, start_route = false, persistent = true, is_use_point_array = true, area_id = 210 },
	{ config_id = 111002, gadget_id = 70211160, pos = { x = 360.239, y = 120.493, z = 957.463 }, rot = { x = 0.000, y = 20.510, z = 0.000 }, level = 16, drop_tag = "渊下宫活动低级稻妻", isOneoff = true, persistent = true, area_id = 210 },
	{ config_id = 111003, gadget_id = 70350292, pos = { x = 356.934, y = 121.367, z = 958.521 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, start_route = false, persistent = true, is_use_point_array = true, area_id = 210 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1111004, name = "PLATFORM_REACH_POINT_111004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_111004", action = "action_EVENT_PLATFORM_REACH_POINT_111004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1111005, name = "AVATAR_NEAR_PLATFORM_111005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_111005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_111005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		...
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_111004", "AVATAR_NEAR_PLATFORM_111005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 111002, state = 0 },
			{ config_id = 111003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_111004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_111004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_111005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_111005(context, evt)
