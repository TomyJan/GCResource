...
-- 装置
gadgets = {
	{ config_id = 4001, gadget_id = 70340014, pos = { x = 0.000, y = 8.600, z = -46.920 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 4002, gadget_id = 70350008, pos = { x = 0.000, y = 11.420, z = -42.300 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
