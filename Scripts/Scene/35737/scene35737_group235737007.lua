...
-- 怪物
monsters = {
	{ config_id = 7001, monster_id = 26120101, pos = { x = -0.032, y = -0.102, z = -10.120 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 201 },
	{ config_id = 7002, monster_id = 26090401, pos = { x = 4.058, y = -0.102, z = -10.120 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 7003, monster_id = 26090401, pos = { x = -3.980, y = -0.102, z = -10.120 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 7004, monster_id = 26120301, pos = { x = -0.032, y = -0.102, z = 10.060 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 7005, monster_id = 26090201, pos = { x = 4.058, y = -0.102, z = 10.060 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 7006, monster_id = 26090201, pos = { x = -3.980, y = -0.102, z = 10.060 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 7007, monster_id = 26090201, pos = { x = 10.074, y = -0.102, z = -0.087 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 7008, monster_id = 26090201, pos = { x = -10.135, y = -0.102, z = -0.022 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 7009, monster_id = 26090401, pos = { x = 10.125, y = -0.102, z = -0.151 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 7012, monster_id = 26090401, pos = { x = -9.987, y = -0.102, z = -0.170 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 }
}
...
suites = {
	...
	},
	{
		-- suite_id = 2,
		-- description = ,
		monsters = { 7001, 7002, 7003, 7007, 7008 },
		gadgets = { 7010 },
		regions = { },
	...
	},
	{
		-- suite_id = 3,
		-- description = ,
		monsters = { 7004, 7005, 7006, 7009, 7012 },
		gadgets = { 7010 },
		regions = { },
