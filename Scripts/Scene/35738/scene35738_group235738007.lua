...
-- 怪物
monsters = {
	{ config_id = 7002, monster_id = 25310101, pos = { x = 0.033, y = -0.102, z = -10.064 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 6106 }, isElite = true, pose_id = 1 },
	{ config_id = 7003, monster_id = 25310201, pos = { x = -9.982, y = -0.102, z = -0.015 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 1 },
	{ config_id = 7004, monster_id = 25310301, pos = { x = 10.048, y = -0.102, z = 0.059 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7005, monster_id = 23010601, pos = { x = 4.092, y = -0.102, z = -12.077 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7006, monster_id = 23010201, pos = { x = -4.060, y = -0.102, z = -12.031 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true }
}
...
suites = {
	...
	},
	{
		-- suite_id = 2,
		-- description = ,
		monsters = { 7002, 7003, 7004, 7005, 7006 },
		gadgets = { 7009 },
		regions = { },
...
function action_EVENT_CHALLENGE_SUCCESS_7011(context, evt)
	...
	-- 改变指定group组235738006中， configid为6001的gadget的state
	...
	-- 改变指定group组235738009中， configid为9001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 235738009, 9001, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 改变指定group组235738009中， configid为9002的gadget的state
