...
-- 怪物
monsters = {
	{ config_id = 8001, monster_id = 23050101, pos = { x = -0.003, y = -0.102, z = -10.063 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1026 }, isElite = true },
	{ config_id = 8002, monster_id = 23030102, pos = { x = -10.087, y = -0.102, z = -0.104 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true, affix = { 9002 } },
	{ config_id = 8003, monster_id = 23030102, pos = { x = 10.023, y = -0.102, z = -0.104 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, affix = { 9002 } }
}
...
function action_EVENT_ANY_MONSTER_LIVE_8005(context, evt)
	...
	-- 从235738005的变量TPL_TIME中取出对应值并开启挑战
