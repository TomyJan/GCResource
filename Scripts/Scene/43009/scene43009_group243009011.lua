...
-- 装置
gadgets = {
	{ config_id = 11001, gadget_id = 70360001, pos = { x = -1.561, y = 41.022, z = -75.359 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 11006, shape = RegionShape.CUBIC, size = { x = 80.000, y = 40.000, z = 35.000 }, pos = { x = -1.247, y = 40.001, z = -77.126 } }
}
...
-- 点位
points = {
	{ config_id = 11007, pos = { x = 6.293, y = 40.049, z = -81.442 }, rot = { x = 0.000, y = 313.018, z = 0.000 } },
	{ config_id = 11008, pos = { x = 9.132, y = 40.000, z = -75.590 }, rot = { x = 0.000, y = 243.269, z = 0.000 } },
	{ config_id = 11009, pos = { x = 3.240, y = 40.072, z = -70.539 }, rot = { x = 0.000, y = 213.064, z = 0.000 } },
	{ config_id = 11010, pos = { x = -8.025, y = 40.000, z = -71.601 }, rot = { x = 0.000, y = 123.863, z = 0.000 } },
	{ config_id = 11011, pos = { x = -9.310, y = 40.001, z = -80.290 }, rot = { x = 0.000, y = 60.213, z = 0.000 } }
}
