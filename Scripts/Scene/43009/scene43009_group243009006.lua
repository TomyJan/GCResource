...
-- 装置
gadgets = {
	{ config_id = 6001, gadget_id = 70360156, pos = { x = 74.540, y = 40.000, z = -76.799 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 6002, gadget_id = 70900205, pos = { x = 81.256, y = 38.651, z = -84.019 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 6007, shape = RegionShape.CUBIC, size = { x = 60.000, y = 40.000, z = 50.000 }, pos = { x = 77.544, y = 40.000, z = -68.830 } }
}
...
-- 点位
points = {
	{ config_id = 6008, pos = { x = 67.699, y = 40.049, z = -83.307 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 6009, pos = { x = 75.578, y = 40.049, z = -85.936 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 6010, pos = { x = 84.853, y = 40.049, z = -79.871 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 6011, pos = { x = 82.062, y = 40.049, z = -66.740 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 6012, pos = { x = 67.975, y = 40.000, z = -66.993 }, rot = { x = 0.000, y = 0.000, z = 0.000 } }
}
