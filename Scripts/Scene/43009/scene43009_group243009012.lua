...
-- 装置
gadgets = {
	{ config_id = 12001, gadget_id = 70360001, pos = { x = 17.955, y = 41.021, z = -3.006 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 12006, shape = RegionShape.CUBIC, size = { x = 70.000, y = 40.000, z = 60.000 }, pos = { x = 17.700, y = 40.008, z = -5.500 } }
}
...
-- 点位
points = {
	{ config_id = 12007, pos = { x = 23.177, y = 40.029, z = -12.494 }, rot = { x = 0.000, y = 336.139, z = 0.000 } },
	{ config_id = 12008, pos = { x = 15.144, y = 40.029, z = -12.580 }, rot = { x = 0.000, y = 10.631, z = 0.000 } },
	{ config_id = 12009, pos = { x = 11.282, y = 40.000, z = 1.026 }, rot = { x = 0.000, y = 116.679, z = 0.000 } },
	{ config_id = 12010, pos = { x = 21.745, y = 40.017, z = 4.467 }, rot = { x = 0.000, y = 212.681, z = 0.000 } },
	{ config_id = 12011, pos = { x = 25.183, y = 40.014, z = -1.804 }, rot = { x = 0.000, y = 265.064, z = 0.000 } },
	{ config_id = 12012, pos = { x = 23.177, y = 40.029, z = -12.494 }, rot = { x = 0.000, y = 336.139, z = 0.000 } },
	{ config_id = 12013, pos = { x = 15.144, y = 40.029, z = -12.580 }, rot = { x = 0.000, y = 10.631, z = 0.000 } },
	{ config_id = 12014, pos = { x = 11.282, y = 40.000, z = 1.026 }, rot = { x = 0.000, y = 116.679, z = 0.000 } },
	{ config_id = 12015, pos = { x = 21.745, y = 40.017, z = 4.467 }, rot = { x = 0.000, y = 212.681, z = 0.000 } },
	{ config_id = 12016, pos = { x = 25.183, y = 40.014, z = -1.804 }, rot = { x = 0.000, y = 265.064, z = 0.000 } }
}
