...
-- 装置
gadgets = {
	{ config_id = 5001, gadget_id = 70360157, pos = { x = -34.748, y = 40.000, z = -27.422 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 5002, gadget_id = 70900205, pos = { x = -27.075, y = 39.754, z = -28.305 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 5006, shape = RegionShape.CUBIC, size = { x = 70.000, y = 40.000, z = 60.000 }, pos = { x = -34.882, y = 40.005, z = -30.750 } }
}
...
-- 点位
points = {
	{ config_id = 5008, pos = { x = -29.557, y = 40.070, z = -21.242 }, rot = { x = 0.000, y = 208.030, z = 0.000 } },
	{ config_id = 5009, pos = { x = -27.636, y = 40.049, z = -33.914 }, rot = { x = 0.000, y = 307.222, z = 0.000 } },
	{ config_id = 5010, pos = { x = -38.593, y = 40.049, z = -36.054 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 5011, pos = { x = -42.584, y = 40.049, z = -28.532 }, rot = { x = 0.000, y = 78.629, z = 0.000 } },
	{ config_id = 5012, pos = { x = -39.996, y = 40.049, z = -21.167 }, rot = { x = 0.000, y = 151.304, z = 0.000 } },
	{ config_id = 5013, pos = { x = -29.557, y = 40.070, z = -21.242 }, rot = { x = 0.000, y = 208.030, z = 0.000 } },
	{ config_id = 5014, pos = { x = -27.636, y = 40.049, z = -33.914 }, rot = { x = 0.000, y = 307.222, z = 0.000 } },
	{ config_id = 5015, pos = { x = -38.593, y = 40.049, z = -36.054 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 5016, pos = { x = -42.584, y = 40.049, z = -28.532 }, rot = { x = 0.000, y = 78.629, z = 0.000 } },
	{ config_id = 5017, pos = { x = -39.996, y = 40.049, z = -21.167 }, rot = { x = 0.000, y = 151.304, z = 0.000 } }
}
