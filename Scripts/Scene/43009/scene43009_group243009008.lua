...
-- 装置
gadgets = {
	{ config_id = 8001, gadget_id = 70360157, pos = { x = 96.924, y = 39.997, z = -4.473 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8002, gadget_id = 70900205, pos = { x = 99.651, y = 34.837, z = 5.467 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 8007, shape = RegionShape.CUBIC, size = { x = 50.000, y = 40.000, z = 45.000 }, pos = { x = 95.413, y = 40.017, z = -5.534 } }
}
...
-- 点位
points = {
	{ config_id = 8008, pos = { x = 99.203, y = 40.065, z = 3.649 }, rot = { x = 0.000, y = 178.335, z = 0.000 } },
	{ config_id = 8009, pos = { x = 88.891, y = 40.000, z = 0.069 }, rot = { x = 0.000, y = 109.555, z = 0.000 } },
	{ config_id = 8010, pos = { x = 89.266, y = 39.999, z = -9.845 }, rot = { x = 0.000, y = 65.176, z = 0.000 } },
	{ config_id = 8011, pos = { x = 104.704, y = 40.049, z = -12.605 }, rot = { x = 0.000, y = 320.033, z = 0.000 } },
	{ config_id = 8012, pos = { x = 109.277, y = 40.049, z = -5.546 }, rot = { x = 0.000, y = 309.778, z = 0.000 } }
}
