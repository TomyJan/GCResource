...
-- 装置
gadgets = {
	{ config_id = 174001, gadget_id = 70590048, pos = { x = -198.926, y = 241.473, z = 192.927 }, rot = { x = 353.585, y = 246.479, z = 0.818 }, level = 36, isOneoff = true, persistent = true, interact_id = 60, area_id = 200 },
	{ config_id = 174002, gadget_id = 70290216, pos = { x = -199.107, y = 241.467, z = 192.929 }, rot = { x = 1.304, y = 355.343, z = 353.666 }, level = 36, area_id = 200 }
}
...
triggers = {
	...
	-- 解除刻印
	{ config_id = 1174005, name = "GADGET_STATE_CHANGE_174005", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_174005", action = "action_EVENT_GADGET_STATE_CHANGE_174005" }
}
...
suites = {
	...
	},
	{
		...
		gadgets = { 174001 },
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_174005" },
		rand_weight = 100
	},
	{
		-- suite_id = 3,
...
function condition_EVENT_GADGET_STATE_CHANGE_174005(context, evt)
	if GadgetState.GearStart ~= ScriptLib.GetGadgetStateByConfigId(context, 155008174, 174001) then
		return false
	end
