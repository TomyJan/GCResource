...
-- 装置
gadgets = {
	{ config_id = 190001, gadget_id = 70360304, pos = { x = -551.410, y = 232.467, z = 455.671 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 36, area_id = 200 }
}
...
triggers = {
	-- 初始化
	{ config_id = 1190002, name = "GROUP_LOAD_190002", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_190002", trigger_count = 0 },
	-- 监听gameplayState变化
	{ config_id = 1190003, name = "VARIABLE_CHANGE_190003", event = EventType.EVENT_VARIABLE_CHANGE, source = "gameplayState", condition = "condition_EVENT_VARIABLE_CHANGE_190003", action = "action_EVENT_VARIABLE_CHANGE_190003", trigger_count = 0 }
}
...
suites = {
	{
		...
		gadgets = { },
		regions = { },
		triggers = { "GROUP_LOAD_190002", "VARIABLE_CHANGE_190003" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发操作
function action_EVENT_GROUP_LOAD_190002(context, evt)
	UpdateGamePlayState(context)
	return 0
end

-- 触发条件
function condition_EVENT_VARIABLE_CHANGE_190003(context, evt)
...
-- 触发操作
function action_EVENT_VARIABLE_CHANGE_190003(context, evt)
	UpdateGamePlayState(context)
	return 0
end
