...
-- 装置
gadgets = {
	{ config_id = 185001, gadget_id = 70590045, pos = { x = 630.213, y = 246.638, z = 763.473 }, rot = { x = 0.000, y = 14.387, z = 0.000 }, level = 36, isOneoff = true, persistent = true, interact_id = 57, area_id = 200 },
	{ config_id = 185002, gadget_id = 70290216, pos = { x = 630.218, y = 246.613, z = 763.500 }, rot = { x = 0.000, y = 64.290, z = 0.000 }, level = 36, area_id = 200 }
}
...
triggers = {
	...
	-- 解除刻印
	{ config_id = 1185005, name = "GADGET_STATE_CHANGE_185005", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_185005", action = "action_EVENT_GADGET_STATE_CHANGE_185005", trigger_count = 0 }
}
...
function condition_EVENT_GADGET_STATE_CHANGE_185005(context, evt)
	if GadgetState.GearStart ~= ScriptLib.GetGadgetStateByConfigId(context, 155005185, 185001) then
		return false
	end
