...
-- 装置
gadgets = {
	{ config_id = 40001, gadget_id = 70360303, pos = { x = 223.844, y = 173.998, z = -418.976 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 36, area_id = 200 }
}
...
triggers = {
	...
	{ config_id = 1040003, name = "VARIABLE_CHANGE_40003", event = EventType.EVENT_VARIABLE_CHANGE, source = "gameplayState", condition = "", action = "action_EVENT_VARIABLE_CHANGE_40003", trigger_count = 0 }
}
...
suites = {
	{
		...
		gadgets = { },
		regions = { },
		triggers = { "GROUP_LOAD_40002", "VARIABLE_CHANGE_40003" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发操作
function action_EVENT_VARIABLE_CHANGE_40003(context, evt)
