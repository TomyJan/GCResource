...
-- 装置
gadgets = {
	{ config_id = 185001, gadget_id = 70590045, pos = { x = -529.553, y = 247.988, z = 452.799 }, rot = { x = 0.000, y = 87.902, z = 0.000 }, level = 36, isOneoff = true, persistent = true, interact_id = 57, area_id = 200 },
	{ config_id = 185002, gadget_id = 70290216, pos = { x = -529.270, y = 248.104, z = 452.815 }, rot = { x = 0.000, y = 137.805, z = 0.000 }, level = 36, area_id = 200 }
}
...
function condition_EVENT_GADGET_STATE_CHANGE_185005(context, evt)
	if GadgetState.GearStart ~= ScriptLib.GetGadgetStateByConfigId(context, 155008185, 185001) then
		return false
	end
