...
-- 怪物
monsters = {
	{ config_id = 153001, monster_id = 24010201, pos = { x = -53.051, y = 167.102, z = 54.184 }, rot = { x = 0.000, y = 236.990, z = 0.000 }, level = 36, drop_tag = "遗迹守卫", disableWander = true, pose_id = 101, area_id = 200 }
}
...
-- 装置
gadgets = {
	{ config_id = 153002, gadget_id = 70211012, pos = { x = -52.873, y = 167.624, z = 49.901 }, rot = { x = 354.154, y = 277.690, z = 3.624 }, level = 16, drop_tag = "战斗中级稻妻", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 200 }
}
