...
-- 装置
gadgets = {
	{ config_id = 181001, gadget_id = 70590044, pos = { x = 620.985, y = 246.759, z = 780.298 }, rot = { x = 0.000, y = 108.482, z = 0.000 }, level = 36, isOneoff = true, persistent = true, interact_id = 56, area_id = 200 },
	{ config_id = 181002, gadget_id = 70290216, pos = { x = 621.011, y = 246.734, z = 780.291 }, rot = { x = 0.000, y = 158.385, z = 0.000 }, level = 36, area_id = 200 }
}
...
triggers = {
	...
	-- 解除刻印
	{ config_id = 1181005, name = "GADGET_STATE_CHANGE_181005", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_181005", action = "action_EVENT_GADGET_STATE_CHANGE_181005", trigger_count = 0 }
}
...
function condition_EVENT_GADGET_STATE_CHANGE_181005(context, evt)
	if GadgetState.GearStart ~= ScriptLib.GetGadgetStateByConfigId(context, 155005181, 181001) then
		return false
	end
