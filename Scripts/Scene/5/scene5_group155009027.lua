...
ScriptLib.KillEntityByConfigId(context, { config_id = defs.gadget_fire })
		...
		ScriptLib.AddQuestProgress(context, "72270_BattleWin_03")
	end
...
-- 装置
gadgets = {
	{ config_id = 27001, gadget_id = 70360343, pos = { x = -757.162, y = 148.753, z = -240.515 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 36, state = GadgetState.GearStart, persistent = true, is_use_point_array = true, area_id = 200 },
	{ config_id = 27002, gadget_id = 70360001, pos = { x = -757.162, y = 148.753, z = -240.515 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 36, area_id = 200 }
}
...
function action_EVENT_SELECT_OPTION_27003(context, evt)
	-- 删除指定group： 155009027 ；指定config：27002；物件身上指定option：91；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 155009027, 27002, 91) then
