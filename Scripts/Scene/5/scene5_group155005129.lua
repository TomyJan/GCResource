...
-- 装置
gadgets = {
	{ config_id = 129001, gadget_id = 70290293, pos = { x = 454.446, y = 137.759, z = 916.308 }, rot = { x = 0.000, y = 208.140, z = 0.000 }, level = 36, area_id = 200 },
	{ config_id = 129002, gadget_id = 70710010, pos = { x = 360.580, y = 145.097, z = 875.135 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 36, route_id = 500500027, area_id = 200 },
	{ config_id = 129003, gadget_id = 70710007, pos = { x = 452.732, y = 137.782, z = 915.566 }, rot = { x = 0.000, y = 244.597, z = 0.000 }, level = 36, area_id = 200 },
	{ config_id = 129004, gadget_id = 70211101, pos = { x = 454.426, y = 137.799, z = 913.093 }, rot = { x = 3.238, y = 259.899, z = 358.927 }, level = 16, drop_tag = "解谜低级稻妻", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 200 }
}

-- 区域
regions = {
	{ config_id = 129007, shape = RegionShape.SPHERE, radius = 3, pos = { x = 360.716, y = 144.507, z = 875.332 }, area_id = 200 }
}
...
function action_EVENT_ENTER_REGION_129007(context, evt)
	-- 设置移动平台路径
	if 0 ~= ScriptLib.SetPlatformRouteId(context, 129002, 500500026) then
...
function action_EVENT_GADGET_STATE_CHANGE_129008(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 155005129, 2) then
