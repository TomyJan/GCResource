...
-- 装置
gadgets = {
	{ config_id = 176001, gadget_id = 70290293, pos = { x = 360.347, y = 301.708, z = 307.779 }, rot = { x = 0.000, y = 44.514, z = 0.000 }, level = 36, area_id = 200 },
	{ config_id = 176002, gadget_id = 70710010, pos = { x = 319.526, y = 287.982, z = 423.904 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 36, route_id = 500500055, area_id = 200 },
	{ config_id = 176003, gadget_id = 70710007, pos = { x = 360.803, y = 302.029, z = 309.456 }, rot = { x = 0.000, y = 15.327, z = 0.000 }, level = 36, area_id = 200 },
	{ config_id = 176004, gadget_id = 70211101, pos = { x = 362.362, y = 301.699, z = 308.931 }, rot = { x = 0.000, y = 4.858, z = 0.000 }, level = 16, drop_tag = "解谜低级稻妻", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 200 }
}

-- 区域
regions = {
	{ config_id = 176007, shape = RegionShape.SPHERE, radius = 5, pos = { x = 319.395, y = 287.898, z = 423.889 }, area_id = 200 }
}
...
function action_EVENT_ENTER_REGION_176007(context, evt)
	-- 设置移动平台路径
	if 0 ~= ScriptLib.SetPlatformRouteId(context, 176002, 500500054) then
...
function action_EVENT_GADGET_STATE_CHANGE_176008(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 155005176, 2) then
