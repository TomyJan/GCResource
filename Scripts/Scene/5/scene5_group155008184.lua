...
-- 装置
gadgets = {
	{ config_id = 184001, gadget_id = 70590044, pos = { x = -522.551, y = 246.978, z = 439.546 }, rot = { x = 0.000, y = 0.384, z = 0.000 }, level = 36, isOneoff = true, persistent = true, interact_id = 56, area_id = 200 },
	{ config_id = 184002, gadget_id = 70290216, pos = { x = -522.586, y = 247.153, z = 439.810 }, rot = { x = 0.000, y = 50.287, z = 0.000 }, level = 36, area_id = 200 }
}
...
function condition_EVENT_GADGET_STATE_CHANGE_184005(context, evt)
	if GadgetState.GearStart ~= ScriptLib.GetGadgetStateByConfigId(context, 155008184, 184001) then
		return false
	end
