...
-- 装置
gadgets = {
	{ config_id = 136001, gadget_id = 70290293, pos = { x = -546.314, y = 217.968, z = 531.130 }, rot = { x = 0.000, y = 173.605, z = 0.000 }, level = 36, area_id = 200 },
	{ config_id = 136002, gadget_id = 70710010, pos = { x = -506.143, y = 225.148, z = 507.910 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 36, route_id = 500800033, area_id = 200 },
	{ config_id = 136003, gadget_id = 70710007, pos = { x = -546.270, y = 219.066, z = 531.014 }, rot = { x = 0.000, y = 126.035, z = 0.000 }, level = 36, area_id = 200 },
	{ config_id = 136004, gadget_id = 70211101, pos = { x = -549.757, y = 217.911, z = 527.520 }, rot = { x = 0.000, y = 104.754, z = 0.000 }, level = 21, drop_tag = "解谜低级稻妻", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 200 }
}

-- 区域
regions = {
	{ config_id = 136007, shape = RegionShape.SPHERE, radius = 4, pos = { x = -506.035, y = 224.804, z = 509.881 }, area_id = 200 }
}
...
function action_EVENT_ENTER_REGION_136007(context, evt)
	-- 设置移动平台路径
	if 0 ~= ScriptLib.SetPlatformRouteId(context, 136002, 500800032) then
...
function action_EVENT_GADGET_STATE_CHANGE_136008(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 155008136, 2) then
