...
-- 装置
gadgets = {
	{ config_id = 86001, gadget_id = 70211101, pos = { x = -146.818, y = 197.782, z = 1550.627 }, rot = { x = 358.132, y = 263.146, z = 358.287 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 200 },
