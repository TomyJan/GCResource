...
triggers = {
	-- 初始化
	{ config_id = 1200001, name = "GROUP_LOAD_200001", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_200001", trigger_count = 0 },
	-- 监听gameplayState变化
	{ config_id = 1200002, name = "VARIABLE_CHANGE_200002", event = EventType.EVENT_VARIABLE_CHANGE, source = "gameplayState", condition = "condition_EVENT_VARIABLE_CHANGE_200002", action = "action_EVENT_VARIABLE_CHANGE_200002", trigger_count = 0 }
}
...
suites = {
	{
		...
		gadgets = { },
		regions = { },
		triggers = { "GROUP_LOAD_200001", "VARIABLE_CHANGE_200002" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发操作
function action_EVENT_GROUP_LOAD_200001(context, evt)
	UpdateGamePlayState(context)
	return 0
end

-- 触发条件
function condition_EVENT_VARIABLE_CHANGE_200002(context, evt)
...
-- 触发操作
function action_EVENT_VARIABLE_CHANGE_200002(context, evt)
	UpdateGamePlayState(context)
	return 0
end
