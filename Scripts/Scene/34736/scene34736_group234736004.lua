...
-- 怪物
monsters = {
	{ config_id = 4009, monster_id = 20040501, pos = { x = 0.085, y = -0.102, z = -0.088 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true }
}
...
-- 装置
gadgets = {
	{ config_id = 4001, gadget_id = 70350356, pos = { x = 0.000, y = 0.000, z = 0.000 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, mark_flag = 12 },
	{ config_id = 4002, gadget_id = 70350356, pos = { x = -6.700, y = -0.102, z = 10.038 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, mark_flag = 3 },
	{ config_id = 4004, gadget_id = 70350356, pos = { x = 6.700, y = -0.102, z = 10.038 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, mark_flag = 4 },
	{ config_id = 4005, gadget_id = 70350356, pos = { x = -6.700, y = -0.102, z = -9.536 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, mark_flag = 5 },
	{ config_id = 4006, gadget_id = 70350356, pos = { x = 6.700, y = -0.102, z = -9.536 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, mark_flag = 6 },
	{ config_id = 4007, gadget_id = 70350356, pos = { x = -15.500, y = 0.000, z = 0.000 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, mark_flag = 7 },
	{ config_id = 4008, gadget_id = 70350356, pos = { x = 15.500, y = 0.000, z = 0.000 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, mark_flag = 8 },
...
suites = {
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 4001, 4002, 4004, 4005, 4006, 4007, 4008, 4010 },
		regions = { },
		triggers = { },
		rand_weight = 100
	},
...
function action_EVENT_CHALLENGE_SUCCESS_4014(context, evt)
	...
	-- 改变指定group组234736003中， configid为3001的gadget的state
	...
	-- 改变指定group组234736001中， configid为1001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 234736001, 1001, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 改变指定group组234736001中， configid为1002的gadget的state
