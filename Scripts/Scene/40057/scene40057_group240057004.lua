...
-- 怪物
monsters = {
	[4001] = { config_id = 4001, monster_id = 20040402, pos = { x = 0.181, y = 0.000, z = 0.000 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true }
}
...
gadgets = {
	...
	[4009] = { config_id = 4009, gadget_id = 44000006, pos = { x = 0.173, y = 0.000, z = 20.294 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	[4013] = { config_id = 4013, shape = RegionShape.SPHERE, radius = 35, pos = { x = 0.000, y = 0.079, z = 0.000 } }
}
