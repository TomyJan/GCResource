...
local defs = {
        ...
        gallery_id = 29024,  --对应gallery的id
        recovergadget_id = 2009,   --恢复gadget的id
        battle_region_id = 2002, --td region的id
...
-- 怪物
monsters = {
	[2001] = { config_id = 2001, monster_id = 22010303, pos = { x = 0.156, y = 0.079, z = -8.683 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 6106 }, isElite = true },
	[2003] = { config_id = 2003, monster_id = 22020102, pos = { x = -2.694, y = 0.077, z = -5.826 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	[2004] = { config_id = 2004, monster_id = 21020202, pos = { x = -8.651, y = 0.146, z = 0.291 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true },
	[2021] = { config_id = 2021, monster_id = 21010902, pos = { x = 8.818, y = 0.080, z = -2.944 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true },
	[2024] = { config_id = 2024, monster_id = 21010902, pos = { x = 8.818, y = 0.080, z = 2.892 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true },
	[2025] = { config_id = 2025, monster_id = 22020102, pos = { x = 3.111, y = 0.078, z = -5.774 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 }
}
...
gadgets = {
	...
	[2009] = { config_id = 2009, gadget_id = 44000006, pos = { x = 0.173, y = 0.000, z = 20.294 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	[2002] = { config_id = 2002, shape = RegionShape.SPHERE, radius = 35, pos = { x = 0.000, y = 0.079, z = 0.000 } }
}
...
function action_EVENT_SELECT_OPTION_2011(context, evt)
	...
	-- 删除指定group： 240057002 ；指定config：2007；物件身上指定option：175；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 240057002, 2007, 175) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : del_work_options_by_group_configId")
		return -1
	end
	
	-- 添加suite4的新内容
	    ScriptLib.AddExtraGroupSuite(context, 240057002, 4)
