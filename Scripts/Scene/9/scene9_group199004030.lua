...
-- 装置
gadgets = {
	{ config_id = 30002, gadget_id = 70360001, pos = { x = -310.337, y = 120.000, z = -597.994 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 20, area_id = 400 }
}

-- 区域
regions = {
	{ config_id = 30001, shape = RegionShape.SPHERE, radius = 150, pos = { x = -156.514, y = 120.000, z = -466.779 }, area_id = 401 }
}

-- 触发器
triggers = {
	{ config_id = 1030001, name = "ENTER_REGION_30001", event = EventType.EVENT_ENTER_REGION, source = "", condition = "", action = "action_EVENT_ENTER_REGION_30001" }
}
