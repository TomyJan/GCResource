...
-- 装置
gadgets = {
	{ config_id = 115002, gadget_id = 70360001, pos = { x = -254.713, y = 120.000, z = 574.973 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 20, area_id = 403 }
}

-- 区域
regions = {
	{ config_id = 115001, shape = RegionShape.SPHERE, radius = 20, pos = { x = -257.500, y = 120.000, z = 573.513 }, area_id = 403 }
}

-- 触发器
triggers = {
	{ config_id = 1115001, name = "ENTER_REGION_115001", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_115001", action = "action_EVENT_ENTER_REGION_115001" }
}
