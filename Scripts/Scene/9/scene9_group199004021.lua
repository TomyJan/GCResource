...
-- 装置
gadgets = {
	{ config_id = 21002, gadget_id = 70360001, pos = { x = -345.786, y = 120.000, z = -182.566 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, area_id = 403 }
}
...
function action_EVENT_ENTER_REGION_21001(context, evt)
	...
	if 0 ~= ScriptLib.AddQuestProgress(context, "7902712finished") then
	...
	if 0 ~= ScriptLib.ShowReminderRadius(context, 1111000, pos, 40) then
