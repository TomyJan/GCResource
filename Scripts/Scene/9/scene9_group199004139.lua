...
-- 装置
gadgets = {
	{ config_id = 139002, gadget_id = 70360001, pos = { x = -66.595, y = 120.000, z = -647.124 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 20, area_id = 401 }
}

-- 区域
regions = {
	{ config_id = 139001, shape = RegionShape.SPHERE, radius = 45, pos = { x = -62.088, y = 120.000, z = -644.425 }, area_id = 401 }
}

-- 触发器
triggers = {
	{ config_id = 1139001, name = "ENTER_REGION_139001", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_139001", action = "action_EVENT_ENTER_REGION_139001" }
}
...
-- 触发条件
function condition_EVENT_ENTER_REGION_139001(context, evt)
	if evt.param1 ~= 139001 then return false end
...
-- 触发操作
function action_EVENT_ENTER_REGION_139001(context, evt)
	local rmd_id = LF_GetRandomResult(context, defs.rmd_list)
	-- 在指定位置对应半径范围播放reminder
	local pos = {x=-62,y=120,z=-644}
