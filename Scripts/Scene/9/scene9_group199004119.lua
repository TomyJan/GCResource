...
-- 装置
gadgets = {
	{ config_id = 119002, gadget_id = 70360001, pos = { x = -138.669, y = 120.000, z = -879.439 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 20, area_id = 400 }
}

-- 区域
regions = {
	{ config_id = 119001, shape = RegionShape.SPHERE, radius = 20, pos = { x = -136.907, y = 120.000, z = -878.374 }, area_id = 400 }
}
...
function action_EVENT_ENTER_REGION_119001(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 199004119, 2) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : goto_groupSuite")
		return -1
	end
	
	-- 在指定位置对应半径范围播放reminder
	local pos = {x=-136.9,y=120,z=-878}
