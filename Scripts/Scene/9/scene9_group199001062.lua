...
-- 装置
gadgets = {
	{ config_id = 62002, gadget_id = 70360001, pos = { x = 141.371, y = 120.000, z = 17.500 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 20, area_id = 402 }
}

-- 区域
regions = {
	{ config_id = 62001, shape = RegionShape.SPHERE, radius = 40, pos = { x = 144.395, y = 120.000, z = 15.712 }, area_id = 402 }
}
