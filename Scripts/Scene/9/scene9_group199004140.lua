...
-- 装置
gadgets = {
	{ config_id = 140002, gadget_id = 70360001, pos = { x = -70.678, y = 120.000, z = -633.515 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 20, area_id = 401 }
}

-- 区域
regions = {
	{ config_id = 140001, shape = RegionShape.SPHERE, radius = 5, pos = { x = -68.893, y = 120.000, z = -632.469 }, area_id = 401 }
}

-- 触发器
triggers = {
	{ config_id = 1140001, name = "ENTER_REGION_140001", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_140001", action = "action_EVENT_ENTER_REGION_140001", trigger_count = 0 }
}
...
-- 触发条件
function condition_EVENT_ENTER_REGION_140001(context, evt)
	if evt.param1 ~= 140001 then return false end
...
-- 触发操作
function action_EVENT_ENTER_REGION_140001(context, evt)
	local rmd_id = LF_GetRandomResult(context, defs.rmd_list)
	-- 在指定位置对应半径范围播放reminder
	local pos = {x=-69,y=120,z=-632}
