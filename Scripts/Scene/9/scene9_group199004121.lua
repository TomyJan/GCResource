...
-- 装置
gadgets = {
	{ config_id = 121002, gadget_id = 70360001, pos = { x = -566.814, y = 120.000, z = -311.904 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 20, area_id = 400 }
}

-- 区域
regions = {
	{ config_id = 121001, shape = RegionShape.SPHERE, radius = 20, pos = { x = -569.801, y = 120.000, z = -308.351 }, area_id = 400 }
}

-- 触发器
triggers = {
	{ config_id = 1121001, name = "ENTER_REGION_121001", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_121001", action = "action_EVENT_ENTER_REGION_121001" }
}
