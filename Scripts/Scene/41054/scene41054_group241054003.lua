...
-- 怪物
monsters = {
	{ config_id = 3001, monster_id = 21010201, pos = { x = 2.646, y = 0.019, z = -7.519 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210, disableWander = true },
	{ config_id = 3002, monster_id = 21010201, pos = { x = -2.500, y = 0.020, z = -7.485 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210, disableWander = true },
	...
	{ config_id = 3005, monster_id = 21010201, pos = { x = 3.336, y = 0.019, z = -7.406 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210, disableWander = true },
	...
	{ config_id = 3007, monster_id = 21010201, pos = { x = -3.210, y = 0.020, z = -7.372 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210, disableWander = true },
	...
	{ config_id = 3011, monster_id = 20011301, pos = { x = 0.161, y = 0.021, z = -7.793 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210, disableWander = true },
	{ config_id = 3014, monster_id = 21010501, pos = { x = -0.819, y = 0.019, z = -7.730 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210, disableWander = true, pose_id = 32 },
	...
	{ config_id = 3020, monster_id = 21010501, pos = { x = 1.227, y = 0.019, z = -7.730 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210, disableWander = true, pose_id = 32 },
	{ config_id = 3026, monster_id = 21020201, pos = { x = 0.192, y = 0.019, z = -10.092 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210, disableWander = true },
	{ config_id = 3027, monster_id = 21020201, pos = { x = 0.088, y = 0.019, z = -7.406 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 11010210, disableWander = true }
}
...
triggers = {
	...
	{ config_id = 1003029, name = "ANY_MONSTER_DIE_3029", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_3029", action = "action_EVENT_ANY_MONSTER_DIE_3029", trigger_count = 0 }
}
...
function action_EVENT_ANY_MONSTER_DIE_3010(context, evt)
	-- 添加suite4的新内容
	    ScriptLib.AddExtraGroupSuite(context, 241054003, 4)
...
function action_EVENT_ANY_MONSTER_DIE_3012(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 241054003, 3)
...
function action_EVENT_ANY_MONSTER_DIE_3013(context, evt)
	-- 添加suite5的新内容
	    ScriptLib.AddExtraGroupSuite(context, 241054003, 5)
...
function action_EVENT_ANY_MONSTER_LIVE_3022(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 1, 241054003, 19, 0, 0) then
...
function action_EVENT_CHALLENGE_SUCCESS_3023(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 1, 241054001) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	  return -1
	end
	
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 241054002, suite = 1 }) then
...
function action_EVENT_CHALLENGE_FAIL_3024(context, evt)
		...
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 241054003, suite = 1 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
			return -1
		end
...
function condition_EVENT_MONSTER_TIDE_DIE_3025(context, evt)
	...
	-- 判断变量"stage"为1
	if ScriptLib.GetGroupVariableValueByGroup(context, "stage", 241054001) ~= 1 then
			return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_3028(context, evt)
	-- 创建编号为1（该怪物潮的识别id)的怪物潮，创建怪物总数为5，场上怪物最少5只，最多5只
	if 0 ~= ScriptLib.AutoMonsterTide(context, 1, 241054003, {3017,3015,3016,3018,3019}, 5, 5, 5) then
		return -1
	end
...
function action_EVENT_ANY_MONSTER_DIE_3029(context, evt)
	-- 添加suite6的新内容
	    ScriptLib.AddExtraGroupSuite(context, 241054003, 6)
