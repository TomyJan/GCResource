...
-- 装置
gadgets = {
	{ config_id = 191001, gadget_id = 70710006, pos = { x = -1022.400, y = 245.782, z = 3425.577 }, rot = { x = 0.000, y = 233.242, z = 0.000 }, level = 30, area_id = 23 },
	{ config_id = 191002, gadget_id = 70710010, pos = { x = -1083.095, y = 268.060, z = 3383.122 }, rot = { x = 0.000, y = 177.053, z = 0.000 }, level = 30, route_id = 330300019, area_id = 23 },
	{ config_id = 191003, gadget_id = 70710007, pos = { x = -1024.364, y = 247.616, z = 3423.100 }, rot = { x = 26.637, y = 41.933, z = 0.000 }, level = 30, area_id = 23 },
	{ config_id = 191004, gadget_id = 70211101, pos = { x = -1024.987, y = 246.332, z = 3425.135 }, rot = { x = 22.753, y = 358.743, z = 353.758 }, level = 26, drop_tag = "解谜低级须弥", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 }
}

-- 区域
regions = {
	{ config_id = 191007, shape = RegionShape.SPHERE, radius = 5, pos = { x = -1082.746, y = 268.029, z = 3382.838 }, area_id = 23 }
}
...
function action_EVENT_ENTER_REGION_191007(context, evt)
	-- 设置移动平台路径
	if 0 ~= ScriptLib.SetPlatformRouteId(context, 191002, 330300018) then
...
function action_EVENT_GADGET_STATE_CHANGE_191008(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133303191, 2) then
