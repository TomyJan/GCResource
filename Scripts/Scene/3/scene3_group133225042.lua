...
local defs = {
	group_ID = 133225042,
	gadget_thunderThelfID = 42001,
	pointarray_ID = 322500001,
	maxPointCount = 18,
	gadget_Reward_1 = 42002,
	pointInfo = {5,10,16,18} 
}
...
-- 装置
gadgets = {
	{ config_id = 42001, gadget_id = 70350292, pos = { x = -6431.011, y = 239.589, z = -2811.411 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 18 },
	{ config_id = 42002, gadget_id = 70211101, pos = { x = -6428.461, y = 218.558, z = -2809.699 }, rot = { x = 0.000, y = 359.100, z = 0.000 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 18 },
	{ config_id = 42003, gadget_id = 70350292, pos = { x = -6427.881, y = 218.345, z = -2807.832 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 18 }
}

-- 区域
regions = {
	{ config_id = 42006, shape = RegionShape.SPHERE, radius = 5, pos = { x = -6430.411, y = 237.811, z = -2813.718 }, area_id = 18 }
}

-- 触发器
triggers = {
	-- 到达中断点停止
	{ config_id = 1042004, name = "PLATFORM_REACH_POINT_42004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_42004", action = "action_EVENT_PLATFORM_REACH_POINT_42004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1042005, name = "AVATAR_NEAR_PLATFORM_42005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_42005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_42005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 42001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_42004", "AVATAR_NEAR_PLATFORM_42005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			...
			{ config_id = 42003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_42004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_42004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_42005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_42005(context, evt)
