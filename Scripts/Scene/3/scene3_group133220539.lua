...
local defs = {
	group_ID = 133220539,
	gadget_thunderThelfID = 539001,
	pointarray_ID = 322000033,
	maxPointCount = 14,
	gadget_Reward_1 = 539002,
	pointInfo = {4,7,9,14} 
}
...
-- 装置
gadgets = {
	{ config_id = 539001, gadget_id = 70350292, pos = { x = -2792.440, y = 191.461, z = -4068.355 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 11 },
	{ config_id = 539002, gadget_id = 70211101, pos = { x = -2793.270, y = 180.180, z = -4084.195 }, rot = { x = 0.242, y = 233.061, z = 357.195 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 11 },
	{ config_id = 539003, gadget_id = 70350292, pos = { x = -2792.300, y = 180.250, z = -4083.274 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 11 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1539004, name = "PLATFORM_REACH_POINT_539004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_539004", action = "action_EVENT_PLATFORM_REACH_POINT_539004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1539005, name = "AVATAR_NEAR_PLATFORM_539005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_539005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_539005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 539001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_539004", "AVATAR_NEAR_PLATFORM_539005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 539002, state = 0 },
			{ config_id = 539003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_539004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_539004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_539005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_539005(context, evt)
