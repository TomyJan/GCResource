...
-- 怪物
monsters = {
	{ config_id = 249001, monster_id = 26100401, pos = { x = -845.970, y = -149.894, z = 4947.540 }, rot = { x = 0.000, y = 255.028, z = 0.000 }, level = 32, drop_tag = "高级镀金旅团", disableWander = true, pose_id = 1, area_id = 32 }
}
...
-- 装置
gadgets = {
	{ config_id = 249002, gadget_id = 70211002, pos = { x = -843.011, y = -147.640, z = 4925.756 }, rot = { x = 0.000, y = 270.529, z = 0.000 }, level = 26, drop_tag = "战斗低级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 32 }
}
