...
-- 怪物
monsters = {
	{ config_id = 30004, monster_id = 25310301, pos = { x = -3201.771, y = 272.983, z = 4748.628 }, rot = { x = 0.000, y = 121.408, z = 0.000 }, level = 32, drop_tag = "中级镀金旅团", disableWander = true, pose_id = 9001, area_id = 28 }
}
...
-- 装置
gadgets = {
	{ config_id = 30002, gadget_id = 70211151, pos = { x = -3201.600, y = 272.967, z = 4751.059 }, rot = { x = 0.000, y = 174.014, z = 0.000 }, level = 26, chest_drop_id = 21910090, drop_count = 1, state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 28 }
}
