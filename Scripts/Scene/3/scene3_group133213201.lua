...
local defs = {
	group_ID = 133213201,
	gadget_thunderThelfID = 201001,
	pointarray_ID = 321300047,
	maxPointCount = 14,
	pointInfo = {2,6,10,14} 
}
...
-- 装置
gadgets = {
	{ config_id = 201001, gadget_id = 70350292, pos = { x = -3310.904, y = 226.718, z = -3270.451 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 12 },
	{ config_id = 201003, gadget_id = 70350292, pos = { x = -3299.810, y = 224.052, z = -3267.281 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 12 }
}
...
-- 触发器
triggers = {
	{ config_id = 1201002, name = "GROUP_LOAD_201002", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_201002", action = "action_EVENT_GROUP_LOAD_201002" },
	-- 到达中断点停止
	{ config_id = 1201004, name = "PLATFORM_REACH_POINT_201004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_201004", action = "action_EVENT_PLATFORM_REACH_POINT_201004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1201005, name = "AVATAR_NEAR_PLATFORM_201005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_201005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_201005", trigger_count = 0 },
	{ config_id = 1201006, name = "VARIABLE_CHANGE_201006", event = EventType.EVENT_VARIABLE_CHANGE, source = "", condition = "condition_EVENT_VARIABLE_CHANGE_201006", action = "action_EVENT_VARIABLE_CHANGE_201006" }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 201001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_201004", "AVATAR_NEAR_PLATFORM_201005", "VARIABLE_CHANGE_201006" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 201003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "GROUP_LOAD_201002" },
		npcs = { },
		variables = {
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_201002(context, evt)
	-- 判断变量"isFinished"为1
...
-- 触发操作
function action_EVENT_GROUP_LOAD_201002(context, evt)
	-- 将本组内变量名为 "count3" 的变量设置为 1
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "count3", 1, 133213218) then
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_201004(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_201005(context, evt)
		MovePlatform(context)
		return 0
end

-- 触发条件
function condition_EVENT_VARIABLE_CHANGE_201006(context, evt)
...
-- 触发操作
function action_EVENT_VARIABLE_CHANGE_201006(context, evt)
	-- 将本组内变量名为 "count3" 的变量设置为 1
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "count3", 1, 133213218) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	  return -1
