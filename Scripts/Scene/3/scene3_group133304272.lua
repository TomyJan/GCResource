...
-- 装置
gadgets = {
	{ config_id = 272006, gadget_id = 70210101, pos = { x = -1131.443, y = 259.017, z = 2232.560 }, rot = { x = 0.000, y = 283.794, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜果蔬须弥", isOneoff = true, persistent = true, area_id = 21 }
}
...
function action_EVENT_ENTER_REGION_272004(context, evt)
	...
	-- 触发镜头注目，注目位置为坐标{x=-1131.443, y=259.0174, z=2232.56}，持续时间为1秒，并且为强制注目形式，不广播其他玩家
		local pos = {x=-1131.443, y=259.0174, z=2232.56}
