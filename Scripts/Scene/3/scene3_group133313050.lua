...
-- 装置
gadgets = {
	{ config_id = 50001, gadget_id = 70330420, pos = { x = -422.454, y = -236.872, z = 5466.177 }, rot = { x = 0.000, y = 86.533, z = 0.000 }, level = 32, persistent = true, area_id = 32 }
}
...
triggers = {
	-- 任务通知开门
	{ config_id = 1050002, name = "QUEST_START_50002", event = EventType.EVENT_QUEST_START, source = "7318730", condition = "", action = "action_EVENT_QUEST_START_50002", trigger_count = 0 },
...
suites = {
	{
		...
		gadgets = { 50001 },
		regions = { },
		triggers = { "QUEST_START_50002", "GROUP_LOAD_50003" },
		rand_weight = 100
	}
}
