...
-- 怪物
monsters = {
	{ config_id = 296001, monster_id = 26010101, pos = { x = -909.895, y = 212.024, z = 2645.362 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, drop_tag = "骗骗花", area_id = 24 }
}
...
-- 装置
gadgets = {
	{ config_id = 296002, gadget_id = 70510013, pos = { x = -909.895, y = 212.024, z = 2645.362 }, rot = { x = 0.000, y = 319.800, z = 0.000 }, level = 27, persistent = true, area_id = 24 }
}
...
function action_EVENT_GADGET_STATE_CHANGE_296003(context, evt)
	-- 添加suite2的新内容
	    ScriptLib.AddExtraGroupSuite(context, 133302296, 2)
...
function action_EVENT_GADGET_CREATE_296005(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 133302296, 296002, {173}) then
...
function action_EVENT_SELECT_OPTION_296006(context, evt)
	...
	-- 删除指定group： 133302296 ；指定config：296002；物件身上指定option：173；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 133302296, 296002, 173) then
