...
-- 装置
gadgets = {
	{ config_id = 262001, gadget_id = 70310090, pos = { x = -6434.726, y = 242.976, z = -2591.079 }, rot = { x = 358.381, y = 233.901, z = 350.414 }, level = 33, persistent = true, area_id = 18 }
}
...
-- 触发器
triggers = {
	{ config_id = 1262002, name = "GADGET_STATE_CHANGE_262002", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_262002", action = "action_EVENT_GADGET_STATE_CHANGE_262002", trigger_count = 0 },
...
suites = {
	{
		...
		gadgets = { 262001 },
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_262002", "GROUP_LOAD_262003" },
		rand_weight = 100
	}
}
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_262002(context, evt)
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_262002(context, evt)
...
function condition_EVENT_GROUP_LOAD_262003(context, evt)
	if GadgetState.GearStart ~= ScriptLib.GetGadgetStateByConfigId(context, 133225262, 262001) then
		return false
	end
