...
gadgets = {
	...
	{ config_id = 620004, gadget_id = 70211101, pos = { x = -14.177, y = 248.091, z = 3029.296 }, rot = { x = 7.467, y = 274.030, z = 348.568 }, level = 26, drop_tag = "解谜低级须弥", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 20 }
}
