...
triggers = {
	...
	-- 邪门歪道的专属保底trigger，碎石堆如果已经死了（状态-1）那就解锁宝箱
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_GADGET_DIE_661003", "GADGET_STATE_CHANGE_661004", "GADGET_CREATE_661005" },
		rand_weight = 100
	}
}
...
function condition_EVENT_GADGET_CREATE_661005(context, evt)
	if ScriptLib.GetGadgetStateByConfigId(context, 133104661, 661002) == -1 then
		return true
	end
