...
local defs = {
	group_ID = 133213280,
	gadget_thunderThelfID = 280001,
	pointarray_ID = 321300029,
	maxPointCount = 14,
	gadget_Reward_1 = 280002,
	pointInfo = {5,10,14} 
}
...
-- 装置
gadgets = {
	{ config_id = 280001, gadget_id = 70350292, pos = { x = -3872.847, y = 201.793, z = -3291.978 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 12 },
	{ config_id = 280002, gadget_id = 70211101, pos = { x = -3952.885, y = 206.262, z = -3272.043 }, rot = { x = 7.611, y = 4.022, z = 343.925 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 12 },
	{ config_id = 280003, gadget_id = 70350292, pos = { x = -3951.762, y = 205.700, z = -3271.176 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 12 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1280004, name = "PLATFORM_REACH_POINT_280004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_280004", action = "action_EVENT_PLATFORM_REACH_POINT_280004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1280005, name = "AVATAR_NEAR_PLATFORM_280005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_280005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_280005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 280001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_280004", "AVATAR_NEAR_PLATFORM_280005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 280002, state = 0 },
			{ config_id = 280003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_280004(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_280005(context, evt)
