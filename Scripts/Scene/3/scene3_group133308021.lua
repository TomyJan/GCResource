...
-- Trigger变量
local defs = {
	pointarray_ID = 330800032,
	pointArrayNum = 3,
	gadget_shooter = 21002,
	gadget_shooterBase_1 = 21001
}
...
-- 装置
gadgets = {
	{ config_id = 21001, gadget_id = 70330300, pos = { x = -1513.949, y = 113.373, z = 4382.113 }, rot = { x = 0.000, y = 339.986, z = 0.000 }, level = 32, persistent = true, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE, area_id = 26 },
	{ config_id = 21002, gadget_id = 70330280, pos = { x = -1513.949, y = 113.373, z = 4382.113 }, rot = { x = 0.000, y = 99.986, z = 0.000 }, level = 32, persistent = true, is_use_point_array = true, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE, area_id = 26 }
}
