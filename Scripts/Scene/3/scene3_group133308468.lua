...
-- 怪物
monsters = {
	{ config_id = 468001, monster_id = 28020604, pos = { x = -1863.245, y = 134.709, z = 5166.962 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, drop_tag = "走兽", area_id = 27 },
	{ config_id = 468002, monster_id = 26090901, pos = { x = -1863.313, y = 134.132, z = 5166.729 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, drop_tag = "蕈兽", pose_id = 101, area_id = 27 },
	{ config_id = 468003, monster_id = 28050106, pos = { x = -1863.484, y = 134.980, z = 5166.711 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, drop_tag = "魔法生物", area_id = 27 },
	{ config_id = 468005, monster_id = 28060401, pos = { x = -1863.257, y = 134.121, z = 5166.798 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, drop_tag = "走兽", pose_id = 1, area_id = 27 }
}
...
-- 装置
gadgets = {
	{ config_id = 468006, gadget_id = 70330266, pos = { x = -1863.324, y = 134.497, z = 5166.689 }, rot = { x = 7.394, y = 76.787, z = 356.449 }, level = 32, area_id = 27 },
	{ config_id = 468007, gadget_id = 70210101, pos = { x = -1863.304, y = 134.202, z = 5166.613 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜破损须弥", persistent = true, area_id = 27 }
}

-- 区域
regions = {
	-- 需要伏击怪食用这个
	{ config_id = 468013, shape = RegionShape.SPHERE, radius = 2.35, pos = { x = -1863.030, y = 134.842, z = 5167.044 }, area_id = 27 }
}
...
garbages = {
	monsters = {
		{ config_id = 468004, monster_id = 28050106, pos = { x = -1863.006, y = 135.013, z = 5166.840 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, drop_tag = "魔法生物", area_id = 27 }
	}
}
