...
-- 装置
gadgets = {
	{ config_id = 247001, gadget_id = 70310090, pos = { x = -6316.876, y = 257.176, z = -2488.747 }, rot = { x = 357.653, y = 77.242, z = 355.319 }, level = 33, persistent = true, area_id = 18 }
}
...
-- 触发器
triggers = {
	{ config_id = 1247002, name = "GADGET_STATE_CHANGE_247002", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_247002", action = "action_EVENT_GADGET_STATE_CHANGE_247002", trigger_count = 0 },
...
suites = {
	{
		...
		gadgets = { 247001 },
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_247002", "GROUP_LOAD_247003" },
		rand_weight = 100
	}
}
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_247002(context, evt)
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_247002(context, evt)
...
function condition_EVENT_GROUP_LOAD_247003(context, evt)
	if GadgetState.GearStart ~= ScriptLib.GetGadgetStateByConfigId(context, 133225247, 247001) then
		return false
	end
