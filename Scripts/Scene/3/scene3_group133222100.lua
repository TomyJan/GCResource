...
local defs = {
	group_ID = 133222100,
	gadget_thunderThelfID = 100001,
	pointarray_ID = 322200001,
	maxPointCount = 14,
	gadget_Reward_1 = 100002,
	pointInfo = {3,5,8,12,14} 
}
...
-- 装置
gadgets = {
	{ config_id = 100001, gadget_id = 70350292, pos = { x = -4262.262, y = 203.570, z = -4176.352 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 14 },
	{ config_id = 100002, gadget_id = 70211111, pos = { x = -4321.874, y = 207.304, z = -4018.392 }, rot = { x = 0.000, y = 67.046, z = 0.000 }, level = 26, drop_tag = "解谜中级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 14 },
	{ config_id = 100003, gadget_id = 70350292, pos = { x = -4323.055, y = 207.455, z = -4016.830 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 14 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1100004, name = "PLATFORM_REACH_POINT_100004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_100004", action = "action_EVENT_PLATFORM_REACH_POINT_100004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1100005, name = "AVATAR_NEAR_PLATFORM_100005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_100005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_100005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 100001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_100004", "AVATAR_NEAR_PLATFORM_100005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 100002, state = 0 },
			{ config_id = 100003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_100004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_100004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_100005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_100005(context, evt)
