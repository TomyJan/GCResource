...
-- 装置
gadgets = {
	{ config_id = 205001, gadget_id = 70211101, pos = { x = 150.307, y = 395.671, z = 2093.597 }, rot = { x = 10.269, y = 101.885, z = 7.775 }, level = 26, drop_tag = "解谜低级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 20 },
	{ config_id = 205002, gadget_id = 70350093, pos = { x = 263.841, y = 362.518, z = 2071.746 }, rot = { x = 0.688, y = 334.581, z = 9.240 }, level = 27, persistent = true, area_id = 20 },
	{ config_id = 205003, gadget_id = 70360001, pos = { x = 263.841, y = 362.518, z = 2071.746 }, rot = { x = 1.336, y = 0.605, z = 10.901 }, level = 27, persistent = true, area_id = 20 },
	{ config_id = 205004, gadget_id = 70290501, pos = { x = 246.720, y = 362.453, z = 2067.041 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 20 },
	{ config_id = 205005, gadget_id = 70290501, pos = { x = 229.941, y = 365.540, z = 2070.863 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 20 },
	{ config_id = 205006, gadget_id = 70290501, pos = { x = 217.009, y = 368.228, z = 2071.808 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 20 },
...
-- 点位
points = {
	{ config_id = 205023, pos = { x = 242.846, y = 363.454, z = 2067.378 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, area_id = 20 }
}
...
function action_EVENT_SELECT_OPTION_205017(context, evt)
	...
	-- 触发镜头注目，注目位置为坐标{x=242.8463, y=363.454, z=2067.378}，持续时间为2秒，并且为强制注目形式，不广播其他玩家
		local pos = {x=242.8463, y=363.454, z=2067.378}
