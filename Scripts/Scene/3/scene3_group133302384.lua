...
-- 装置
gadgets = {
	{ config_id = 384002, gadget_id = 70211151, pos = { x = -962.461, y = 211.874, z = 2573.622 }, rot = { x = 14.913, y = 0.585, z = 5.292 }, level = 26, chest_drop_id = 21910074, drop_count = 1, state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 24 }
}
