...
local defs = {
	group_ID = 133212205,
	gadget_thunderThelfID = 205001,
	pointarray_ID = 321200016,
	maxPointCount = 8,
	gadget_Reward_1 = 205002,
	pointInfo = {2,3,6,8} 
}
...
-- 装置
gadgets = {
	{ config_id = 205001, gadget_id = 70350292, pos = { x = -4042.317, y = 210.265, z = -2189.109 }, rot = { x = 0.000, y = 320.555, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 13 },
	{ config_id = 205002, gadget_id = 70211101, pos = { x = -4088.563, y = 214.613, z = -2248.164 }, rot = { x = 354.587, y = 313.963, z = 1.140 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 13 },
	{ config_id = 205003, gadget_id = 70350292, pos = { x = -4087.218, y = 215.705, z = -2245.906 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 13 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1205004, name = "PLATFORM_REACH_POINT_205004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_205004", action = "action_EVENT_PLATFORM_REACH_POINT_205004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1205005, name = "AVATAR_NEAR_PLATFORM_205005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_205005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_205005", trigger_count = 0 }
}
...
garbages = {
	gadgets = {
		{ config_id = 205006, gadget_id = 70900387, pos = { x = -4044.138, y = 210.179, z = -2188.868 }, rot = { x = 0.000, y = 75.349, z = 0.000 }, level = 27, persistent = true, area_id = 13 }
	}
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 205001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_205004", "AVATAR_NEAR_PLATFORM_205005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 205002, state = 0 },
			{ config_id = 205003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_205004(context, evt)
	if 205001 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_205005(context, evt)
