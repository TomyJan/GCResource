...
local defs = {
	group_ID = 133220034,
	gadget_thunderThelfID = 34001,
	pointarray_ID = 322000034,
	maxPointCount = 14,
	gadget_Reward_1 = 34002,
	pointInfo = {10,13,14} 
}
...
-- 装置
gadgets = {
	{ config_id = 34001, gadget_id = 70350292, pos = { x = -2186.635, y = 230.665, z = -4264.060 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 11 },
	{ config_id = 34002, gadget_id = 70211101, pos = { x = -1956.933, y = 199.416, z = -4265.527 }, rot = { x = 359.806, y = 233.721, z = 3.197 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 11 },
	{ config_id = 34003, gadget_id = 70350292, pos = { x = -1962.104, y = 200.000, z = -4268.898 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 11 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1034004, name = "PLATFORM_REACH_POINT_34004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_34004", action = "action_EVENT_PLATFORM_REACH_POINT_34004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1034005, name = "AVATAR_NEAR_PLATFORM_34005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_34005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_34005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 34001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_34004", "AVATAR_NEAR_PLATFORM_34005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 34002, state = 0 },
			{ config_id = 34003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_34004(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_34005(context, evt)
