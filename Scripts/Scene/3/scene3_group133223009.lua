...
local defs = {
	group_ID = 133223009,
	gadget_thunderThelfID = 9001,
	pointarray_ID = 322300007,
	maxPointCount = 14,
	gadget_Reward_1 = 9002,
	pointInfo = {3,8,12,14} ,
...
-- 装置
gadgets = {
	{ config_id = 9001, gadget_id = 70350292, pos = { x = -6271.004, y = 363.567, z = -2686.611 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 18 },
	{ config_id = 9003, gadget_id = 70350292, pos = { x = -6121.835, y = 224.272, z = -2766.468 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 18 }
}

-- 区域
regions = {
	{ config_id = 9002, shape = RegionShape.SPHERE, radius = 5, pos = { x = -6270.087, y = 364.292, z = -2684.318 }, area_id = 18 }
}

-- 触发器
triggers = {
	-- 到达中断点停止
	{ config_id = 1009004, name = "PLATFORM_REACH_POINT_9004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_9004", action = "action_EVENT_PLATFORM_REACH_POINT_9004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1009005, name = "AVATAR_NEAR_PLATFORM_9005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_9005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_9005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 9001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_9004", "AVATAR_NEAR_PLATFORM_9005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 9003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_9004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_9004(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "thief_A_finish", 1, 133223075) then
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_9005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_9005(context, evt)
