...
local defs = {
	group_ID = 133212266,
	gadget_thunderThelfID = 266001,
	pointarray_ID = 321200006,
	maxPointCount = 23,
	gadget_Reward_1 = 266002,
	pointInfo = {7,16,23} 
}
...
-- 装置
gadgets = {
	{ config_id = 266001, gadget_id = 70350292, pos = { x = -3601.060, y = 206.918, z = -2399.073 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 13 },
	{ config_id = 266002, gadget_id = 70211101, pos = { x = -3621.620, y = 212.332, z = -2249.001 }, rot = { x = 355.259, y = 227.018, z = 6.926 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 13 },
	{ config_id = 266003, gadget_id = 70350292, pos = { x = -3624.470, y = 212.440, z = -2249.169 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 13 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1266004, name = "PLATFORM_REACH_POINT_266004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_266004", action = "action_EVENT_PLATFORM_REACH_POINT_266004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1266005, name = "AVATAR_NEAR_PLATFORM_266005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_266005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_266005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 266001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_266004", "AVATAR_NEAR_PLATFORM_266005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 266002, state = 0 },
			{ config_id = 266003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_266004(context, evt)
	if 266001 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_266005(context, evt)
