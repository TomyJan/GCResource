...
local defs = {
	group_ID = 133220083,
	gadget_thunderThelfID = 83001,
	pointarray_ID = 322000028,
	maxPointCount = 14,
	gadget_Reward_1 = 83002,
	pointInfo = {4,9,14} 
}
...
-- 装置
gadgets = {
	{ config_id = 83001, gadget_id = 70350292, pos = { x = -2469.186, y = 226.595, z = -4108.266 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 11 },
	{ config_id = 83002, gadget_id = 70211101, pos = { x = -2473.439, y = 224.103, z = -4152.876 }, rot = { x = 359.576, y = 307.823, z = 357.001 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 11 },
	{ config_id = 83003, gadget_id = 70350292, pos = { x = -2474.912, y = 224.014, z = -4150.330 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 11 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1083004, name = "PLATFORM_REACH_POINT_83004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_83004", action = "action_EVENT_PLATFORM_REACH_POINT_83004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1083005, name = "AVATAR_NEAR_PLATFORM_83005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_83005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_83005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		...
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_83004", "AVATAR_NEAR_PLATFORM_83005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			...
			{ config_id = 83003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_83004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_83004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_83005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_83005(context, evt)
