...
local defs = {
	group_ID = 133220509,
	gadget_thunderThelfID = 509001,
	pointarray_ID = 322000030,
	maxPointCount = 20,
	gadget_Reward_1 = 509002,
	pointInfo = {5,10,20} 
}
...
-- 装置
gadgets = {
	{ config_id = 509001, gadget_id = 70350292, pos = { x = -2789.235, y = 219.964, z = -4259.597 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 11 },
	{ config_id = 509002, gadget_id = 70211101, pos = { x = -2822.313, y = 219.922, z = -4372.449 }, rot = { x = 0.000, y = 11.711, z = 0.000 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 11 },
	{ config_id = 509003, gadget_id = 70350292, pos = { x = -2821.830, y = 224.698, z = -4373.626 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 11 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1509004, name = "PLATFORM_REACH_POINT_509004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_509004", action = "action_EVENT_PLATFORM_REACH_POINT_509004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1509005, name = "AVATAR_NEAR_PLATFORM_509005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_509005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_509005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 509001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_509004", "AVATAR_NEAR_PLATFORM_509005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 509002, state = 0 },
			{ config_id = 509003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_509004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_509004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_509005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_509005(context, evt)
