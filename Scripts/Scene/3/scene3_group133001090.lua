...
-- 装置
gadgets = {
	{ config_id = 1717, gadget_id = 70900007, pos = { x = 1266.951, y = 259.361, z = -1688.478 }, rot = { x = 0.000, y = 79.834, z = 0.000 }, level = 15, state = GadgetState.GearStart, persistent = true, area_id = 2 },
