...
-- 装置
gadgets = {
	{ config_id = 134001, gadget_id = 70710006, pos = { x = -3472.101, y = 200.020, z = -2699.971 }, rot = { x = 0.000, y = 105.773, z = 0.000 }, level = 32, area_id = 13 },
	{ config_id = 134002, gadget_id = 70710010, pos = { x = -3501.398, y = 208.168, z = -2640.660 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, route_id = 321200140, area_id = 13 },
	{ config_id = 134003, gadget_id = 70710007, pos = { x = -3472.367, y = 200.089, z = -2699.471 }, rot = { x = 0.000, y = 332.439, z = 0.000 }, level = 32, area_id = 13 }
}

-- 区域
regions = {
	{ config_id = 134007, shape = RegionShape.SPHERE, radius = 2, pos = { x = -3501.483, y = 208.175, z = -2640.702 }, area_id = 13 }
}
...
function action_EVENT_ENTER_REGION_134007(context, evt)
	-- 设置移动平台路径
	if 0 ~= ScriptLib.SetPlatformRouteId(context, 134002, 321200139) then
...
function action_EVENT_GADGET_STATE_CHANGE_134008(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133212134, 2) then
