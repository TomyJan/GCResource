...
local defs = {
	group_ID = 133213091,
	gadget_thunderThelfID = 91001,
	pointarray_ID = 321300014,
	maxPointCount = 14,
	gadget_Reward_1 = 91002,
	pointInfo = {5,10,14} 
}
...
-- 装置
gadgets = {
	{ config_id = 91001, gadget_id = 70350292, pos = { x = -3364.131, y = 201.008, z = -2976.303 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 12 },
	{ config_id = 91003, gadget_id = 70350292, pos = { x = -3414.938, y = 199.323, z = -2978.508 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 12 }
}
...
triggers = {
	...
	{ config_id = 1091006, name = "VARIABLE_CHANGE_91006", event = EventType.EVENT_VARIABLE_CHANGE, source = "", condition = "condition_EVENT_VARIABLE_CHANGE_91006", action = "action_EVENT_VARIABLE_CHANGE_91006" },
	{ config_id = 1091007, name = "GADGET_CREATE_91007", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_91007", action = "action_EVENT_GADGET_CREATE_91007" }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 91001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_91004", "AVATAR_NEAR_PLATFORM_91005", "VARIABLE_CHANGE_91006" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 91003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "GADGET_CREATE_91007" },
		npcs = { },
		variables = {
...
-- 触发条件
function condition_EVENT_VARIABLE_CHANGE_91006(context, evt)
...
-- 触发操作
function action_EVENT_VARIABLE_CHANGE_91006(context, evt)
	-- 将本组内变量名为 "count2" 的变量设置为 1
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "count2", 1, 133213372) then
...
-- 触发条件
function condition_EVENT_GADGET_CREATE_91007(context, evt)
	-- 判断变量"isFinished"为1
	if ScriptLib.GetGroupVariableValue(context, "isFinished") ~= 1 then
			return false
	end
...
-- 触发操作
function action_EVENT_GADGET_CREATE_91007(context, evt)
	-- 将本组内变量名为 "count2" 的变量设置为 1
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "count2", 1, 133213372) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable_by_group")
	  return -1
