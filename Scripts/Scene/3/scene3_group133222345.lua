...
local defs = {
	group_ID = 133222345,
	gadget_thunderThelfID = 345001,
	pointarray_ID = 322200035,
	maxPointCount = 14,
	gadget_Reward_1 = 345002,
	pointInfo = {5,10,14} 
}
...
-- 装置
gadgets = {
	{ config_id = 345001, gadget_id = 70350292, pos = { x = -4665.389, y = 202.291, z = -4067.203 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 14 },
	{ config_id = 345002, gadget_id = 70211101, pos = { x = -4789.686, y = 200.274, z = -4072.111 }, rot = { x = 350.888, y = 72.547, z = 7.999 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 14 },
	{ config_id = 345003, gadget_id = 70350292, pos = { x = -4788.711, y = 200.368, z = -4067.900 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 14 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1345004, name = "PLATFORM_REACH_POINT_345004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_345004", action = "action_EVENT_PLATFORM_REACH_POINT_345004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1345005, name = "AVATAR_NEAR_PLATFORM_345005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_345005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_345005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 345001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_345004", "AVATAR_NEAR_PLATFORM_345005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 345002, state = 0 },
			{ config_id = 345003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_345004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_345004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_345005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_345005(context, evt)
