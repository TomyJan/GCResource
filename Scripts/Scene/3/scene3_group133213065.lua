...
local defs = {
	group_ID = 133213065,
	gadget_thunderThelfID = 65001,
	pointarray_ID = 321300028,
	maxPointCount = 14,
	gadget_Reward_1 = 65002,
	pointInfo = {5,10,14} 
}
...
-- 装置
gadgets = {
	{ config_id = 65001, gadget_id = 70350292, pos = { x = -3709.826, y = 200.981, z = -3336.837 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 12 },
	{ config_id = 65002, gadget_id = 70211101, pos = { x = -3734.948, y = 201.504, z = -3360.006 }, rot = { x = 10.031, y = 358.505, z = 16.322 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 12 },
	{ config_id = 65003, gadget_id = 70350292, pos = { x = -3746.930, y = 223.482, z = -3362.370 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 12 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1065004, name = "PLATFORM_REACH_POINT_65004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_65004", action = "action_EVENT_PLATFORM_REACH_POINT_65004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1065005, name = "AVATAR_NEAR_PLATFORM_65005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_65005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_65005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 65001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_65004", "AVATAR_NEAR_PLATFORM_65005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 65002, state = 0 },
			{ config_id = 65003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_65004(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_65005(context, evt)
