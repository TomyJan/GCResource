...
gadgets = {
	...
	[300002] = { config_id = 300002, gadget_id = 70330251, pos = { x = -682.754, y = 143.182, z = 2305.519 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, mark_flag = 3, area_id = 24 },
	[300003] = { config_id = 300003, gadget_id = 70220103, pos = { x = -692.885, y = 155.002, z = 2300.169 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, persistent = true, area_id = 24 },
	[300004] = { config_id = 300004, gadget_id = 70220103, pos = { x = -682.754, y = 143.182, z = 2305.519 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, persistent = true, area_id = 24 }
}
