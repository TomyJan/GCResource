...
-- 装置
gadgets = {
	{ config_id = 23001, gadget_id = 70211111, pos = { x = 666.384, y = 309.431, z = 5925.904 }, rot = { x = 0.000, y = 270.304, z = 0.000 }, level = 26, drop_tag = "解谜中级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 30 },
	{ config_id = 23002, gadget_id = 70350093, pos = { x = 640.546, y = 310.523, z = 5900.313 }, rot = { x = 20.370, y = 1.111, z = 2.733 }, level = 32, persistent = true, area_id = 30 },
	{ config_id = 23003, gadget_id = 70360001, pos = { x = 640.540, y = 311.570, z = 5900.303 }, rot = { x = 12.684, y = 359.871, z = 359.266 }, level = 32, persistent = true, area_id = 30 },
	{ config_id = 23004, gadget_id = 70290501, pos = { x = 650.182, y = 310.229, z = 5925.960 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, area_id = 30 },
	{ config_id = 23005, gadget_id = 70290501, pos = { x = 651.931, y = 310.229, z = 5925.960 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, area_id = 30 },
	{ config_id = 23006, gadget_id = 70290501, pos = { x = 653.462, y = 310.229, z = 5925.960 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, area_id = 30 },
	{ config_id = 23007, gadget_id = 70290501, pos = { x = 655.096, y = 310.229, z = 5925.960 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, area_id = 30 },
	{ config_id = 23008, gadget_id = 70290501, pos = { x = 656.596, y = 310.229, z = 5925.960 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, area_id = 30 },
	{ config_id = 23009, gadget_id = 70290501, pos = { x = 658.494, y = 310.229, z = 5925.960 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, area_id = 30 },
	{ config_id = 23010, gadget_id = 70290501, pos = { x = 660.385, y = 310.229, z = 5925.960 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, area_id = 30 },
	{ config_id = 23011, gadget_id = 70290501, pos = { x = 662.078, y = 310.229, z = 5925.960 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, area_id = 30 }
}
...
suites = {
	...
	},
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 23004, 23005, 23006, 23007, 23008, 23009, 23010, 23011 },
		regions = { },
		triggers = { },
		rand_weight = 100
	},
...
function action_EVENT_CHALLENGE_SUCCESS_23012(context, evt)
	...
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 23002, GadgetState.GearStop) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
	    ...
	    ScriptLib.KillExtraGroupSuite(context, 133316023, 2)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133316023, 3) then
...
function action_EVENT_CHALLENGE_FAIL_23013(context, evt)
	...
	-- 删除suite2的所有内容
	    ScriptLib.RemoveExtraGroupSuite(context, 133316023, 2)
...
function action_EVENT_GADGET_CREATE_23016(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 133316023, 23003, {177}) then
