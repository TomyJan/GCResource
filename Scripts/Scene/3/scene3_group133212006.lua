...
local defs = {
	group_ID = 133212006,
	gadget_thunderThelfID = 6001,
	pointarray_ID = 321200008,
	maxPointCount = 10,
	gadget_Reward_1 = 6002,
	pointInfo = {1,3,5,6,7,8,10} 
}
...
-- 装置
gadgets = {
	{ config_id = 6001, gadget_id = 70350292, pos = { x = -3720.570, y = 226.399, z = -2094.275 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 13 },
	{ config_id = 6002, gadget_id = 70211101, pos = { x = -3606.706, y = 218.854, z = -2364.075 }, rot = { x = 13.023, y = 62.197, z = 358.789 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 13 },
	{ config_id = 6003, gadget_id = 70350292, pos = { x = -3602.368, y = 217.712, z = -2360.336 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 13 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1006004, name = "PLATFORM_REACH_POINT_6004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_6004", action = "action_EVENT_PLATFORM_REACH_POINT_6004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1006005, name = "AVATAR_NEAR_PLATFORM_6005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_6005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_6005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 6001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_6004", "AVATAR_NEAR_PLATFORM_6005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			...
			{ config_id = 6003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_6004(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_6005(context, evt)
