...
-- 装置
gadgets = {
	{ config_id = 410001, gadget_id = 70710006, pos = { x = -1148.489, y = 209.958, z = 3842.917 }, rot = { x = 0.000, y = 174.432, z = 0.000 }, level = 30, area_id = 23 },
	{ config_id = 410002, gadget_id = 70710010, pos = { x = -1126.270, y = 199.956, z = 3793.806 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, route_id = 330300029, area_id = 23 },
	{ config_id = 410003, gadget_id = 70710007, pos = { x = -1147.789, y = 209.958, z = 3841.818 }, rot = { x = 0.000, y = 148.000, z = 0.000 }, level = 30, area_id = 23 },
	{ config_id = 410004, gadget_id = 70211101, pos = { x = -1148.605, y = 209.883, z = 3844.275 }, rot = { x = 0.000, y = 215.258, z = 0.000 }, level = 26, drop_tag = "解谜低级须弥", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 }
}

-- 区域
regions = {
	{ config_id = 410007, shape = RegionShape.SPHERE, radius = 3, pos = { x = -1127.355, y = 201.122, z = 3792.594 }, area_id = 23 }
}
...
function action_EVENT_ENTER_REGION_410007(context, evt)
	-- 设置移动平台路径
	if 0 ~= ScriptLib.SetPlatformRouteId(context, 410002, 330300028) then
...
function action_EVENT_GADGET_STATE_CHANGE_410008(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133303410, 2) then
