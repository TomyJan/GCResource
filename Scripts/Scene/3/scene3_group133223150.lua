...
local defs = {
	group_ID = 133223150,
	gadget_thunderThelfID = 150001,
	pointarray_ID = 322300021,
	maxPointCount = 14,
...
-- 装置
gadgets = {
	{ config_id = 150001, gadget_id = 70350292, pos = { x = -6121.474, y = 204.037, z = -2981.910 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 18 },
	{ config_id = 150003, gadget_id = 70350292, pos = { x = -6182.010, y = 200.245, z = -2999.646 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 18 }
}
...
-- 触发器
triggers = {
	{ config_id = 1150002, name = "VARIABLE_CHANGE_150002", event = EventType.EVENT_VARIABLE_CHANGE, source = "", condition = "condition_EVENT_VARIABLE_CHANGE_150002", action = "action_EVENT_VARIABLE_CHANGE_150002" },
	-- 到达中断点停止
	{ config_id = 1150004, name = "PLATFORM_REACH_POINT_150004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_150004", action = "action_EVENT_PLATFORM_REACH_POINT_150004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1150005, name = "AVATAR_NEAR_PLATFORM_150005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_150005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_150005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 150001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "VARIABLE_CHANGE_150002", "PLATFORM_REACH_POINT_150004", "AVATAR_NEAR_PLATFORM_150005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 150003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_VARIABLE_CHANGE_150002(context, evt)
...
-- 触发操作
function action_EVENT_VARIABLE_CHANGE_150002(context, evt)
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_150004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_150004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_150005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_150005(context, evt)
