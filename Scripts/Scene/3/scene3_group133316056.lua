...
-- 装置
gadgets = {
	{ config_id = 56001, gadget_id = 70330401, pos = { x = 474.401, y = -1.008, z = 6354.552 }, rot = { x = 0.000, y = 19.706, z = 0.000 }, level = 32, area_id = 30 }
}
...
function action_EVENT_GADGET_STATE_CHANGE_56002(context, evt)
	...
	if 0 ~= ScriptLib.AddQuestProgress(context, "7325133") then
