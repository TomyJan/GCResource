...
-- 怪物
monsters = {
	{ config_id = 555001, monster_id = 28020604, pos = { x = -2134.077, y = 316.058, z = 4177.839 }, rot = { x = 0.000, y = 218.836, z = 0.000 }, level = 32, drop_tag = "走兽", area_id = 26 },
	{ config_id = 555002, monster_id = 26090901, pos = { x = -2134.146, y = 315.481, z = 4177.606 }, rot = { x = 0.000, y = 218.836, z = 0.000 }, level = 32, drop_tag = "蕈兽", pose_id = 101, area_id = 26 },
	{ config_id = 555003, monster_id = 28050106, pos = { x = -2134.316, y = 316.329, z = 4177.588 }, rot = { x = 0.000, y = 218.836, z = 0.000 }, level = 32, drop_tag = "魔法生物", area_id = 26 },
	{ config_id = 555005, monster_id = 28060401, pos = { x = -2134.090, y = 315.470, z = 4177.675 }, rot = { x = 0.000, y = 218.836, z = 0.000 }, level = 32, drop_tag = "走兽", pose_id = 1, area_id = 26 }
}
...
-- 装置
gadgets = {
	{ config_id = 555006, gadget_id = 70330266, pos = { x = -2134.155, y = 315.848, z = 4177.646 }, rot = { x = 357.910, y = 218.866, z = 358.316 }, level = 32, area_id = 26 },
	{ config_id = 555007, gadget_id = 70210101, pos = { x = -2134.136, y = 315.551, z = 4177.490 }, rot = { x = 0.000, y = 218.836, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜破损须弥", persistent = true, area_id = 26 }
}

-- 区域
regions = {
	-- 需要伏击怪食用这个
	{ config_id = 555013, shape = RegionShape.SPHERE, radius = 2.35, pos = { x = -2133.863, y = 316.191, z = 4177.921 }, area_id = 26 }
}
...
garbages = {
	monsters = {
		{ config_id = 555004, monster_id = 28050106, pos = { x = -2133.838, y = 316.362, z = 4177.717 }, rot = { x = 0.000, y = 218.836, z = 0.000 }, level = 32, drop_tag = "魔法生物", area_id = 26 }
	}
}
