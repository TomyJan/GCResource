...
-- Trigger变量
local defs = {
	pointarray_ID = 330800034,
	pointArrayNum = 3,
	gadget_shooter = 99002,
	gadget_shooterBase_1 = 99001
}
...
-- 装置
gadgets = {
	{ config_id = 99001, gadget_id = 70330300, pos = { x = -1481.344, y = 113.208, z = 4417.622 }, rot = { x = 0.000, y = 158.495, z = 0.000 }, level = 32, persistent = true, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE, area_id = 26 },
	{ config_id = 99002, gadget_id = 70330280, pos = { x = -1481.344, y = 113.208, z = 4417.622 }, rot = { x = 0.000, y = 278.496, z = 0.000 }, level = 32, persistent = true, is_use_point_array = true, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE, area_id = 26 }
}
