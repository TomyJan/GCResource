...
local defs = {
	group_ID = 133213456,
	gadget_thunderThelfID = 456001,
	pointarray_ID = 321300035,
	maxPointCount = 17,
	gadget_Reward_1 = 456002,
	pointInfo = {4,8,10,12,15,17} 
}
...
-- 装置
gadgets = {
	{ config_id = 456001, gadget_id = 70350292, pos = { x = -3705.164, y = 227.323, z = -3127.845 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 12 },
	{ config_id = 456002, gadget_id = 70211101, pos = { x = -3722.479, y = 270.175, z = -3170.242 }, rot = { x = 0.000, y = 220.377, z = 0.000 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, autopick = true, explore = { name = "chest", exp = 1 }, area_id = 12 },
	{ config_id = 456003, gadget_id = 70350292, pos = { x = -3721.759, y = 269.094, z = -3173.880 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 12 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1456004, name = "PLATFORM_REACH_POINT_456004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_456004", action = "action_EVENT_PLATFORM_REACH_POINT_456004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1456005, name = "AVATAR_NEAR_PLATFORM_456005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_456005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_456005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 456001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_456004", "AVATAR_NEAR_PLATFORM_456005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 456002, state = 0 },
			{ config_id = 456003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_456004(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_456005(context, evt)
