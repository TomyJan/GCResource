...
-- 装置
gadgets = {
	{ config_id = 257001, gadget_id = 70310090, pos = { x = -6438.248, y = 246.818, z = -2497.796 }, rot = { x = 350.279, y = 153.391, z = 0.001 }, level = 33, persistent = true, area_id = 18 }
}
...
triggers = {
	...
	{ config_id = 1257003, name = "GROUP_LOAD_257003", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_257003", action = "action_EVENT_GROUP_LOAD_257003", trigger_count = 0 }
}
...
suites = {
	{
		...
		gadgets = { 257001 },
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_257002", "GROUP_LOAD_257003" },
		rand_weight = 100
	}
}
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_257003(context, evt)
	if GadgetState.GearStart ~= ScriptLib.GetGadgetStateByConfigId(context, 133225257, 257001) then
		return false
	end
...
-- 触发操作
function action_EVENT_GROUP_LOAD_257003(context, evt)
	-- 针对当前group内变量名为 "progress" 的变量，进行修改，变化值为 1
	if 0 ~= ScriptLib.ChangeGroupVariableValueByGroup(context, "progress", 1, 133223291) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : change_GroupVariable_by_group")
	  return -1
