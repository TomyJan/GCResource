...
-- 怪物
monsters = {
	{ config_id = 2001, monster_id = 21020501, pos = { x = 829.132, y = 341.643, z = 6480.877 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, drop_tag = "丘丘岩盔王", disableWander = true, area_id = 30 }
}
...
-- 装置
gadgets = {
	{ config_id = 2002, gadget_id = 70211022, pos = { x = 829.089, y = 341.643, z = 6484.153 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "战斗高级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 30 }
}
