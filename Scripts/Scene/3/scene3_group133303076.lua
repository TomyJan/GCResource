...
triggers = {
	...
	{ config_id = 1076008, name = "GROUP_LOAD_76008", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_76008", action = "action_EVENT_GROUP_LOAD_76008", trigger_count = 0 }
}
