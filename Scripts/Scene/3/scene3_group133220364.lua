...
local defs = {
	group_ID = 133220364,
	gadget_thunderThelfID = 364001,
	pointarray_ID = 322000035,
	maxPointCount = 14,
	gadget_Reward_1 = 364002,
	pointInfo = {5,10,14} 
}
...
-- 装置
gadgets = {
	{ config_id = 364001, gadget_id = 70350292, pos = { x = -2792.570, y = 225.951, z = -4456.732 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 11 },
	{ config_id = 364002, gadget_id = 70211101, pos = { x = -2730.337, y = 237.483, z = -4522.033 }, rot = { x = 4.254, y = 271.571, z = 0.000 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 11 },
	{ config_id = 364003, gadget_id = 70350292, pos = { x = -2728.454, y = 237.917, z = -4521.867 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 11 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1364004, name = "PLATFORM_REACH_POINT_364004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_364004", action = "action_EVENT_PLATFORM_REACH_POINT_364004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1364005, name = "AVATAR_NEAR_PLATFORM_364005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_364005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_364005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 364001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_364004", "AVATAR_NEAR_PLATFORM_364005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			...
			{ config_id = 364003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_364004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_364004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_364005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_364005(context, evt)
