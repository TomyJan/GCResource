...
-- 装置
gadgets = {
	{ config_id = 204001, gadget_id = 70710006, pos = { x = 154.461, y = 195.456, z = 2787.397 }, rot = { x = 0.000, y = 334.139, z = 0.000 }, level = 27, area_id = 20 },
	{ config_id = 204002, gadget_id = 70710010, pos = { x = 86.326, y = 270.274, z = 2983.178 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, route_id = 331500060, area_id = 20 },
	{ config_id = 204003, gadget_id = 70710007, pos = { x = 154.461, y = 195.456, z = 2787.397 }, rot = { x = 338.100, y = 334.139, z = 0.000 }, level = 27, area_id = 20 },
	{ config_id = 204004, gadget_id = 70211101, pos = { x = 152.800, y = 194.822, z = 2788.452 }, rot = { x = 358.031, y = 65.869, z = 17.073 }, level = 26, drop_tag = "解谜低级须弥", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 20 }
}

-- 区域
regions = {
	{ config_id = 204007, shape = RegionShape.SPHERE, radius = 5, pos = { x = 86.326, y = 270.274, z = 2983.178 }, area_id = 20 }
}
...
function action_EVENT_ENTER_REGION_204007(context, evt)
	-- 设置移动平台路径
	if 0 ~= ScriptLib.SetPlatformRouteId(context, 204002, 331500059) then
...
function action_EVENT_GADGET_STATE_CHANGE_204008(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133315204, 2) then
