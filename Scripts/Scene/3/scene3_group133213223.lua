...
local defs = {
	group_ID = 133213223,
	gadget_thunderThelfID = 223001,
	pointarray_ID = 321300008,
	maxPointCount = 18,
	gadget_Reward_1 = 223002,
	pointInfo = {5,10,14,18} 
}
...
-- 装置
gadgets = {
	{ config_id = 223001, gadget_id = 70350292, pos = { x = -3478.350, y = 202.080, z = -3242.240 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 12 },
	{ config_id = 223002, gadget_id = 70211101, pos = { x = -3509.894, y = 202.311, z = -3208.921 }, rot = { x = 346.908, y = 198.777, z = 2.953 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 12 },
	{ config_id = 223003, gadget_id = 70350292, pos = { x = -3509.651, y = 202.804, z = -3211.459 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 12 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1223004, name = "PLATFORM_REACH_POINT_223004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_223004", action = "action_EVENT_PLATFORM_REACH_POINT_223004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1223005, name = "AVATAR_NEAR_PLATFORM_223005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_223005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_223005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 223001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_223004", "AVATAR_NEAR_PLATFORM_223005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			...
			{ config_id = 223003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_223004(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_223005(context, evt)
