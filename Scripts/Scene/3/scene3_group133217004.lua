...
local defs = {
	group_ID = 133217004,
	gadget_thunderThelfID = 4001,
	pointarray_ID = 321700001,
	maxPointCount = 24,
	gadget_Reward_1 = 4002,
	pointInfo = {1,2,6,10,13,16,18,22,23,24} 
}
...
-- 装置
gadgets = {
	{ config_id = 4001, gadget_id = 70350292, pos = { x = -4389.163, y = 216.990, z = -3923.445 }, rot = { x = 0.000, y = 126.128, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 14 },
	{ config_id = 4002, gadget_id = 70211101, pos = { x = -4685.583, y = 205.118, z = -3737.122 }, rot = { x = 6.679, y = 26.042, z = 353.858 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 14 },
	{ config_id = 4003, gadget_id = 70350292, pos = { x = -4683.792, y = 205.708, z = -3734.523 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 14 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1004004, name = "PLATFORM_REACH_POINT_4004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_4004", action = "action_EVENT_PLATFORM_REACH_POINT_4004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1004005, name = "AVATAR_NEAR_PLATFORM_4005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_4005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_4005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 4001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_4004", "AVATAR_NEAR_PLATFORM_4005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			...
			{ config_id = 4003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_4004(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_4005(context, evt)
