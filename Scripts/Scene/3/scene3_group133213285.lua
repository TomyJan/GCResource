...
local defs = {
	group_ID = 133213285,
	gadget_thunderThelfID = 285001,
	pointarray_ID = 321300030,
	maxPointCount = 14,
	gadget_Reward_1 = 285002,
	pointInfo = {5,10,14} 
}
...
-- 装置
gadgets = {
	{ config_id = 285001, gadget_id = 70350292, pos = { x = -3588.766, y = 200.000, z = -3594.265 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 12 },
	{ config_id = 285002, gadget_id = 70211101, pos = { x = -3585.619, y = 200.108, z = -3638.732 }, rot = { x = 0.000, y = 45.185, z = 0.000 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 12 },
	{ config_id = 285003, gadget_id = 70350292, pos = { x = -3597.824, y = 200.676, z = -3642.194 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 12 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1285004, name = "PLATFORM_REACH_POINT_285004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_285004", action = "action_EVENT_PLATFORM_REACH_POINT_285004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1285005, name = "AVATAR_NEAR_PLATFORM_285005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_285005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_285005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 285001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_285004", "AVATAR_NEAR_PLATFORM_285005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 285002, state = 0 },
			{ config_id = 285003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_285004(context, evt)
	if 285001 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_285005(context, evt)
