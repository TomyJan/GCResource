...
-- 装置
gadgets = {
	{ config_id = 412002, gadget_id = 70330199, pos = { x = -1340.941, y = 247.031, z = 3994.477 }, rot = { x = 349.354, y = 2.877, z = 343.225 }, level = 30, state = GadgetState.GearStop, area_id = 23 }
}
