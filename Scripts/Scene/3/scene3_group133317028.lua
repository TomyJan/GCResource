...
local defs = {
	group_ID = 133317028,
	gadget_thunderThelfID = 28001,
	pointarray_ID = 331700003,
	maxPointCount = 2,
	gadget_Reward_1 = 28002,
	pointInfo = {1,2} 
}
...
-- 装置
gadgets = {
	{ config_id = 28001, gadget_id = 70350292, pos = { x = 717.454, y = 225.925, z = 6086.846 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 30 },
	{ config_id = 28002, gadget_id = 70211121, pos = { x = 712.836, y = 220.638, z = 6095.799 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "解谜高级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 30 },
	{ config_id = 28003, gadget_id = 70350292, pos = { x = 715.350, y = 220.915, z = 6096.333 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 30 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1028004, name = "PLATFORM_ARRIVAL_28004", event = EventType.EVENT_PLATFORM_ARRIVAL, source = "", condition = "condition_EVENT_PLATFORM_ARRIVAL_28004", action = "action_EVENT_PLATFORM_ARRIVAL_28004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1028005, name = "AVATAR_NEAR_PLATFORM_28005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_28005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_28005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 28001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_ARRIVAL_28004", "AVATAR_NEAR_PLATFORM_28005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			...
			{ config_id = 28003, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_ARRIVAL_28004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_ARRIVAL_28004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_28005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_28005(context, evt)
