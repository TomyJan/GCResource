...
-- 装置
gadgets = {
	{ config_id = 113001, gadget_id = 70211101, pos = { x = -1112.356, y = 248.772, z = 2851.825 }, rot = { x = 352.672, y = 270.304, z = 0.000 }, level = 26, drop_tag = "解谜低级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 21 },
	{ config_id = 113002, gadget_id = 70350093, pos = { x = -1172.485, y = 295.659, z = 2854.589 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, persistent = true, area_id = 21 },
	{ config_id = 113003, gadget_id = 70360001, pos = { x = -1172.858, y = 296.915, z = 2855.069 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, persistent = true, area_id = 21 },
	{ config_id = 113004, gadget_id = 70290501, pos = { x = -1167.245, y = 295.319, z = 2856.197 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, area_id = 21 },
	{ config_id = 113005, gadget_id = 70290501, pos = { x = -1170.412, y = 294.265, z = 2859.936 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, area_id = 21 },
	{ config_id = 113006, gadget_id = 70290501, pos = { x = -1157.686, y = 284.735, z = 2863.134 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, area_id = 21 },
	{ config_id = 113007, gadget_id = 70290501, pos = { x = -1160.570, y = 287.040, z = 2862.578 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, area_id = 21 },
	{ config_id = 113008, gadget_id = 70290501, pos = { x = -1153.689, y = 281.746, z = 2864.035 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, area_id = 21 },
	{ config_id = 113009, gadget_id = 70290501, pos = { x = -1146.886, y = 274.086, z = 2862.433 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, area_id = 21 },
	{ config_id = 113010, gadget_id = 70290501, pos = { x = -1131.407, y = 258.253, z = 2857.153 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, area_id = 21 },
	{ config_id = 113011, gadget_id = 70290501, pos = { x = -1118.579, y = 252.741, z = 2852.411 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, area_id = 21 }
}
...
suites = {
	...
	},
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 113004, 113005, 113006, 113007, 113008, 113009, 113010, 113011 },
		regions = { },
		triggers = { },
		rand_weight = 100
	},
...
function action_EVENT_CHALLENGE_SUCCESS_113012(context, evt)
	...
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 113002, GadgetState.GearStop) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
	    ...
	    ScriptLib.KillExtraGroupSuite(context, 133304113, 2)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133304113, 3) then
...
function action_EVENT_CHALLENGE_FAIL_113013(context, evt)
	...
	-- 删除suite2的所有内容
	    ScriptLib.RemoveExtraGroupSuite(context, 133304113, 2)
...
function action_EVENT_GADGET_CREATE_113016(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 133304113, 113003, {177}) then
...
function action_EVENT_SELECT_OPTION_113017(context, evt)
	...
	-- 触发镜头注目，注目位置为坐标（-1167，296，2856），持续时间为2秒，并且为强制注目形式，不广播其他玩家
		local pos = {x=-1167, y=296, z=2856}
