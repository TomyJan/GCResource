...
local defs = {
	group_ID = 133213448,
	gadget_thunderThelfID = 448001,
	pointarray_ID = 321300034,
	maxPointCount = 14,
	gadget_Reward_1 = 448002,
	pointInfo = {3,5,6,8,10,11,14} 
}
...
-- 装置
gadgets = {
	{ config_id = 448001, gadget_id = 70350292, pos = { x = -3186.461, y = 202.326, z = -3921.638 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 12 },
	{ config_id = 448002, gadget_id = 70211101, pos = { x = -3196.968, y = 225.407, z = -3955.984 }, rot = { x = 6.825, y = 359.822, z = 3.462 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 12 },
	{ config_id = 448003, gadget_id = 70350292, pos = { x = -3195.208, y = 224.804, z = -3955.945 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 12 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1448004, name = "PLATFORM_REACH_POINT_448004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_448004", action = "action_EVENT_PLATFORM_REACH_POINT_448004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1448005, name = "AVATAR_NEAR_PLATFORM_448005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_448005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_448005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 448001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_448004", "AVATAR_NEAR_PLATFORM_448005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 448002, state = 0 },
			{ config_id = 448003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_448004(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_448005(context, evt)
