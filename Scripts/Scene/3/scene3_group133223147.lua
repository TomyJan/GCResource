...
local defs = {
	group_ID = 133223147,
	gadget_thunderThelfID = 147001,
	pointarray_ID = 322300020,
	maxPointCount = 11,
	gadget_Reward_1 = 147002,
	pointInfo = {5,9,11} 
}
...
-- 装置
gadgets = {
	{ config_id = 147001, gadget_id = 70350292, pos = { x = -6174.292, y = 209.253, z = -2982.566 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 18 },
	{ config_id = 147003, gadget_id = 70350292, pos = { x = -6187.157, y = 200.331, z = -3000.107 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 18 }
}
...
-- 触发器
triggers = {
	{ config_id = 1147002, name = "VARIABLE_CHANGE_147002", event = EventType.EVENT_VARIABLE_CHANGE, source = "", condition = "condition_EVENT_VARIABLE_CHANGE_147002", action = "action_EVENT_VARIABLE_CHANGE_147002" },
	-- 到达中断点停止
	{ config_id = 1147004, name = "PLATFORM_REACH_POINT_147004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_147004", action = "action_EVENT_PLATFORM_REACH_POINT_147004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1147005, name = "AVATAR_NEAR_PLATFORM_147005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_147005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_147005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 147001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "VARIABLE_CHANGE_147002", "PLATFORM_REACH_POINT_147004", "AVATAR_NEAR_PLATFORM_147005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 147003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_VARIABLE_CHANGE_147002(context, evt)
...
-- 触发操作
function action_EVENT_VARIABLE_CHANGE_147002(context, evt)
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_147004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_147004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_147005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_147005(context, evt)
