...
local defs = {
	group_ID = 133217014,
	gadget_thunderThelfID = 14001,
	pointarray_ID = 321700002,
	maxPointCount = 19,
	gadget_Reward_1 = 14002,
	pointInfo = {3,5,7,8,12,16,19} 
}
...
-- 装置
gadgets = {
	{ config_id = 14001, gadget_id = 70350292, pos = { x = -4292.446, y = 203.891, z = -3806.648 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 14 },
	{ config_id = 14002, gadget_id = 70211101, pos = { x = -4386.813, y = 233.834, z = -3857.737 }, rot = { x = 13.368, y = 303.003, z = 335.038 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 14 },
	{ config_id = 14003, gadget_id = 70350292, pos = { x = -4386.328, y = 232.203, z = -3854.733 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 14 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1014004, name = "PLATFORM_REACH_POINT_14004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_14004", action = "action_EVENT_PLATFORM_REACH_POINT_14004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1014005, name = "AVATAR_NEAR_PLATFORM_14005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_14005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_14005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 14001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_14004", "AVATAR_NEAR_PLATFORM_14005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			...
			{ config_id = 14003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_14004(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_14005(context, evt)
