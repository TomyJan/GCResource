...
local defs = {
	group_ID = 133212444,
	gadget_thunderThelfID = 444001,
	pointarray_ID = 321200048,
	maxPointCount = 8,
	gadget_Reward_1 = 444002,
	pointInfo = {1,2,3,7,8} 
}
...
-- 装置
gadgets = {
	{ config_id = 444001, gadget_id = 70350292, pos = { x = -3895.924, y = 265.267, z = -2243.859 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 13 },
	{ config_id = 444003, gadget_id = 70350292, pos = { x = -3902.666, y = 298.077, z = -2258.869 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 13 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1444004, name = "PLATFORM_REACH_POINT_444004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_444004", action = "action_EVENT_PLATFORM_REACH_POINT_444004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1444005, name = "AVATAR_NEAR_PLATFORM_444005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_444005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_444005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 444001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_444004", "AVATAR_NEAR_PLATFORM_444005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 444003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_444004(context, evt)
...
function action_EVENT_PLATFORM_REACH_POINT_444004(context, evt)
	...
	if evt.param3 == defs.maxPointCount then
		...
		if 0 ~= ScriptLib.ChangeGroupVariableValueByGroup(context, "door_open", 1, 133212074) then
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_444005(context, evt)
