...
local defs = {
	group_ID = 133222045,
	gadget_thunderThelfID = 45001,
	pointarray_ID = 322200004,
	maxPointCount = 9,
	gadget_Reward_1 = 45002,
	pointInfo = {8,9} 
}
...
-- 装置
gadgets = {
	{ config_id = 45001, gadget_id = 70350292, pos = { x = -4409.259, y = 204.096, z = -4237.604 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 14 },
	{ config_id = 45002, gadget_id = 70211101, pos = { x = -4462.250, y = 200.632, z = -4307.241 }, rot = { x = 10.197, y = 20.185, z = 5.589 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 14 },
	{ config_id = 45003, gadget_id = 70350292, pos = { x = -4460.451, y = 200.181, z = -4304.716 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 14 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1045004, name = "PLATFORM_REACH_POINT_45004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_45004", action = "action_EVENT_PLATFORM_REACH_POINT_45004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1045005, name = "AVATAR_NEAR_PLATFORM_45005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_45005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_45005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 45001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_45004", "AVATAR_NEAR_PLATFORM_45005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 45002, state = 0 },
			{ config_id = 45003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_45004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_45004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_45005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_45005(context, evt)
