...
-- 装置
gadgets = {
	{ config_id = 182001, gadget_id = 70350292, pos = { x = -3643.156, y = 114.860, z = -890.725 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 17 },
	{ config_id = 182002, gadget_id = 70330114, pos = { x = -3648.690, y = 133.746, z = -818.224 }, rot = { x = 17.567, y = 152.664, z = 1.637 }, level = 30, area_id = 17 },
	{ config_id = 182003, gadget_id = 70350292, pos = { x = -3645.311, y = 113.344, z = -830.906 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, state = GadgetState.GearStart, start_route = false, persistent = true, is_use_point_array = true, area_id = 17 },
	{ config_id = 182006, gadget_id = 70350292, pos = { x = -3653.837, y = 113.284, z = -836.732 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, state = GadgetState.GearStart, start_route = false, persistent = true, is_use_point_array = true, area_id = 17 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1182004, name = "PLATFORM_REACH_POINT_182004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_182004", action = "action_EVENT_PLATFORM_REACH_POINT_182004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1182005, name = "AVATAR_NEAR_PLATFORM_182005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_182005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_182005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 182001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } },
			{ config_id = 182002, state = 0 },
			{ config_id = 182006, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_182004", "AVATAR_NEAR_PLATFORM_182005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 182003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } },
			{ config_id = 182006, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_182004(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_182005(context, evt)
