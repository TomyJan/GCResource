...
local defs = {
	group_ID = 133212108,
	gadget_thunderThelfID = 108001,
	pointarray_ID = 321200020,
	maxPointCount = 9,
	gadget_Reward_1 = 108002,
	pointInfo = {2,3,5,7,9} 
}
...
-- 装置
gadgets = {
	{ config_id = 108001, gadget_id = 70350292, pos = { x = -3885.874, y = 206.999, z = -2554.841 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 13 },
	{ config_id = 108002, gadget_id = 70211101, pos = { x = -3961.725, y = 230.461, z = -2497.295 }, rot = { x = 359.729, y = 213.688, z = 9.030 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 13 },
	{ config_id = 108003, gadget_id = 70350292, pos = { x = -3965.060, y = 231.616, z = -2498.829 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 13 },
	{ config_id = 108006, gadget_id = 70900380, pos = { x = -3897.320, y = 215.308, z = -2559.158 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 13 },
	{ config_id = 108007, gadget_id = 70900380, pos = { x = -3923.281, y = 223.238, z = -2559.158 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 13 },
	{ config_id = 108008, gadget_id = 70900380, pos = { x = -3955.271, y = 228.149, z = -2547.895 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 13 },
	{ config_id = 108009, gadget_id = 70900380, pos = { x = -3979.554, y = 235.894, z = -2537.520 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 13 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1108004, name = "PLATFORM_REACH_POINT_108004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_108004", action = "action_EVENT_PLATFORM_REACH_POINT_108004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1108005, name = "AVATAR_NEAR_PLATFORM_108005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_108005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_108005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 108001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_108004", "AVATAR_NEAR_PLATFORM_108005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 108002, state = 0 },
			{ config_id = 108003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_108004(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_108005(context, evt)
