...
-- 装置
gadgets = {
	{ config_id = 362001, gadget_id = 70350292, pos = { x = -2598.132, y = 208.598, z = -4120.679 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 11 },
	{ config_id = 362003, gadget_id = 70350292, pos = { x = -2576.877, y = 211.667, z = -4123.494 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 11 }
}
