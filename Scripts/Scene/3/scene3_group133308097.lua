...
-- Trigger变量
local defs = {
	pointarray_ID = 330800033,
	pointArrayNum = 3,
	gadget_shooter = 97002,
	gadget_shooterBase_1 = 97001
}
...
-- 装置
gadgets = {
	{ config_id = 97001, gadget_id = 70330300, pos = { x = -1486.595, y = 113.376, z = 4378.743 }, rot = { x = 0.000, y = 249.499, z = 0.000 }, level = 32, persistent = true, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE, area_id = 26 },
	{ config_id = 97002, gadget_id = 70330280, pos = { x = -1486.595, y = 113.376, z = 4378.743 }, rot = { x = 0.000, y = 9.499, z = 0.000 }, level = 32, persistent = true, is_use_point_array = true, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE, area_id = 26 }
}
