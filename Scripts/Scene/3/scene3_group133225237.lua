...
-- 装置
gadgets = {
	{ config_id = 237001, gadget_id = 70310090, pos = { x = -6339.936, y = 259.530, z = -2586.236 }, rot = { x = 350.279, y = 2.488, z = 0.001 }, level = 33, persistent = true, area_id = 18 }
}
...
-- 触发器
triggers = {
	{ config_id = 1237002, name = "GADGET_STATE_CHANGE_237002", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_237002", action = "action_EVENT_GADGET_STATE_CHANGE_237002", trigger_count = 0 },
...
suites = {
	{
		...
		gadgets = { 237001 },
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_237002", "GROUP_LOAD_237003" },
		rand_weight = 100
	}
}
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_237002(context, evt)
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_237002(context, evt)
...
function condition_EVENT_GROUP_LOAD_237003(context, evt)
	if GadgetState.GearStart ~= ScriptLib.GetGadgetStateByConfigId(context, 133225237, 237001) then
		return false
	end
