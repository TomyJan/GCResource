...
-- 装置
gadgets = {
	{ config_id = 28001, gadget_id = 70330331, pos = { x = -2930.391, y = 37.804, z = 4506.038 }, rot = { x = 0.000, y = 117.776, z = 0.000 }, level = 32, area_id = 28 },
	{ config_id = 28002, gadget_id = 70710010, pos = { x = -3010.205, y = 14.014, z = 4412.648 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, route_id = 331200020, area_id = 28 },
	{ config_id = 28003, gadget_id = 70710007, pos = { x = -2930.422, y = 38.865, z = 4506.016 }, rot = { x = 0.000, y = 148.000, z = 0.000 }, level = 32, area_id = 28 },
	{ config_id = 28004, gadget_id = 70211101, pos = { x = -2929.826, y = 38.025, z = 4508.004 }, rot = { x = 350.464, y = 139.974, z = 1.054 }, level = 26, drop_tag = "解谜低级须弥", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 28 }
}

-- 区域
regions = {
	{ config_id = 28007, shape = RegionShape.SPHERE, radius = 5, pos = { x = -3010.220, y = 13.974, z = 4411.501 }, area_id = 28 }
}

-- 触发器
triggers = {
	{ config_id = 1028005, name = "PLATFORM_ARRIVAL_28005", event = EventType.EVENT_PLATFORM_ARRIVAL, source = "", condition = "condition_EVENT_PLATFORM_ARRIVAL_28005", action = "action_EVENT_PLATFORM_ARRIVAL_28005", trigger_count = 0 },
...
suites = {
	{
		...
		regions = { 28007 },
		triggers = { "PLATFORM_ARRIVAL_28005", "AVATAR_NEAR_PLATFORM_28006", "ENTER_REGION_28007", "GADGET_STATE_CHANGE_28008" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发条件
function condition_EVENT_PLATFORM_ARRIVAL_28005(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_ARRIVAL_28005(context, evt)
...
function action_EVENT_ENTER_REGION_28007(context, evt)
	-- 设置移动平台路径
	if 0 ~= ScriptLib.SetPlatformRouteId(context, 28002, 331200019) then
...
function action_EVENT_GADGET_STATE_CHANGE_28008(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133312028, 2) then
