...
-- 装置
gadgets = {
	{ config_id = 135001, gadget_id = 70290160, pos = { x = -6198.913, y = 214.036, z = -2794.865 }, rot = { x = 0.000, y = 246.905, z = 0.000 }, level = 33, persistent = true, area_id = 18 },
	{ config_id = 135003, gadget_id = 70230053, pos = { x = -6198.223, y = 214.243, z = -2796.450 }, rot = { x = 0.000, y = 178.368, z = 0.000 }, level = 33, state = GadgetState.GearStart, persistent = true, area_id = 18 }
}
...
-- 触发器
triggers = {
	{ config_id = 1135002, name = "VARIABLE_CHANGE_135002", event = EventType.EVENT_VARIABLE_CHANGE, source = "", condition = "condition_EVENT_VARIABLE_CHANGE_135002", action = "action_EVENT_VARIABLE_CHANGE_135002" }
}
...
suites = {
	{
		...
		gadgets = { 135001 },
		regions = { },
		triggers = { "VARIABLE_CHANGE_135002" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
