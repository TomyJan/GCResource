...
-- 装置
gadgets = {
	{ config_id = 373001, gadget_id = 70350292, pos = { x = -3542.123, y = 177.971, z = -1190.996 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 17 },
	{ config_id = 373003, gadget_id = 70350292, pos = { x = -3533.460, y = 220.313, z = -1163.662 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 17 }
}
