...
local defs = {
	group_ID = 133222037,
	gadget_thunderThelfID = 37001,
	pointarray_ID = 322200002,
	maxPointCount = 11,
	gadget_Reward_1 = 37002,
	pointInfo = {6,8,11} 
}
...
-- 装置
gadgets = {
	{ config_id = 37001, gadget_id = 70350292, pos = { x = -4246.001, y = 213.139, z = -4266.364 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 14 },
	{ config_id = 37002, gadget_id = 70211101, pos = { x = -4137.297, y = 201.974, z = -4313.074 }, rot = { x = 1.818, y = 223.256, z = 13.051 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 14 },
	{ config_id = 37003, gadget_id = 70350292, pos = { x = -4138.904, y = 201.676, z = -4315.706 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 14 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1037004, name = "PLATFORM_REACH_POINT_37004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_37004", action = "action_EVENT_PLATFORM_REACH_POINT_37004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1037005, name = "AVATAR_NEAR_PLATFORM_37005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_37005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_37005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 37001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_37004", "AVATAR_NEAR_PLATFORM_37005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 37002, state = 0 },
			{ config_id = 37003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_37004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_37004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_37005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_37005(context, evt)
