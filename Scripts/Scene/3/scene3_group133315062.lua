...
-- 装置
gadgets = {
	{ config_id = 62001, gadget_id = 70500000, pos = { x = 553.683, y = 97.850, z = 2531.611 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 10, point_type = 4014, isOneoff = true, persistent = true, explore = { name = "gather", exp = 30 }, area_id = 20, is_enable_interact = false },
	{ config_id = 62002, gadget_id = 70330199, pos = { x = 553.418, y = 96.712, z = 2530.886 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 10, state = GadgetState.GearStop, area_id = 20 }
}
