...
-- 怪物
monsters = {
	{ config_id = 224001, monster_id = 26010201, pos = { x = -6236.871, y = 246.215, z = -2748.713 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, drop_tag = "骗骗花", climate_area_id = 7, area_id = 18 }
}
...
-- 装置
gadgets = {
	{ config_id = 224002, gadget_id = 70510013, pos = { x = -6236.871, y = 246.215, z = -2748.713 }, rot = { x = 0.000, y = 319.800, z = 0.000 }, level = 32, persistent = true, area_id = 18 }
}
...
function action_EVENT_GADGET_STATE_CHANGE_224003(context, evt)
	-- 添加suite2的新内容
	    ScriptLib.AddExtraGroupSuite(context, 133225224, 2)
...
function action_EVENT_GADGET_CREATE_224005(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 133225224, 224002, {173}) then
...
function condition_EVENT_SELECT_OPTION_224006(context, evt)
	-- 判断是gadgetid 224002 option_id 173
...
function action_EVENT_SELECT_OPTION_224006(context, evt)
	...
	-- 删除指定group： 133225224 ；指定config：224002；物件身上指定option：173；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 133225224, 224002, 173) then
