...
local defs = {
	group_ID = 133220526,
	gadget_thunderThelfID = 526001,
	pointarray_ID = 322000032,
	maxPointCount = 14,
	gadget_Reward_1 = 526002,
	pointInfo = {7,10,14} 
}
...
-- 装置
gadgets = {
	{ config_id = 526001, gadget_id = 70350292, pos = { x = -2875.323, y = 202.980, z = -4175.659 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 11 },
	{ config_id = 526002, gadget_id = 70211101, pos = { x = -2851.906, y = 208.040, z = -4094.452 }, rot = { x = 13.100, y = 167.106, z = 0.000 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 11 },
	{ config_id = 526003, gadget_id = 70350292, pos = { x = -2852.453, y = 209.010, z = -4092.555 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 11 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1526004, name = "PLATFORM_REACH_POINT_526004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_526004", action = "action_EVENT_PLATFORM_REACH_POINT_526004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1526005, name = "AVATAR_NEAR_PLATFORM_526005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_526005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_526005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 526001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_526004", "AVATAR_NEAR_PLATFORM_526005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			...
			{ config_id = 526003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_526004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_526004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_526005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_526005(context, evt)
