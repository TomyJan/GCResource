...
local defs = {
	group_ID = 133212003,
	gadget_thunderThelfID = 3001,
	pointarray_ID = 321200007,
	maxPointCount = 7,
	gadget_Reward_1 = 3002,
	pointInfo = {2,4,6,7} 
}
...
-- 装置
gadgets = {
	{ config_id = 3001, gadget_id = 70350292, pos = { x = -3590.689, y = 227.603, z = -1960.727 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 13 },
	{ config_id = 3002, gadget_id = 70211101, pos = { x = -3521.937, y = 200.847, z = -2028.107 }, rot = { x = 0.019, y = 345.202, z = 1.222 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 13 },
	{ config_id = 3003, gadget_id = 70350292, pos = { x = -3520.750, y = 200.901, z = -2025.890 }, rot = { x = 0.000, y = 346.105, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 13 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 3001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_3004", "AVATAR_NEAR_PLATFORM_3005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 3002, state = 0 },
			{ config_id = 3003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_3004(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_3005(context, evt)
