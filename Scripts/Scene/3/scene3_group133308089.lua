...
-- 装置
gadgets = {
	{ config_id = 89001, gadget_id = 70330331, pos = { x = -2463.498, y = 25.067, z = 4324.466 }, rot = { x = 0.000, y = 172.167, z = 0.000 }, level = 32, area_id = 26 },
	{ config_id = 89002, gadget_id = 70710010, pos = { x = -2363.065, y = 48.146, z = 4228.071 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, route_id = 330800030, area_id = 26 },
	{ config_id = 89003, gadget_id = 70710007, pos = { x = -2463.489, y = 25.918, z = 4323.955 }, rot = { x = 0.000, y = 166.066, z = 0.000 }, level = 32, area_id = 26 },
	{ config_id = 89004, gadget_id = 70211101, pos = { x = -2464.454, y = 24.985, z = 4326.513 }, rot = { x = 0.000, y = 173.843, z = 0.000 }, level = 26, drop_tag = "解谜低级须弥", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 26 }
}

-- 区域
regions = {
	{ config_id = 89007, shape = RegionShape.SPHERE, radius = 5, pos = { x = -2363.083, y = 48.190, z = 4228.023 }, area_id = 26 }
}
...
function action_EVENT_ENTER_REGION_89007(context, evt)
	-- 设置移动平台路径
	if 0 ~= ScriptLib.SetPlatformRouteId(context, 89002, 330800029) then
...
function action_EVENT_GADGET_STATE_CHANGE_89008(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133308089, 2) then
