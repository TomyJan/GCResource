...
-- 怪物
monsters = {
	{ config_id = 234001, monster_id = 21020501, pos = { x = -843.940, y = -31.230, z = 4523.205 }, rot = { x = 0.000, y = 134.358, z = 0.000 }, level = 32, drop_tag = "丘丘岩盔王", disableWander = true, pose_id = 401, area_id = 32 }
}
...
-- 装置
gadgets = {
	{ config_id = 234002, gadget_id = 70211012, pos = { x = -844.110, y = -28.033, z = 4527.959 }, rot = { x = 4.870, y = 145.049, z = 355.254 }, level = 26, drop_tag = "战斗中级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 32 }
}
