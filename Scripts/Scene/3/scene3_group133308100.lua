...
-- 装置
gadgets = {
	{ config_id = 100001, gadget_id = 70330331, pos = { x = -2344.256, y = 85.162, z = 4400.669 }, rot = { x = 0.000, y = 165.931, z = 0.000 }, level = 32, area_id = 26 },
	{ config_id = 100002, gadget_id = 70710010, pos = { x = -2297.842, y = 71.022, z = 4297.606 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, route_id = 330800038, area_id = 26 },
	{ config_id = 100003, gadget_id = 70710007, pos = { x = -2344.281, y = 86.188, z = 4400.609 }, rot = { x = 0.000, y = 180.059, z = 0.000 }, level = 32, area_id = 26 },
	{ config_id = 100004, gadget_id = 70211101, pos = { x = -2343.539, y = 85.206, z = 4403.899 }, rot = { x = 0.000, y = 169.828, z = 0.000 }, level = 26, drop_tag = "解谜低级须弥", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 26 }
}

-- 区域
regions = {
	{ config_id = 100007, shape = RegionShape.CUBIC, size = { x = 12.000, y = 5.000, z = 12.000 }, pos = { x = -2290.710, y = 71.022, z = 4297.072 }, area_id = 26 }
}

-- 触发器
triggers = {
	{ config_id = 1100005, name = "PLATFORM_ARRIVAL_100005", event = EventType.EVENT_PLATFORM_ARRIVAL, source = "", condition = "condition_EVENT_PLATFORM_ARRIVAL_100005", action = "action_EVENT_PLATFORM_ARRIVAL_100005", trigger_count = 0 },
...
suites = {
	{
		...
		regions = { 100007 },
		triggers = { "PLATFORM_ARRIVAL_100005", "AVATAR_NEAR_PLATFORM_100006", "ENTER_REGION_100007", "GADGET_STATE_CHANGE_100008" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发条件
function condition_EVENT_PLATFORM_ARRIVAL_100005(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_ARRIVAL_100005(context, evt)
...
function action_EVENT_ENTER_REGION_100007(context, evt)
	-- 设置移动平台路径
	if 0 ~= ScriptLib.SetPlatformRouteId(context, 100002, 330800037) then
...
function action_EVENT_GADGET_STATE_CHANGE_100008(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133308100, 2) then
