...
-- 装置
gadgets = {
	{ config_id = 599001, gadget_id = 70500000, pos = { x = -1840.960, y = 359.550, z = 3534.906 }, rot = { x = 0.000, y = 76.777, z = 0.000 }, level = 10, point_type = 4014, isOneoff = true, persistent = true, explore = { name = "gather", exp = 30 }, area_id = 23, is_enable_interact = false },
