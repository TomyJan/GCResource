...
-- 怪物
monsters = {
	{ config_id = 578001, monster_id = 28020604, pos = { x = -1377.849, y = 77.441, z = 4704.837 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, drop_tag = "走兽", area_id = 26 },
	{ config_id = 578002, monster_id = 26090901, pos = { x = -1377.918, y = 76.865, z = 4704.604 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, drop_tag = "蕈兽", pose_id = 101, area_id = 26 },
	{ config_id = 578003, monster_id = 28050106, pos = { x = -1378.089, y = 77.713, z = 4704.586 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, drop_tag = "魔法生物", area_id = 26 },
	{ config_id = 578005, monster_id = 28060401, pos = { x = -1377.862, y = 76.854, z = 4704.673 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, drop_tag = "走兽", pose_id = 1, area_id = 26 }
}
...
-- 装置
gadgets = {
	{ config_id = 578006, gadget_id = 70330266, pos = { x = -1377.927, y = 77.232, z = 4704.644 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, area_id = 26 },
	{ config_id = 578007, gadget_id = 70210101, pos = { x = -1377.909, y = 76.935, z = 4704.488 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜破损须弥", persistent = true, area_id = 26 }
}

-- 区域
regions = {
	-- 需要伏击怪食用这个
	{ config_id = 578013, shape = RegionShape.SPHERE, radius = 2.35, pos = { x = -1377.635, y = 77.575, z = 4704.919 }, area_id = 26 }
}
...
garbages = {
	monsters = {
		{ config_id = 578004, monster_id = 28050106, pos = { x = -1377.610, y = 77.745, z = 4704.715 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, drop_tag = "魔法生物", area_id = 26 }
	}
}
