...
-- 怪物
monsters = {
	{ config_id = 530001, monster_id = 26010201, pos = { x = -862.478, y = 212.507, z = 1847.399 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 36, drop_tag = "骗骗花", area_id = 19 }
}
...
-- 装置
gadgets = {
	{ config_id = 530002, gadget_id = 70510013, pos = { x = -862.478, y = 212.507, z = 1847.399 }, rot = { x = 327.237, y = 327.530, z = 334.113 }, level = 32, persistent = true, area_id = 19 }
}
...
function action_EVENT_GADGET_STATE_CHANGE_530003(context, evt)
	-- 添加suite2的新内容
	    ScriptLib.AddExtraGroupSuite(context, 133106530, 2)
...
function action_EVENT_GADGET_CREATE_530005(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 133106530, 530002, {173}) then
...
function condition_EVENT_SELECT_OPTION_530006(context, evt)
	-- 判断是gadgetid 530002 option_id 173
...
function action_EVENT_SELECT_OPTION_530006(context, evt)
	...
	-- 删除指定group： 133106530 ；指定config：530002；物件身上指定option：173；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 133106530, 530002, 173) then
