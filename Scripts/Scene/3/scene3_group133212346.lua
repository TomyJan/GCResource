...
local defs = {
	group_ID = 133212346,
	gadget_thunderThelfID = 346001,
	pointarray_ID = 321200042,
	maxPointCount = 22,
	gadget_Reward_1 = 0,
	pointInfo = {5,14,20,22} 
}
...
-- 装置
gadgets = {
	{ config_id = 346001, gadget_id = 70350292, pos = { x = -3691.819, y = 236.001, z = -2263.336 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 13 },
	{ config_id = 346003, gadget_id = 70350292, pos = { x = -3750.201, y = 237.327, z = -2250.450 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 13 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1346004, name = "PLATFORM_REACH_POINT_346004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_346004", action = "action_EVENT_PLATFORM_REACH_POINT_346004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1346005, name = "AVATAR_NEAR_PLATFORM_346005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_346005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_346005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 346001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_346004", "AVATAR_NEAR_PLATFORM_346005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 346003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_346004(context, evt)
	if 346001 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_346005(context, evt)
