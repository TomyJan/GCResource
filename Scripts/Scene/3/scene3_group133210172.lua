...
local defs = {
	...
	pointarray_ID = 321000046,
	maxPointCount = 14,
	gadget_Reward_1 = 0,
	pointInfo = {5,10,14} ,
	next_baton = 133210165
}
...
-- 装置
gadgets = {
	{ config_id = 172001, gadget_id = 70350292, pos = { x = -3935.668, y = 168.855, z = -705.423 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, start_route = false, persistent = true, is_use_point_array = true, area_id = 17 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1172002, name = "PLATFORM_REACH_POINT_172002", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_172002", action = "action_EVENT_PLATFORM_REACH_POINT_172002", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1172003, name = "AVATAR_NEAR_PLATFORM_172003", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_172003", action = "action_EVENT_AVATAR_NEAR_PLATFORM_172003", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 172001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_172002", "AVATAR_NEAR_PLATFORM_172003" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_172002(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_172003(context, evt)
