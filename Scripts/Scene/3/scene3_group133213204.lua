...
-- 装置
gadgets = {
	{ config_id = 204001, gadget_id = 70710006, pos = { x = -3321.585, y = 217.187, z = -3448.878 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, area_id = 12 },
	{ config_id = 204002, gadget_id = 70710010, pos = { x = -3314.632, y = 212.311, z = -3511.192 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, route_id = 321300033, area_id = 12 },
	{ config_id = 204003, gadget_id = 70710007, pos = { x = -3323.277, y = 217.842, z = -3450.721 }, rot = { x = 0.000, y = 355.211, z = 0.000 }, level = 32, area_id = 12 },
	{ config_id = 204004, gadget_id = 70211101, pos = { x = -3322.116, y = 217.228, z = -3450.397 }, rot = { x = 0.000, y = 332.738, z = 0.000 }, level = 26, drop_tag = "解谜低级稻妻", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 12 }
}

-- 区域
regions = {
	{ config_id = 204007, shape = RegionShape.SPHERE, radius = 5, pos = { x = -3314.260, y = 212.287, z = -3511.648 }, area_id = 12 }
}
...
function action_EVENT_ENTER_REGION_204007(context, evt)
	-- 设置移动平台路径
	if 0 ~= ScriptLib.SetPlatformRouteId(context, 204002, 321300032) then
...
function action_EVENT_GADGET_STATE_CHANGE_204008(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133213204, 2) then
