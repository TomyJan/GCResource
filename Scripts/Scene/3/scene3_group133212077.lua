...
local defs = {
	...
	pointarray_ID = 321200050,
	maxPointCount = 11,
	gadget_Reward_1 = 77002,
	pointInfo = {1,3,7,10,11} 
}
...
-- 装置
gadgets = {
	{ config_id = 77001, gadget_id = 70350292, pos = { x = -3910.255, y = 274.503, z = -2260.610 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 13 },
	{ config_id = 77003, gadget_id = 70350292, pos = { x = -3892.306, y = 297.558, z = -2254.127 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 13 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1077004, name = "PLATFORM_REACH_POINT_77004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_77004", action = "action_EVENT_PLATFORM_REACH_POINT_77004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
...
suite_disk = {
	[1] = {
		...
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_77004", "AVATAR_NEAR_PLATFORM_77005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 77003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_77004(context, evt)
