...
-- 装置
gadgets = {
	{ config_id = 25001, gadget_id = 70330331, pos = { x = -1451.813, y = 75.258, z = 4849.827 }, rot = { x = 0.000, y = 330.394, z = 0.000 }, level = 32, area_id = 26 },
	{ config_id = 25002, gadget_id = 70710010, pos = { x = -1589.920, y = 95.205, z = 4944.952 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, route_id = 330800002, area_id = 26 },
	{ config_id = 25003, gadget_id = 70710007, pos = { x = -1452.202, y = 76.613, z = 4850.141 }, rot = { x = 0.000, y = 296.647, z = 0.000 }, level = 32, area_id = 26 },
	{ config_id = 25004, gadget_id = 70211101, pos = { x = -1448.716, y = 73.220, z = 4844.771 }, rot = { x = 0.000, y = 328.729, z = 0.000 }, level = 26, drop_tag = "解谜低级须弥", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 26 }
}

-- 区域
regions = {
	{ config_id = 25007, shape = RegionShape.SPHERE, radius = 5, pos = { x = -1586.989, y = 96.045, z = 4941.515 }, area_id = 26 }
}
...
function action_EVENT_ENTER_REGION_25007(context, evt)
	-- 设置移动平台路径
	if 0 ~= ScriptLib.SetPlatformRouteId(context, 25002, 330800001) then
...
function action_EVENT_GADGET_STATE_CHANGE_25008(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133308025, 2) then
