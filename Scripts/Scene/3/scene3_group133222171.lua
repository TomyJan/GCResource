...
local defs = {
	group_ID = 133222171,
	gadget_thunderThelfID = 171001,
	pointarray_ID = 322200016,
	maxPointCount = 15,
	gadget_Reward_1 = 171002,
	pointInfo = {3,5,12,15} 
}
...
-- 装置
gadgets = {
	{ config_id = 171001, gadget_id = 70350292, pos = { x = -4979.686, y = 203.662, z = -4344.625 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 14 },
	{ config_id = 171002, gadget_id = 70211101, pos = { x = -5008.483, y = 268.051, z = -4251.236 }, rot = { x = 17.923, y = 321.576, z = 346.197 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, autopick = true, explore = { name = "chest", exp = 1 }, area_id = 14 },
	{ config_id = 171003, gadget_id = 70350292, pos = { x = -5007.629, y = 268.419, z = -4252.386 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 14 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1171004, name = "PLATFORM_REACH_POINT_171004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_171004", action = "action_EVENT_PLATFORM_REACH_POINT_171004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1171005, name = "AVATAR_NEAR_PLATFORM_171005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_171005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_171005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 171001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_171004", "AVATAR_NEAR_PLATFORM_171005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 171002, state = 0 },
			{ config_id = 171003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_171004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_171004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_171005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_171005(context, evt)
