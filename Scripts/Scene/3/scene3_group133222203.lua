...
local defs = {
	group_ID = 133222203,
	gadget_thunderThelfID = 203001,
	pointarray_ID = 322200017,
	maxPointCount = 14,
	gadget_Reward_1 = 203002,
	pointInfo = {1,2,4,14} 
}
...
-- 装置
gadgets = {
	{ config_id = 203001, gadget_id = 70350292, pos = { x = -4822.810, y = 222.381, z = -4806.819 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 14 },
	{ config_id = 203002, gadget_id = 70211101, pos = { x = -4809.487, y = 247.523, z = -4664.478 }, rot = { x = 345.067, y = 208.611, z = 359.329 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 14 },
	{ config_id = 203003, gadget_id = 70350292, pos = { x = -4805.113, y = 253.438, z = -4663.969 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 14 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1203004, name = "PLATFORM_REACH_POINT_203004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_203004", action = "action_EVENT_PLATFORM_REACH_POINT_203004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1203005, name = "AVATAR_NEAR_PLATFORM_203005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_203005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_203005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 203001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_203004", "AVATAR_NEAR_PLATFORM_203005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 203002, state = 0 },
			{ config_id = 203003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_203004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_203004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_203005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_203005(context, evt)
