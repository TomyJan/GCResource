...
local defs = {
	group_ID = 133220039,
	gadget_thunderThelfID = 39001,
	pointarray_ID = 322000022,
	maxPointCount = 14,
	gadget_Reward_1 = 39002,
	pointInfo = {5,10,14} 
}
...
-- 装置
gadgets = {
	{ config_id = 39001, gadget_id = 70350292, pos = { x = -2965.285, y = 207.047, z = -4069.463 }, rot = { x = 0.000, y = 31.261, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 11 },
	{ config_id = 39002, gadget_id = 70211101, pos = { x = -3022.175, y = 201.189, z = -4020.709 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 11 },
	{ config_id = 39003, gadget_id = 70350292, pos = { x = -3016.994, y = 207.604, z = -4020.879 }, rot = { x = 0.000, y = 251.032, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 11 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1039004, name = "PLATFORM_REACH_POINT_39004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_39004", action = "action_EVENT_PLATFORM_REACH_POINT_39004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1039005, name = "AVATAR_NEAR_PLATFORM_39005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_39005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_39005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 39001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_39004", "AVATAR_NEAR_PLATFORM_39005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 39002, state = 0 },
			{ config_id = 39003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_39004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_39004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_39005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_39005(context, evt)
