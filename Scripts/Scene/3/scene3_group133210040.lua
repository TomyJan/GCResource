...
local defs = {
	group_ID = 133210040,
	gadget_thunderThelfID = 40001,
	pointarray_ID = 321000014,
	maxPointCount = 14,
	gadget_Reward_1 = 40002,
	pointInfo = {5,7,9,12,13,14} 
}
...
-- 装置
gadgets = {
	{ config_id = 40001, gadget_id = 70350292, pos = { x = -4034.412, y = 214.319, z = -1254.838 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 17 },
	{ config_id = 40002, gadget_id = 70211101, pos = { x = -3976.305, y = 199.755, z = -1164.605 }, rot = { x = 0.000, y = 237.682, z = 0.000 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 17 },
	{ config_id = 40003, gadget_id = 70350292, pos = { x = -3978.116, y = 199.874, z = -1167.406 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 17 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1040004, name = "PLATFORM_REACH_POINT_40004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_40004", action = "action_EVENT_PLATFORM_REACH_POINT_40004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1040005, name = "AVATAR_NEAR_PLATFORM_40005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_40005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_40005", trigger_count = 0 }
}
...
variables = {
	...
	{ config_id = 7, name = "AddRegion", value = 0, no_refresh = false }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 40001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_40004", "AVATAR_NEAR_PLATFORM_40005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 40002, state = 0 },
			{ config_id = 40003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_40004(context, evt)
...
function action_EVENT_PLATFORM_REACH_POINT_40004(context, evt)
	...
	-- 将本组内变量名为 "AddRegion" 的变量设置为 1
	if 0 ~= ScriptLib.SetGroupVariableValue(context, "AddRegion", 1) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_groupVariable")
	  return -1
	end
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_40005(context, evt)
