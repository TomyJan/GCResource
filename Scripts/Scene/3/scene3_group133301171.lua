...
-- 装置
gadgets = {
	{ config_id = 171001, gadget_id = 70360001, pos = { x = -1185.494, y = 183.638, z = 2483.595 }, rot = { x = 348.311, y = 253.020, z = 5.694 }, level = 33, isOneoff = true, persistent = true, area_id = 21 },
	{ config_id = 171002, gadget_id = 70211101, pos = { x = -1185.762, y = 183.799, z = 2483.124 }, rot = { x = 12.051, y = 24.738, z = 356.005 }, level = 26, drop_tag = "解谜低级须弥", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 21 }
}
...
triggers = {
	...
	{ config_id = 1171004, name = "SELECT_OPTION_171004", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_171004", action = "action_EVENT_SELECT_OPTION_171004" },
...
suites = {
	{
		...
		gadgets = { 171001 },
		regions = { },
		triggers = { "GADGET_CREATE_171003", "SELECT_OPTION_171004" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_SELECT_OPTION_171004(context, evt)
	-- 删除指定group： 133301171 ；指定config：171001；物件身上指定option：169；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 133301171, 171001, 169) then
	...
	-- 运营数据埋点，匹配LD定义的规则使用
		...
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 133301171, suite = 2 }) then
...
function condition_EVENT_GADGET_STATE_CHANGE_171005(context, evt)
	if 171002 ~= evt.param2 or GadgetState.ChestOpened ~= evt.param1 then
		return false
	end
