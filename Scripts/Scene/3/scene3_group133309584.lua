...
-- Trigger变量
local defs = {
	pointarray_ID = 330900057,
	pointArrayNum = 2,
	gadget_shooter = 584002,
	gadget_shooterBase_1 = 584001
}
...
-- 装置
gadgets = {
	{ config_id = 584001, gadget_id = 70330300, pos = { x = -2379.271, y = 131.622, z = 5593.442 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 32, persistent = true, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE, area_id = 27 },
	{ config_id = 584002, gadget_id = 70330280, pos = { x = -2379.271, y = 131.622, z = 5593.442 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 32, persistent = true, is_use_point_array = true, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE, area_id = 27 }
}
