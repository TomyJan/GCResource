...
-- 怪物
monsters = {
	{ config_id = 3001, monster_id = 21020501, pos = { x = 587.109, y = 297.489, z = 6599.324 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, drop_tag = "丘丘岩盔王", disableWander = true, area_id = 30 }
}
...
-- 装置
gadgets = {
	{ config_id = 3002, gadget_id = 70211022, pos = { x = 587.066, y = 297.489, z = 6602.600 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "战斗高级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 30 }
}
