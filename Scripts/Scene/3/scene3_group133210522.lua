...
-- 怪物
monsters = {
	{ config_id = 522001, monster_id = 25100101, pos = { x = -3859.995, y = 121.284, z = -1004.339 }, rot = { x = 0.000, y = 103.707, z = 0.000 }, level = 32, drop_tag = "高阶武士", disableWander = true, pose_id = 1001, area_id = 17 }
}
...
-- 装置
gadgets = {
	{ config_id = 522002, gadget_id = 70211002, pos = { x = -3870.992, y = 122.209, z = -1002.837 }, rot = { x = 18.024, y = 115.928, z = 5.328 }, level = 26, drop_tag = "战斗低级稻妻", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 17 }
}
