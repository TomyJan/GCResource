...
-- 区域
regions = {
	{ config_id = 215001, shape = RegionShape.SPHERE, radius = 3, pos = { x = -2466.202, y = 448.245, z = -4420.700 }, area_id = 11 }
}
...
function action_EVENT_ENTER_REGION_215001(context, evt)
	...
	if 0 ~= ScriptLib.AddQuestProgress(context, "13322021501") then
		ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : add_quest_progress")
	  return -1
	end
	
	-- 调用提示id为 -1074245595 的提示UI，会显示在屏幕中央偏下位置，id索引自 ReminderData表格
	if 0 ~= ScriptLib.ShowReminder(context, -1074245595) then
