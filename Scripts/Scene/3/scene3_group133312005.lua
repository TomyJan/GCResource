...
-- 装置
gadgets = {
	{ config_id = 5001, gadget_id = 70330331, pos = { x = -3251.993, y = 366.175, z = 4841.862 }, rot = { x = 0.000, y = 73.253, z = 0.000 }, level = 32, area_id = 28 },
	{ config_id = 5002, gadget_id = 70710010, pos = { x = -3147.372, y = 336.633, z = 4820.079 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, route_id = 331200025, area_id = 28 },
	{ config_id = 5003, gadget_id = 70710007, pos = { x = -3251.944, y = 367.230, z = 4841.797 }, rot = { x = 0.000, y = 95.346, z = 0.000 }, level = 32, area_id = 28 },
	{ config_id = 5004, gadget_id = 70211101, pos = { x = -3251.065, y = 366.866, z = 4838.558 }, rot = { x = 7.596, y = 16.820, z = 3.368 }, level = 26, drop_tag = "解谜低级须弥", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 28 }
}

-- 区域
regions = {
	-- 机器人峡谷顶布设-愚人众营地仙灵
	{ config_id = 5007, shape = RegionShape.SPHERE, radius = 5, pos = { x = -3147.372, y = 337.133, z = 4820.079 }, area_id = 28 }
}

-- 触发器
triggers = {
	{ config_id = 1005005, name = "PLATFORM_ARRIVAL_5005", event = EventType.EVENT_PLATFORM_ARRIVAL, source = "", condition = "condition_EVENT_PLATFORM_ARRIVAL_5005", action = "action_EVENT_PLATFORM_ARRIVAL_5005", trigger_count = 0 },
...
suites = {
	{
		...
		regions = { 5007 },
		triggers = { "PLATFORM_ARRIVAL_5005", "AVATAR_NEAR_PLATFORM_5006", "ENTER_REGION_5007", "GADGET_STATE_CHANGE_5008" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ENTER_REGION_5007(context, evt)
	-- 设置移动平台路径
	if 0 ~= ScriptLib.SetPlatformRouteId(context, 5002, 331200024) then
...
function action_EVENT_GADGET_STATE_CHANGE_5008(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133312005, 2) then
