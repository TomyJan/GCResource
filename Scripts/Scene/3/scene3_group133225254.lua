...
-- 装置
gadgets = {
	{ config_id = 254001, gadget_id = 70310090, pos = { x = -6376.340, y = 248.795, z = -2544.332 }, rot = { x = 358.163, y = 281.327, z = 356.810 }, level = 33, persistent = true, area_id = 18 }
}
...
-- 触发器
triggers = {
	{ config_id = 1254002, name = "GADGET_STATE_CHANGE_254002", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_254002", action = "action_EVENT_GADGET_STATE_CHANGE_254002", trigger_count = 0 },
...
suites = {
	{
		...
		gadgets = { 254001 },
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_254002", "GROUP_LOAD_254003" },
		rand_weight = 100
	}
}
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_254002(context, evt)
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_254002(context, evt)
...
function condition_EVENT_GROUP_LOAD_254003(context, evt)
	if GadgetState.GearStart ~= ScriptLib.GetGadgetStateByConfigId(context, 133225254, 254001) then
		return false
	end
