...
-- 装置
gadgets = {
	{ config_id = 269001, gadget_id = 70350292, pos = { x = -3699.502, y = 113.949, z = -838.235 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, start_route = false, persistent = true, is_use_point_array = true, area_id = 17 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1269002, name = "PLATFORM_REACH_POINT_269002", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_269002", action = "action_EVENT_PLATFORM_REACH_POINT_269002", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1269003, name = "AVATAR_NEAR_PLATFORM_269003", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_269003", action = "action_EVENT_AVATAR_NEAR_PLATFORM_269003", trigger_count = 0 },
	-- 上一步完成创建闪电球
	...
	-- 上一步完成创建闪电球
	{ config_id = 1269005, name = "GROUP_LOAD_269005", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_269005", action = "action_EVENT_GROUP_LOAD_269005", trigger_count = 0 },
	-- 玩法完成刷到suite2
	{ config_id = 1269006, name = "GROUP_LOAD_269006", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_269006", action = "action_EVENT_GROUP_LOAD_269006", trigger_count = 0 },
	-- 玩法完成刷到suite2
	{ config_id = 1269007, name = "VARIABLE_CHANGE_269007", event = EventType.EVENT_VARIABLE_CHANGE, source = "", condition = "condition_EVENT_VARIABLE_CHANGE_269007", action = "action_EVENT_VARIABLE_CHANGE_269007" }
}
...
suite_disk = {
	[1] = {
		...
		regions = { },
		triggers = { "VARIABLE_CHANGE_269004", "GROUP_LOAD_269005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 269001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_269002", "AVATAR_NEAR_PLATFORM_269003", "GROUP_LOAD_269006", "VARIABLE_CHANGE_269007" },
		npcs = { },
		variables = {
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_269002(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_269003(context, evt)
...
function action_EVENT_VARIABLE_CHANGE_269004(context, evt)
	-- 调用提示id为 32100167 的提示UI，会显示在屏幕中央偏下位置，id索引自 ReminderData表格
	if 0 ~= ScriptLib.ShowReminder(context, 32100167) then
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_269005(context, evt)
	-- 判断变量"next_baton_start"为1
	if ScriptLib.GetGroupVariableValue(context, "next_baton_start") ~= 1 then
			return false
	end
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_269006(context, evt)
	-- 判断变量"ReachPoint"为1
