...
-- 区域
regions = {
	{ config_id = 3001, shape = RegionShape.CUBIC, size = { x = 50.000, y = 20.000, z = 20.000 }, pos = { x = -2352.084, y = 73.550, z = 5247.491 }, area_id = 27 }
}
...
function action_EVENT_ENTER_REGION_3001(context, evt)
	...
	if 0 ~= ScriptLib.AddQuestProgress(context, "7305326") then
