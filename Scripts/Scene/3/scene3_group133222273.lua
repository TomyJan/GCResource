...
local defs = {
	group_ID = 133222273,
	gadget_thunderThelfID = 273001,
	pointarray_ID = 322200030,
	maxPointCount = 13,
	gadget_Reward_1 = 273002,
	pointInfo = {6,9,12,13} 
}
...
-- 装置
gadgets = {
	{ config_id = 273001, gadget_id = 70350292, pos = { x = -4282.165, y = 220.762, z = -4217.762 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 14 },
	{ config_id = 273002, gadget_id = 70211101, pos = { x = -4349.231, y = 239.560, z = -4193.129 }, rot = { x = 18.669, y = 124.201, z = 359.745 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 14 },
	{ config_id = 273003, gadget_id = 70350292, pos = { x = -4345.281, y = 241.344, z = -4190.309 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 14 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1273004, name = "PLATFORM_REACH_POINT_273004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_273004", action = "action_EVENT_PLATFORM_REACH_POINT_273004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1273005, name = "AVATAR_NEAR_PLATFORM_273005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_273005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_273005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 273001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_273004", "AVATAR_NEAR_PLATFORM_273005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 273002, state = 0 },
			{ config_id = 273003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_273004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_273004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_273005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_273005(context, evt)
