...
local defs = {
	group_ID = 133220325,
	gadget_thunderThelfID = 325001,
	pointarray_ID = 322000012,
	maxPointCount = 14,
	gadget_Reward_1 = 325002,
	pointInfo = {5,10,14} 
}
...
-- 装置
gadgets = {
	{ config_id = 325001, gadget_id = 70350292, pos = { x = -2642.162, y = 212.732, z = -4227.258 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 11 },
	{ config_id = 325002, gadget_id = 70211101, pos = { x = -2598.332, y = 229.345, z = -4325.520 }, rot = { x = 5.994, y = 277.168, z = 355.615 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 11 },
	{ config_id = 325003, gadget_id = 70350292, pos = { x = -2602.174, y = 228.884, z = -4324.670 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 11 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1325004, name = "PLATFORM_REACH_POINT_325004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_325004", action = "action_EVENT_PLATFORM_REACH_POINT_325004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1325005, name = "AVATAR_NEAR_PLATFORM_325005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_325005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_325005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 325001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_325004", "AVATAR_NEAR_PLATFORM_325005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 325002, state = 0 },
			{ config_id = 325003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_325004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_325004(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_325005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_325005(context, evt)
