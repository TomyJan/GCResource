...
-- 装置
gadgets = {
	{ config_id = 40001, gadget_id = 70330331, pos = { x = -2281.047, y = 97.972, z = 5241.547 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 32, area_id = 27 },
	{ config_id = 40002, gadget_id = 70710010, pos = { x = -2315.861, y = 75.462, z = 5149.010 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, route_id = 331000103, area_id = 27 },
	{ config_id = 40003, gadget_id = 70710007, pos = { x = -2281.248, y = 98.526, z = 5240.366 }, rot = { x = 0.000, y = 183.673, z = 0.000 }, level = 32, area_id = 27 },
	{ config_id = 40004, gadget_id = 70211101, pos = { x = -2285.950, y = 97.972, z = 5242.547 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 26, drop_tag = "解谜低级须弥", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 27 }
}

-- 区域
regions = {
	{ config_id = 40007, shape = RegionShape.SPHERE, radius = 5, pos = { x = -2315.861, y = 75.462, z = 5149.010 }, area_id = 27 }
}
...
function action_EVENT_ENTER_REGION_40007(context, evt)
	-- 设置移动平台路径
	if 0 ~= ScriptLib.SetPlatformRouteId(context, 40002, 331000102) then
...
function action_EVENT_GADGET_STATE_CHANGE_40008(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133310040, 2) then
