...
-- 装置
gadgets = {
	[53001] = { config_id = 53001, gadget_id = 70330236, pos = { x = -12.674, y = 246.159, z = 3437.697 }, rot = { x = 0.002, y = 292.301, z = 359.953 }, level = 27, persistent = true, area_id = 29 },
	[53002] = { config_id = 53002, gadget_id = 70330236, pos = { x = -11.921, y = 190.527, z = 3438.076 }, rot = { x = 0.002, y = 269.237, z = 359.953 }, level = 27, persistent = true, area_id = 29 },
	-- 1号门trigger 下面参数为传送后坐标
	[53003] = { config_id = 53003, gadget_id = 70290264, pos = { x = -13.145, y = 246.394, z = 3438.009 }, rot = { x = 0.000, y = 294.036, z = 0.000 }, level = 27, area_id = 29 },
	-- 2号门trigger 下面参数为传送后坐标
	[53004] = { config_id = 53004, gadget_id = 70290264, pos = { x = -12.665, y = 191.266, z = 3438.004 }, rot = { x = 0.000, y = 264.313, z = 0.000 }, level = 27, area_id = 29 }
}
...
triggers = {
	-- 2号门成功时注目
	{ config_id = 1053005, name = "GADGET_STATE_CHANGE_53005", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_53005", action = "action_EVENT_GADGET_STATE_CHANGE_53005" },
	-- 1号门触发
...
-- 点位
points = {
	[53009] = { config_id = 53009, pos = { x = -19.767, y = 249.096, z = 3443.292 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, area_id = 29 }
}
...
suites = {
	{
		...
		gadgets = { 53001, 53002 },
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_53005", "GADGET_STATE_CHANGE_53006", "GADGET_STATE_CHANGE_53007", "GADGET_STATE_CHANGE_53008" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_GADGET_STATE_CHANGE_53006(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133301053, 2) then
