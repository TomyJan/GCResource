...
local defs = {
	group_ID = 133223101,
	gadget_thunderThelfID = 101001,
	pointarray_ID = 322300009,
	maxPointCount = 16,
	gadget_Reward_1 = 101002,
	pointInfo = {3,5,8,13,16} ,
...
-- 装置
gadgets = {
	{ config_id = 101001, gadget_id = 70350292, pos = { x = -6249.406, y = 244.775, z = -2958.139 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 18 },
	{ config_id = 101003, gadget_id = 70350292, pos = { x = -6114.744, y = 223.339, z = -2772.285 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 18 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1101004, name = "PLATFORM_REACH_POINT_101004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_101004", action = "action_EVENT_PLATFORM_REACH_POINT_101004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1101005, name = "AVATAR_NEAR_PLATFORM_101005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_101005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_101005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 101001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_101004", "AVATAR_NEAR_PLATFORM_101005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			{ config_id = 101003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_101004(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_101004(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "thief_C_finish", 1, 133223075) then
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_101005(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_101005(context, evt)
