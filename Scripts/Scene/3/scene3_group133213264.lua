...
local defs = {
	group_ID = 133213264,
	gadget_thunderThelfID = 264001,
	pointarray_ID = 321300027,
	maxPointCount = 14,
	gadget_Reward_1 = 264002,
	pointInfo = {5,10,14} 
}
...
-- 装置
gadgets = {
	{ config_id = 264001, gadget_id = 70350292, pos = { x = -3755.153, y = 203.273, z = -2965.253 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 12 },
	{ config_id = 264002, gadget_id = 70211101, pos = { x = -3874.578, y = 246.404, z = -3023.064 }, rot = { x = 1.213, y = 53.180, z = 6.118 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 12 },
	{ config_id = 264003, gadget_id = 70350292, pos = { x = -3875.929, y = 246.379, z = -3023.891 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 12 }
}
...
triggers = {
	-- 到达中断点停止
	{ config_id = 1264004, name = "PLATFORM_REACH_POINT_264004", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_264004", action = "action_EVENT_PLATFORM_REACH_POINT_264004", trigger_count = 0 },
	-- 玩家接近雷仙灵后触发移动
	{ config_id = 1264005, name = "AVATAR_NEAR_PLATFORM_264005", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_264005", action = "action_EVENT_AVATAR_NEAR_PLATFORM_264005", trigger_count = 0 }
}
...
suite_disk = {
	[1] = {
		gadgets = {
			{ config_id = 264001, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
		triggers = { "PLATFORM_REACH_POINT_264004", "AVATAR_NEAR_PLATFORM_264005" },
		npcs = { },
		variables = {
			{ config_id = 1, name = "isFinished", value = 0, no_refresh = true },
			{ config_id = 2, name = "isMoving", value = 0, no_refresh = false },
	...
	[2] = {
		gadgets = {
			...
			{ config_id = 264003, state = 201, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } }
		},
		monsters = {
		},
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_264004(context, evt)
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_264005(context, evt)
