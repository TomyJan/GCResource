...
-- 装置
gadgets = {
	{ config_id = 4001, gadget_id = 70340012, pos = { x = 0.000, y = 511.917, z = -46.200 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 4002, gadget_id = 70350008, pos = { x = 0.000, y = 514.472, z = -41.598 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
