...
function action_EVENT_SELECT_OPTION_1003(context, evt)
	ScriptLib.AutoMonsterTide(context, 1, 240661002, {2004,2005,2006,2007,2008,2010,2011,2012,2013,2014,2015,2016}, 12, 5, 5)
	
	TLA_del_work_options_by_group_configid(context, evt, 240661001, 1001, 7)
	
	TLA_set_gadget_state_by_configid(context, evt, 1001, GadgetState.GearStop)
	
	TLA_refresh_group_tosuite(context, evt, 240661003, 2)
