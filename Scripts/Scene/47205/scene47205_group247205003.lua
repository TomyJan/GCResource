...
-- 怪物
monsters = {
	{ config_id = 3007, monster_id = 24040301, pos = { x = 330.335, y = 154.979, z = 362.332 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 1 },
	{ config_id = 3008, monster_id = 24040201, pos = { x = 330.254, y = 154.979, z = 367.396 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 1 }
}
...
function action_EVENT_SELECT_OPTION_3003(context, evt)
	...
	-- 添加suite2的新内容，刷怪
	    ScriptLib.AddExtraGroupSuite(context, 247205003, 2)
	...
	-- 删除指定group： 247205003 ；指定config：3001；物件身上指定option：7；
...
function action_EVENT_VARIABLE_CHANGE_3005(context, evt)
	...
	-- 改变指定group组247205001中， configid为1019的gadget的state
