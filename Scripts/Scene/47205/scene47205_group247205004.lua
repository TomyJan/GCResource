...
-- 怪物
monsters = {
	{ config_id = 4006, monster_id = 25010601, pos = { x = 239.917, y = 162.354, z = 446.489 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4007, monster_id = 25010601, pos = { x = 246.582, y = 162.354, z = 446.429 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4008, monster_id = 25210501, pos = { x = 244.554, y = 162.406, z = 446.781 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4009, monster_id = 25210403, pos = { x = 242.050, y = 162.354, z = 446.781 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4010, monster_id = 25210302, pos = { x = 238.461, y = 162.354, z = 444.207 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4011, monster_id = 25010201, pos = { x = 248.122, y = 162.354, z = 444.207 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4012, monster_id = 25070101, pos = { x = 248.122, y = 162.354, z = 442.078 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4014, monster_id = 25210201, pos = { x = 238.461, y = 162.354, z = 442.078 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true }
}
...
function action_EVENT_SELECT_OPTION_4003(context, evt)
	...
	-- 刷怪
	    ScriptLib.AutoMonsterTide(context, 1, defs.group_1, {4006,4007,4008,4009,4010,4011,4012,4014}, 8, 4, 4)
	...
	-- 删除指定group： 247205004 ；指定config：4001；物件身上指定option：7；
...
function action_EVENT_VARIABLE_CHANGE_4005(context, evt)
	...
	-- 改变指定group组247205001中， configid为1020的gadget的state
