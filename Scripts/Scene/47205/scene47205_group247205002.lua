...
-- 怪物
monsters = {
	{ config_id = 2006, monster_id = 20060201, pos = { x = 242.073, y = 157.414, z = 287.574 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 2007, monster_id = 20050703, pos = { x = 241.145, y = 157.414, z = 287.574 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 2008, monster_id = 20060201, pos = { x = 244.506, y = 157.414, z = 287.576 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 2009, monster_id = 20011001, pos = { x = 239.517, y = 157.461, z = 287.554 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 2010, monster_id = 20011001, pos = { x = 247.052, y = 157.414, z = 287.501 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 2011, monster_id = 20050703, pos = { x = 245.279, y = 157.414, z = 287.576 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true }
}
...
function action_EVENT_SELECT_OPTION_2003(context, evt)
	...
	-- 删除指定group： 247205002 ；指定config：2001；物件身上指定option：7；
...
function action_EVENT_VARIABLE_CHANGE_2005(context, evt)
	...
	-- 改变指定group组247205001中， configid为1018的gadget的state
