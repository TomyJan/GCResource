...
-- 怪物
monsters = {
	{ config_id = 12006, monster_id = 25310101, pos = { x = 136.497, y = 194.894, z = 362.630 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 11, disableWander = true, affix = { 1007 }, pose_id = 1 },
	{ config_id = 12007, monster_id = 25310301, pos = { x = 136.418, y = 194.894, z = 365.003 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 11, disableWander = true, affix = { 1007 } },
	{ config_id = 12008, monster_id = 25210203, pos = { x = 136.556, y = 194.894, z = 367.415 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 11, disableWander = true, affix = { 1007 } },
	{ config_id = 12010, monster_id = 25080101, pos = { x = 135.572, y = 194.727, z = 362.108 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 11, disableWander = true, affix = { 1007 }, pose_id = 1 },
	{ config_id = 12011, monster_id = 25100201, pos = { x = 135.493, y = 194.727, z = 365.003 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 11, disableWander = true, affix = { 1007 }, pose_id = 1 },
	{ config_id = 12012, monster_id = 25080201, pos = { x = 135.630, y = 194.727, z = 368.018 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 11, disableWander = true, affix = { 1007 }, pose_id = 1 }
}
...
function action_EVENT_SELECT_OPTION_12003(context, evt)
	...
	-- 添加suite2的新内容，刷怪空气墙
	    ScriptLib.AddExtraGroupSuite(context, 247205012, 2)
	
	-- 删除指定group： 247205012 ；指定config：12001；物件身上指定option：7；
...
function condition_EVENT_VARIABLE_CHANGE_12004(context, evt)
	...
	-- 判断变量"success"为0
	if ScriptLib.GetGroupVariableValueByGroup(context, "success", 247205001) ~= 0 then
			return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_12013(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 247205012, 3)
