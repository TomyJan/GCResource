...
-- 怪物
monsters = {
	{ config_id = 9006, monster_id = 21011301, pos = { x = 322.141, y = 163.312, z = 481.963 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 9007, monster_id = 21011301, pos = { x = 326.973, y = 163.312, z = 481.849 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 9008, monster_id = 21010201, pos = { x = 319.723, y = 163.189, z = 481.533 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 9009, monster_id = 21010201, pos = { x = 329.367, y = 163.189, z = 481.549 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 9010, monster_id = 21030301, pos = { x = 324.659, y = 163.189, z = 481.967 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 9011, monster_id = 21010701, pos = { x = 323.261, y = 163.189, z = 484.334 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 9012, monster_id = 21010701, pos = { x = 325.901, y = 163.189, z = 484.302 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true }
}
...
function action_EVENT_GADGET_CREATE_9002(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 247205009, 9001, {7}) then
...
function action_EVENT_SELECT_OPTION_9003(context, evt)
	...
	ScriptLib.AutoMonsterTide(context, 1, defs.group_1, {9006,9007,9008,9009,9010,9011,9012}, 7, 5, 5)
	...
	-- 删除指定group： 247205009 ；指定config：9001；物件身上指定option：7；
