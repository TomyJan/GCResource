...
-- 怪物
monsters = {
	{ config_id = 10006, monster_id = 25210102, pos = { x = 333.374, y = 179.017, z = 268.078 }, rot = { x = 0.000, y = 315.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 10007, monster_id = 25210401, pos = { x = 329.987, y = 179.017, z = 264.413 }, rot = { x = 0.000, y = 315.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 10008, monster_id = 25210203, pos = { x = 328.108, y = 179.017, z = 262.807 }, rot = { x = 0.000, y = 315.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 10009, monster_id = 25210301, pos = { x = 331.795, y = 179.017, z = 266.164 }, rot = { x = 0.000, y = 315.000, z = 0.000 }, level = 1, disableWander = true }
}
...
function action_EVENT_GADGET_CREATE_10002(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 247205010, 10001, {7}) then
...
function action_EVENT_SELECT_OPTION_10003(context, evt)
	...
	-- 删除指定group： 247205010 ；指定config：10001；物件身上指定option：7；
