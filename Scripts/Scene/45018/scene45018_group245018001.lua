...
-- 装置
gadgets = {
	{ config_id = 1001, gadget_id = 70290050, pos = { x = 34.938, y = -5.000, z = -94.684 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 1002, gadget_id = 70290050, pos = { x = 0.643, y = -5.000, z = -57.373 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1 },
