...
-- 怪物
monsters = {
	{ config_id = 1004, monster_id = 25210202, pos = { x = -3.468, y = 0.192, z = -5.174 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 1005, monster_id = 25210202, pos = { x = 0.060, y = 0.192, z = -5.174 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 1008, monster_id = 25210501, pos = { x = -3.338, y = 0.192, z = -2.572 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 1011, monster_id = 25210302, pos = { x = -0.030, y = 0.192, z = -0.263 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 1012, monster_id = 25210501, pos = { x = 2.545, y = 0.192, z = -2.466 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 1013, monster_id = 25210203, pos = { x = 0.154, y = 0.192, z = -6.427 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 1017, monster_id = 25210201, pos = { x = 3.358, y = 0.192, z = -5.174 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 1019, monster_id = 25310201, pos = { x = -0.031, y = 0.192, z = -2.047 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 1 }
}
...
function action_EVENT_ENTER_REGION_1002(context, evt)
	-- 改变指定group组240650001中， configid为1001的gadget的state
...
function action_EVENT_SELECT_OPTION_1003(context, evt)
	...
	-- 删除指定group： 240650001 ；指定config：1001；物件身上指定option：7；
