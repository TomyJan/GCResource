...
-- 怪物
monsters = {
	{ config_id = 7001, monster_id = 23010101, pos = { x = 4.100, y = -0.102, z = -15.127 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7002, monster_id = 23010101, pos = { x = -4.205, y = -0.102, z = -15.144 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7003, monster_id = 23010501, pos = { x = 6.064, y = -0.102, z = -10.173 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7004, monster_id = 23010501, pos = { x = -7.084, y = -0.102, z = -10.127 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7005, monster_id = 23030102, pos = { x = 13.226, y = -0.102, z = -0.020 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7006, monster_id = 23040102, pos = { x = -13.984, y = -0.102, z = -0.058 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true }
}
...
-- 触发器
triggers = {
	{ config_id = 1007007, name = "MONSTER_TIDE_DIE_7007", event = EventType.EVENT_MONSTER_TIDE_DIE, source = "1", condition = "condition_EVENT_MONSTER_TIDE_DIE_7007", action = "action_EVENT_MONSTER_TIDE_DIE_7007" },
...
suites = {
	{
		...
		gadgets = { 7010 },
		regions = { },
		triggers = { "MONSTER_TIDE_DIE_7007", "ANY_MONSTER_LIVE_7013", "CHALLENGE_SUCCESS_7014", "CHALLENGE_FAIL_7015" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发条件
function condition_EVENT_MONSTER_TIDE_DIE_7007(context, evt)
...
function action_EVENT_ANY_MONSTER_LIVE_7013(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 197, 600, 234723007, 6, 0) then
...
function action_EVENT_CHALLENGE_SUCCESS_7014(context, evt)
	-- 将剩余时间记录在触发此challenge的group变量TPL_TIME中
	    if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "TPL_TIME", evt.param2, 234723005) then
...
function action_EVENT_CHALLENGE_FAIL_7015(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 234723007, suite = 1 }) then
