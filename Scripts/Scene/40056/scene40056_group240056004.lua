...
-- 怪物
monsters = {
	[4001] = { config_id = 4001, monster_id = 20040602, pos = { x = 0.181, y = 0.000, z = 0.000 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true }
}
...
gadgets = {
	...
	[4009] = { config_id = 4009, gadget_id = 44000006, pos = { x = 0.120, y = 0.000, z = 20.107 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
function action_EVENT_SELECT_OPTION_4011(context, evt)
	...
	-- 删除指定group： 240056004 ；指定config：4007；物件身上指定option：175；
