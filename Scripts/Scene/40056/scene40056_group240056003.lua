...
local defs = {
        ...
        gallery_id = 29021,  --对应gallery的id
        recovergadget_id = 3009,   --恢复gadget的id
        battle_region_id = 3002, --td region的id
...
-- 怪物
monsters = {
	[3001] = { config_id = 3001, monster_id = 22010102, pos = { x = 0.167, y = 0.223, z = -8.638 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1028 }, isElite = true },
	[3022] = { config_id = 3022, monster_id = 21010502, pos = { x = 3.071, y = 0.223, z = -5.836 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	[3023] = { config_id = 3023, monster_id = 21010502, pos = { x = -2.704, y = 0.223, z = -5.778 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	[3024] = { config_id = 3024, monster_id = 21030203, pos = { x = 0.167, y = 0.223, z = -11.519 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	[3026] = { config_id = 3026, monster_id = 22030202, pos = { x = 3.115, y = 0.078, z = -5.785 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	[3027] = { config_id = 3027, monster_id = 22030202, pos = { x = -2.738, y = 0.077, z = -5.651 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 }
}
...
gadgets = {
	...
	[3009] = { config_id = 3009, gadget_id = 44000006, pos = { x = 0.120, y = 0.000, z = 20.107 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	[3002] = { config_id = 3002, shape = RegionShape.SPHERE, radius = 35, pos = { x = 0.000, y = 0.000, z = 0.000 } }
}
...
function action_EVENT_SELECT_OPTION_3011(context, evt)
	...
	-- 删除指定group： 240056003 ；指定config：3007；物件身上指定option：175；
