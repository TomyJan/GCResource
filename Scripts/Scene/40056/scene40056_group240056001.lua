...
local defs = {
        ...
        battle_region_id = 1008, --td region的id
...
-- 怪物
monsters = {
	[1006] = { config_id = 1006, monster_id = 20011304, pos = { x = -5.608, y = 0.073, z = -8.758 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	[1007] = { config_id = 1007, monster_id = 20060701, pos = { x = 11.884, y = 0.082, z = -0.105 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	[1012] = { config_id = 1012, monster_id = 26010201, pos = { x = -8.348, y = 0.073, z = 0.001 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true },
	[1021] = { config_id = 1021, monster_id = 20011304, pos = { x = 6.045, y = 0.073, z = -8.758 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	[1022] = { config_id = 1022, monster_id = 20011304, pos = { x = -11.561, y = 0.073, z = -0.085 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true },
	[1023] = { config_id = 1023, monster_id = 20011304, pos = { x = 11.885, y = 0.073, z = -0.085 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true },
	[1024] = { config_id = 1024, monster_id = 20060701, pos = { x = -11.524, y = 0.081, z = 0.013 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	[1025] = { config_id = 1025, monster_id = 20060601, pos = { x = 9.121, y = 0.073, z = -2.967 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	[1026] = { config_id = 1026, monster_id = 26010201, pos = { x = 9.121, y = 0.073, z = -0.034 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true },
	[1027] = { config_id = 1027, monster_id = 26010201, pos = { x = 0.210, y = 0.073, z = 8.786 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	[1028] = { config_id = 1028, monster_id = 20060601, pos = { x = 9.121, y = 0.073, z = 2.951 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	[1029] = { config_id = 1029, monster_id = 20060601, pos = { x = -8.598, y = 0.073, z = -2.967 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	[1030] = { config_id = 1030, monster_id = 20060601, pos = { x = -8.598, y = 0.073, z = 2.951 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	[1032] = { config_id = 1032, monster_id = 26040102, pos = { x = 6.100, y = 0.081, z = -8.797 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1028 }, isElite = true },
	[1033] = { config_id = 1033, monster_id = 26040102, pos = { x = -5.626, y = 0.081, z = -8.763 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 6105 }, isElite = true }
}
...
gadgets = {
	...
	[1009] = { config_id = 1009, gadget_id = 44000006, pos = { x = 0.120, y = 0.000, z = 20.107 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	[1008] = { config_id = 1008, shape = RegionShape.SPHERE, radius = 35, pos = { x = 0.000, y = 0.000, z = 0.000 } }
}
...
suites = {
	...
	},
	{
		-- suite_id = 4,
		-- description = ,
		monsters = { 1007, 1024, 1025, 1028, 1029, 1030 },
		gadgets = { 1002 },
		regions = { },
