...
-- 装置
gadgets = {
	{ config_id = 2001, gadget_id = 70360010, pos = { x = 30.890, y = -19.586, z = -52.149 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 2008, shape = RegionShape.CUBIC, size = { x = 80.000, y = 50.000, z = 80.000 }, pos = { x = 30.890, y = -19.586, z = -52.149 } }
}
...
-- 点位
points = {
	{ config_id = 2011, pos = { x = 22.097, y = -18.948, z = -49.831 }, rot = { x = 0.000, y = 184.777, z = 0.000 } },
	{ config_id = 2012, pos = { x = 25.426, y = -18.948, z = -43.650 }, rot = { x = 0.000, y = 184.777, z = 0.000 } },
	{ config_id = 2013, pos = { x = 32.010, y = -19.008, z = -40.085 }, rot = { x = 0.000, y = 184.777, z = 0.000 } },
	{ config_id = 2014, pos = { x = 40.678, y = -18.948, z = -43.337 }, rot = { x = 0.000, y = 184.777, z = 0.000 } },
	{ config_id = 2015, pos = { x = 43.141, y = -19.008, z = -49.529 }, rot = { x = 0.000, y = 184.777, z = 0.000 } }
}
...
function condition_EVENT_VARIABLE_CHANGE_2004(context, evt)
	...
	-- 判断变量"success"为0
	if ScriptLib.GetGroupVariableValueByGroup(context, "success", 243010003) ~= 0 then
			return false
	end
