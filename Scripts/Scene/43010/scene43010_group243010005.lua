...
-- 装置
gadgets = {
	{ config_id = 5001, gadget_id = 70360157, pos = { x = 17.615, y = 40.000, z = -3.150 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 5002, gadget_id = 70900205, pos = { x = 25.331, y = 33.003, z = -2.896 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 5006, shape = RegionShape.CUBIC, size = { x = 70.000, y = 40.000, z = 60.000 }, pos = { x = 17.532, y = 40.551, z = -5.337 } }
}
...
-- 点位
points = {
	{ config_id = 5008, pos = { x = 24.307, y = 40.049, z = 5.081 }, rot = { x = 0.000, y = 208.030, z = 0.000 } },
	{ config_id = 5009, pos = { x = 26.819, y = 40.050, z = -9.888 }, rot = { x = 0.000, y = 307.222, z = 0.000 } },
	{ config_id = 5010, pos = { x = 15.361, y = 40.029, z = -12.823 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 5011, pos = { x = 8.296, y = 40.029, z = -3.361 }, rot = { x = 0.000, y = 78.629, z = 0.000 } },
	{ config_id = 5012, pos = { x = 9.953, y = 40.029, z = 6.517 }, rot = { x = 0.000, y = 151.304, z = 0.000 } }
}
