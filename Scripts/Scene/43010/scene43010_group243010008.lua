...
-- 装置
gadgets = {
	{ config_id = 8001, gadget_id = 70360157, pos = { x = 96.777, y = 39.999, z = -3.889 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8002, gadget_id = 70900205, pos = { x = 97.872, y = 34.866, z = 6.561 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 8007, shape = RegionShape.CUBIC, size = { x = 50.000, y = 40.000, z = 45.000 }, pos = { x = 93.632, y = 40.551, z = -4.437 } }
}
...
-- 点位
points = {
	{ config_id = 8008, pos = { x = 97.438, y = 40.049, z = 4.282 }, rot = { x = 0.000, y = 178.335, z = 0.000 } },
	{ config_id = 8009, pos = { x = 87.124, y = 40.004, z = 0.696 }, rot = { x = 0.000, y = 109.555, z = 0.000 } },
	{ config_id = 8010, pos = { x = 87.504, y = 40.011, z = -9.220 }, rot = { x = 0.000, y = 65.176, z = 0.000 } },
	{ config_id = 8011, pos = { x = 102.930, y = 40.049, z = -11.983 }, rot = { x = 0.000, y = 320.033, z = 0.000 } },
	{ config_id = 8012, pos = { x = 107.492, y = 40.049, z = -4.914 }, rot = { x = 0.000, y = 309.778, z = 0.000 } }
}
