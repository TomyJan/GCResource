...
-- 装置
gadgets = {
	{ config_id = 1001, gadget_id = 70360001, pos = { x = 71.788, y = 41.021, z = -29.637 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 1005, shape = RegionShape.CUBIC, size = { x = 50.000, y = 40.000, z = 45.000 }, pos = { x = 63.832, y = 40.551, z = -32.037 } }
}
...
-- 点位
points = {
	{ config_id = 1007, pos = { x = 75.567, y = 40.049, z = -22.101 }, rot = { x = 0.000, y = 213.111, z = 0.000 } },
	{ config_id = 1008, pos = { x = 65.011, y = 40.021, z = -21.680 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 1009, pos = { x = 60.616, y = 40.049, z = -28.241 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 1010, pos = { x = 66.255, y = 40.049, z = -35.758 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 1011, pos = { x = 79.168, y = 39.999, z = -33.773 }, rot = { x = 0.000, y = 321.537, z = 0.000 } }
}
