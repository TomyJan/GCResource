...
-- 怪物
monsters = {
	{ config_id = 8001, monster_id = 21030601, pos = { x = -4.036, y = -0.102, z = -13.057 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 6111 } },
	{ config_id = 8002, monster_id = 21030601, pos = { x = 4.025, y = -0.102, z = -13.075 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 6111 } },
	{ config_id = 8003, monster_id = 22020102, pos = { x = -0.004, y = -0.102, z = -15.031 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 6110 }, isElite = true, pose_id = 101 }
}
...
function action_EVENT_ANY_MONSTER_LIVE_8009(context, evt)
	...
	-- 从235718005的变量TPL_TIME中取出对应值并开启挑战
	  local tpl_time = ScriptLib.GetGroupVariableValueByGroup(context, "TPL_TIME", 235718005)
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 235718008, 3, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
...
function action_EVENT_CHALLENGE_SUCCESS_8011(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 235718005) then
...
function action_EVENT_CHALLENGE_FAIL_8012(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 235718008, suite = 1 }) then
