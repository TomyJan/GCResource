...
-- 装置
gadgets = {
	{ config_id = 9006, gadget_id = 70360157, pos = { x = 69.142, y = 40.000, z = -28.773 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 9018, gadget_id = 70900205, pos = { x = 79.610, y = 33.906, z = -82.892 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 9011, shape = RegionShape.CUBIC, size = { x = 50.000, y = 40.000, z = 45.000 }, pos = { x = 64.000, y = 40.000, z = -32.200 } }
}
...
-- 点位
points = {
	{ config_id = 9003, pos = { x = 75.789, y = 40.049, z = -22.182 }, rot = { x = 0.000, y = 213.111, z = 0.000 } },
	{ config_id = 9004, pos = { x = 65.179, y = 40.000, z = -20.868 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 9005, pos = { x = 60.226, y = 40.049, z = -28.404 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 9007, pos = { x = 66.424, y = 40.049, z = -36.745 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 9008, pos = { x = 79.886, y = 40.005, z = -34.629 }, rot = { x = 0.000, y = 321.537, z = 0.000 } },
	{ config_id = 9012, pos = { x = 75.789, y = 40.049, z = -22.182 }, rot = { x = 0.000, y = 213.111, z = 0.000 } },
	{ config_id = 9013, pos = { x = 65.179, y = 40.000, z = -20.868 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 9014, pos = { x = 60.226, y = 40.049, z = -28.404 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 9015, pos = { x = 66.424, y = 40.049, z = -36.745 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 9016, pos = { x = 79.886, y = 40.005, z = -34.629 }, rot = { x = 0.000, y = 321.537, z = 0.000 } }
}
