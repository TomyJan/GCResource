...
-- 装置
gadgets = {
	{ config_id = 5004, gadget_id = 70360159, pos = { x = 32.272, y = 69.000, z = -45.694 }, rot = { x = 0.000, y = 187.000, z = 0.000 }, level = 1, mark_flag = 2 },
	{ config_id = 5008, gadget_id = 70900201, pos = { x = 32.091, y = 41.714, z = -45.585 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 5009, gadget_id = 70900201, pos = { x = 31.059, y = -19.662, z = -52.312 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	...
	{ config_id = 5019, gadget_id = 70360162, pos = { x = 18.500, y = 40.000, z = -2.700 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
function action_EVENT_DUNGEON_ALL_AVATAR_DIE_5001(context, evt)
	-- 重新生成指定group，指定suite
	if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 243008004, suite = 1 }) then
...
function action_EVENT_TIME_AXIS_PASS_5002(context, evt)
	-- 重新生成指定group，默认为独立随机
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 243008012 }) then
...
function action_EVENT_VARIABLE_CHANGE_5003(context, evt)
	-- 删除指定group： 243008005 ；指定config：5013；物件身上指定option：30；
...
function action_EVENT_TIMER_EVENT_5007(context, evt)
		-- 卸载指定gadget
		if 0 ~= ScriptLib.RemoveEntityByConfigId(context, 243008005, EntityType.GADGET, 5016 ) then
