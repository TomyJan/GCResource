...
-- 区域
regions = {
	{ config_id = 1010, shape = RegionShape.CUBIC, size = { x = 60.000, y = 40.000, z = 50.000 }, pos = { x = 75.900, y = 40.000, z = -67.700 } }
}
...
triggers = {
	...
	{ config_id = 1001010, name = "LEAVE_REGION_1010", event = EventType.EVENT_LEAVE_REGION, source = "", condition = "condition_EVENT_LEAVE_REGION_1010", action = "action_EVENT_LEAVE_REGION_1010", trigger_count = 0 },
...
-- 点位
points = {
	{ config_id = 1004, pos = { x = 66.040, y = 40.049, z = -82.170 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 1005, pos = { x = 73.921, y = 40.000, z = -84.805 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 1007, pos = { x = 83.213, y = 40.049, z = -78.743 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 1008, pos = { x = 80.421, y = 40.000, z = -65.614 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 1009, pos = { x = 66.311, y = 40.000, z = -65.847 }, rot = { x = 0.000, y = 0.000, z = 0.000 } }
}
...
suites = {
	{
		...
		gadgets = { 1003 },
		regions = { 1010 },
		triggers = { "GADGET_CREATE_1001", "SELECT_OPTION_1002", "ANY_MONSTER_DIE_1006", "LEAVE_REGION_1010", "VARIABLE_CHANGE_1017" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发条件
function condition_EVENT_LEAVE_REGION_1010(context, evt)
	-- 判断是区域8011
...
-- 触发操作
function action_EVENT_LEAVE_REGION_1010(context, evt)
	--离开区域 挑战失败
