...
-- 装置
gadgets = {
	{ config_id = 1001, gadget_id = 70360010, pos = { x = 0.021, y = 9.156, z = -0.572 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, state = GadgetState.GearStop }
}

-- 区域
regions = {
	{ config_id = 1003, shape = RegionShape.CUBIC, size = { x = 40.000, y = 10.000, z = 10.000 }, pos = { x = 0.021, y = 9.140, z = 22.150 } }
}
...
function action_EVENT_SELECT_OPTION_1004(context, evt)
	...
	-- 删除指定group： 240751001 ；指定config：1001；物件身上指定option：7；
