...
-- 怪物
monsters = {
	{ config_id = 9006, monster_id = 25010701, pos = { x = 323.080, y = 163.189, z = 482.633 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 9007, monster_id = 25010701, pos = { x = 325.820, y = 163.189, z = 482.519 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 9008, monster_id = 25010201, pos = { x = 320.662, y = 163.189, z = 482.203 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 9009, monster_id = 25010201, pos = { x = 328.214, y = 163.189, z = 482.218 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 9010, monster_id = 25010301, pos = { x = 324.523, y = 163.189, z = 483.883 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true }
}
...
function action_EVENT_SELECT_OPTION_9003(context, evt)
	...
	-- 删除指定group： 247203009 ；指定config：9001；物件身上指定option：7；
