...
-- 怪物
monsters = {
	{ config_id = 10006, monster_id = 22040201, pos = { x = 331.709, y = 179.017, z = 266.014 }, rot = { x = 0.000, y = 315.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 10007, monster_id = 22040201, pos = { x = 330.105, y = 179.017, z = 264.132 }, rot = { x = 0.000, y = 315.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 }
}
...
function action_EVENT_GADGET_CREATE_10002(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 247203010, 10001, {7}) then
...
function action_EVENT_SELECT_OPTION_10003(context, evt)
	...
	-- 删除指定group： 247203010 ；指定config：10001；物件身上指定option：7；
