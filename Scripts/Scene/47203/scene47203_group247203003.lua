...
-- 怪物
monsters = {
	{ config_id = 3006, monster_id = 25100201, pos = { x = 329.874, y = 154.979, z = 364.963 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1028 }, pose_id = 1 }
}
...
function action_EVENT_SELECT_OPTION_3003(context, evt)
	...
	-- 添加suite2的新内容，刷怪
	    ScriptLib.AddExtraGroupSuite(context, 247203003, 2)
	...
	-- 删除指定group： 247203003 ；指定config：3001；物件身上指定option：7；
...
function action_EVENT_VARIABLE_CHANGE_3005(context, evt)
	...
	-- 改变指定group组247203001中， configid为1019的gadget的state
