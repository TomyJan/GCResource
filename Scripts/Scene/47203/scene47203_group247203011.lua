...
-- 怪物
monsters = {
	{ config_id = 11006, monster_id = 25080101, pos = { x = 181.077, y = 144.022, z = 372.096 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 1 },
	{ config_id = 11007, monster_id = 25080201, pos = { x = 181.077, y = 144.022, z = 361.364 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 1 }
}
...
function action_EVENT_GADGET_CREATE_11002(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 247203011, 11001, {7}) then
...
function action_EVENT_SELECT_OPTION_11003(context, evt)
	...
	ScriptLib.AutoMonsterTide(context, 1, defs.group_1, {11006,11007}, 2, 2, 2)
