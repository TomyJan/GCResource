...
-- 怪物
monsters = {
	{ config_id = 4006, monster_id = 25210203, pos = { x = 239.917, y = 162.354, z = 446.585 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4007, monster_id = 25210301, pos = { x = 246.582, y = 162.354, z = 446.526 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4008, monster_id = 25310101, pos = { x = 243.099, y = 162.354, z = 446.628 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 1 },
	{ config_id = 4010, monster_id = 23020101, pos = { x = 243.099, y = 161.991, z = 448.052 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true }
}
...
function action_EVENT_SELECT_OPTION_4003(context, evt)
	...
	-- 删除指定group： 247203004 ；指定config：4001；物件身上指定option：7；
...
function action_EVENT_VARIABLE_CHANGE_4005(context, evt)
	...
	-- 改变指定group组247203001中， configid为1020的gadget的state
...
function action_EVENT_ANY_MONSTER_DIE_4009(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 247203004, 3)
