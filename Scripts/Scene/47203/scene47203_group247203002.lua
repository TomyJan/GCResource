...
-- 怪物
monsters = {
	{ config_id = 2006, monster_id = 21010601, pos = { x = 240.608, y = 157.290, z = 286.624 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 2007, monster_id = 20011301, pos = { x = 243.205, y = 157.290, z = 286.624 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 2008, monster_id = 21010601, pos = { x = 246.300, y = 157.290, z = 286.624 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	...
	{ config_id = 2011, monster_id = 21010201, pos = { x = 237.644, y = 157.320, z = 290.274 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 2013, monster_id = 20011301, pos = { x = 248.967, y = 157.320, z = 290.274 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 2014, monster_id = 21010201, pos = { x = 237.769, y = 157.320, z = 294.279 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 2015, monster_id = 22010101, pos = { x = 248.795, y = 157.320, z = 294.279 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, affix = { 6105 } }
}
...
function action_EVENT_SELECT_OPTION_2003(context, evt)
	...
	-- 删除指定group： 247203002 ；指定config：2001；物件身上指定option：7；
...
function action_EVENT_VARIABLE_CHANGE_2005(context, evt)
	...
	-- 改变指定group组247203001中， configid为1018的gadget的state
