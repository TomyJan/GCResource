...
-- 装置
gadgets = {
	{ config_id = 347001, gadget_id = 70720218, pos = { x = 1093.605, y = 937.765, z = 525.678 }, rot = { x = 0.000, y = 289.033, z = 0.000 }, level = 36, area_id = 300 },
	{ config_id = 347002, gadget_id = 70720217, pos = { x = 1077.220, y = 930.056, z = 590.509 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 36, route_id = 600100051, area_id = 300 },
	{ config_id = 347003, gadget_id = 70720219, pos = { x = 1094.873, y = 937.765, z = 525.980 }, rot = { x = 0.000, y = 77.033, z = 0.000 }, level = 36, area_id = 300 },
	{ config_id = 347004, gadget_id = 70211111, pos = { x = 1092.753, y = 937.891, z = 523.919 }, rot = { x = 13.370, y = 336.326, z = 14.233 }, level = 26, drop_tag = "解谜中级璃月", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 300 }
}

-- 区域
regions = {
	{ config_id = 347007, shape = RegionShape.SPHERE, radius = 2, pos = { x = 1077.285, y = 930.047, z = 590.711 }, area_id = 300 }
}
...
function action_EVENT_ENTER_REGION_347007(context, evt)
	-- 设置移动平台路径
	if 0 ~= ScriptLib.SetPlatformRouteId(context, 347002, 600100050) then
...
function action_EVENT_GADGET_STATE_CHANGE_347008(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 166001347, 2) then
