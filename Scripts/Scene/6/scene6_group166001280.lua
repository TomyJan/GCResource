...
-- 装置
gadgets = {
	{ config_id = 280001, gadget_id = 70720218, pos = { x = 991.438, y = 838.669, z = 584.350 }, rot = { x = 0.000, y = 179.340, z = 0.000 }, level = 36, area_id = 300 },
	{ config_id = 280002, gadget_id = 70720217, pos = { x = 962.350, y = 862.190, z = 548.376 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 36, route_id = 600100038, area_id = 300 },
	{ config_id = 280003, gadget_id = 70720219, pos = { x = 991.367, y = 838.555, z = 583.906 }, rot = { x = 0.000, y = 194.498, z = 0.000 }, level = 36, area_id = 300 }
}

-- 区域
regions = {
	{ config_id = 280007, shape = RegionShape.SPHERE, radius = 2, pos = { x = 962.735, y = 862.190, z = 548.497 }, area_id = 300 }
}
...
suites = {
	{
		...
		regions = { 280007 },
		triggers = { "PLATFORM_REACH_POINT_280005", "AVATAR_NEAR_PLATFORM_280006", "ENTER_REGION_280007", "GADGET_STATE_CHANGE_280008" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ENTER_REGION_280007(context, evt)
	-- 设置移动平台路径
	if 0 ~= ScriptLib.SetPlatformRouteId(context, 280002, 600100037) then
...
function action_EVENT_GADGET_STATE_CHANGE_280008(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 166001280, 2) then
