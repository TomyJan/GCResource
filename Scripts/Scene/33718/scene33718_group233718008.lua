...
-- 怪物
monsters = {
	{ config_id = 8001, monster_id = 21020501, pos = { x = 0.030, y = -0.102, z = -10.068 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 6110 }, isElite = true },
	{ config_id = 8002, monster_id = 21010502, pos = { x = 5.043, y = -0.102, z = 9.881 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true, affix = { 6111 } },
	{ config_id = 8003, monster_id = 21010902, pos = { x = -7.124, y = -0.102, z = -10.064 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 6111 }, isElite = true },
	{ config_id = 8004, monster_id = 21010902, pos = { x = -5.095, y = -0.102, z = 9.930 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true, affix = { 6111 } },
	{ config_id = 8005, monster_id = 21010502, pos = { x = 7.084, y = -0.102, z = -10.054 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 6111 } }
}
...
function action_EVENT_ANY_MONSTER_LIVE_8010(context, evt)
	...
	-- 从233718005的变量TPL_TIME中取出对应值并开启挑战
	  local tpl_time = ScriptLib.GetGroupVariableValueByGroup(context, "TPL_TIME", 233718005)
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 233718008, 5, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
...
function action_EVENT_CHALLENGE_SUCCESS_8012(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 233718005) then
...
function action_EVENT_CHALLENGE_FAIL_8013(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 233718008, suite = 1 }) then
