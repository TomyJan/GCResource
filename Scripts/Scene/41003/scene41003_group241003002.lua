...
-- 装置
gadgets = {
	{ config_id = 2001, gadget_id = 70360010, pos = { x = -0.028, y = -0.035, z = 0.003 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
...
function action_EVENT_SELECT_OPTION_2003(context, evt)
	-- 添加suite2的新内容
	    ScriptLib.AddExtraGroupSuite(context, 241003003, 2)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "monster_wave", 1, 241003003) then
