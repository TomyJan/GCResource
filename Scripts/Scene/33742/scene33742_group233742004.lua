...
-- 怪物
monsters = {
	{ config_id = 4001, monster_id = 25210101, pos = { x = 0.010, y = -0.102, z = -9.018 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4004, monster_id = 25310101, pos = { x = 0.010, y = -0.102, z = -7.024 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 1 },
	{ config_id = 4005, monster_id = 25210501, pos = { x = 5.036, y = -0.102, z = 7.041 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4006, monster_id = 25100201, pos = { x = 5.036, y = -0.102, z = -7.033 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 1 },
	{ config_id = 4007, monster_id = 25210301, pos = { x = 5.036, y = -0.102, z = -8.027 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4008, monster_id = 25210301, pos = { x = -5.040, y = -0.102, z = -8.050 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	...
	{ config_id = 4011, monster_id = 25210401, pos = { x = -8.066, y = -0.102, z = -2.975 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4012, monster_id = 25210401, pos = { x = -8.066, y = -0.102, z = 3.134 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4013, monster_id = 25210501, pos = { x = 8.037, y = -0.102, z = -2.975 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4016, monster_id = 25210501, pos = { x = 8.036, y = -0.102, z = 3.134 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 4017, monster_id = 25210401, pos = { x = -5.040, y = -0.102, z = 7.018 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true }
}
...
function action_EVENT_CHALLENGE_SUCCESS_4014(context, evt)
	...
	-- 改变指定group组233742003中， configid为3001的gadget的state
	...
	-- 改变指定group组233742001中， configid为1001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 233742001, 1001, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 改变指定group组233742001中， configid为1002的gadget的state
