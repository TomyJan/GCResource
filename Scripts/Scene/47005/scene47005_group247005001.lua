...
garbages = {
	gadgets = {
		{ config_id = 1001, gadget_id = 70310145, pos = { x = -2.755, y = 0.124, z = 123.595 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, isOneoff = true, persistent = true },
		{ config_id = 1002, gadget_id = 70310145, pos = { x = 83.700, y = -0.015, z = 437.780 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, isOneoff = true, persistent = true }
	}
}
