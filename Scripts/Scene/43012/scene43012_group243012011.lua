...
-- 装置
gadgets = {
	{ config_id = 11001, gadget_id = 70360001, pos = { x = -35.509, y = 40.000, z = -26.997 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 11006, shape = RegionShape.CUBIC, size = { x = 50.000, y = 40.000, z = 60.000 }, pos = { x = -26.500, y = 40.000, z = -29.500 } }
}
...
-- 点位
points = {
	{ config_id = 11007, pos = { x = -30.628, y = 40.049, z = -31.088 }, rot = { x = 0.000, y = 313.018, z = 0.000 } },
	{ config_id = 11008, pos = { x = -29.085, y = 40.054, z = -26.887 }, rot = { x = 0.000, y = 268.871, z = 0.000 } },
	{ config_id = 11009, pos = { x = -32.328, y = 40.070, z = -22.475 }, rot = { x = 0.000, y = 213.064, z = 0.000 } },
	{ config_id = 11010, pos = { x = -38.683, y = 40.049, z = -23.058 }, rot = { x = 0.000, y = 123.863, z = 0.000 } },
	{ config_id = 11011, pos = { x = -36.587, y = 40.000, z = -31.894 }, rot = { x = 0.000, y = 14.570, z = 0.000 } }
}
