...
-- 装置
gadgets = {
	{ config_id = 3001, gadget_id = 70360164, pos = { x = 32.229, y = 40.193, z = -45.602 }, rot = { x = 0.000, y = 31.000, z = 0.000 }, level = 1, mark_flag = 4 },
	{ config_id = 3002, gadget_id = 70350244, pos = { x = 32.390, y = 39.758, z = -53.318 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, state = GadgetState.GearStart },
	{ config_id = 3003, gadget_id = 70360161, pos = { x = -35.509, y = 40.000, z = -26.997 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 3004, gadget_id = 70360160, pos = { x = 97.151, y = 40.001, z = -2.099 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 3005, gadget_id = 70360162, pos = { x = -1.339, y = 40.001, z = -76.741 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 3006, gadget_id = 70360159, pos = { x = 32.229, y = 69.000, z = -45.602 }, rot = { x = 0.000, y = 40.760, z = 0.000 }, level = 1, mark_flag = 2 },
	{ config_id = 3007, gadget_id = 70900201, pos = { x = 32.229, y = 40.193, z = -45.602 }, rot = { x = 0.000, y = 31.000, z = 0.000 }, level = 1 },
	{ config_id = 3008, gadget_id = 70900201, pos = { x = 32.738, y = -16.654, z = -52.183 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 3012, shape = RegionShape.SPHERE, radius = 5, pos = { x = 49.072, y = 40.000, z = -2.348 } },
	-- 切换天气区域
	{ config_id = 3015, shape = RegionShape.CUBIC, size = { x = 40.000, y = 1.000, z = 40.000 }, pos = { x = 32.461, y = 31.798, z = -50.662 } },
	-- 全局启动trigger
	{ config_id = 3018, shape = RegionShape.CUBIC, size = { x = 40.000, y = 20.000, z = 2.000 }, pos = { x = 17.643, y = 44.569, z = 15.548 } },
	-- 断线重连保护大region
	{ config_id = 3025, shape = RegionShape.CUBIC, size = { x = 300.000, y = 200.000, z = 300.000 }, pos = { x = 70.222, y = -13.050, z = -16.433 } }
}
...
function action_EVENT_DUNGEON_ALL_AVATAR_DIE_3009(context, evt)
	-- 重新生成指定group，指定suite
	if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 243012001, suite = 1 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
		return -1
	end
	
	-- 重新生成指定group，指定suite
	if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 243012002, suite = 1 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
		return -1
	end
	
	-- 重新生成指定group，指定suite
	if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 243012005, suite = 1 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
		return -1
	end
	
	-- 重新生成指定group，指定suite
	if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 243012006, suite = 1 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
		return -1
	end
	
	-- 重新生成指定group，指定suite
	if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 243012007, suite = 1 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
		return -1
	end
	
	-- 重新生成指定group，指定suite
	if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 243012008, suite = 1 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
		return -1
	end
	
	-- 重新生成指定group，指定suite
	if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 243012011, suite = 1 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
		return -1
	end
	...
	-- 重新生成指定group，指定suite
	if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 243012012, suite = 1 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
		return -1
	end
...
function action_EVENT_TIME_AXIS_PASS_3010(context, evt)
	-- 重新生成指定group，默认为独立随机
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 243012009 }) then
...
function action_EVENT_TIMER_EVENT_3014(context, evt)
		-- 卸载指定gadget
		if 0 ~= ScriptLib.RemoveEntityByConfigId(context, 243012003, EntityType.GADGET, 3002 ) then
...
function action_EVENT_SELECT_OPTION_3017(context, evt)
	...
	if 0 ~= ScriptLib.CreateGroupTimerEvent(context, 243012003, "floor", 2) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : create_timerevent_by_group")
	  return -1
	end
	
	-- 删除指定group： 243007005 ；指定config：5013；物件身上指定option：7；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 243012003, 3001, 59) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : del_work_options_by_group_configId")
		return -1
	end
...
function action_EVENT_ENTER_REGION_3018(context, evt)
	...
	ScriptLib.StartGallery(context, 7040)
