...
-- 怪物
monsters = {
	{ config_id = 5001, monster_id = 22050101, pos = { x = -0.030, y = -0.102, z = -12.175 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 5004, monster_id = 22040101, pos = { x = 4.033, y = -0.102, z = -6.931 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 5005, monster_id = 22040101, pos = { x = 0.015, y = -0.102, z = -10.085 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 5006, monster_id = 22040101, pos = { x = 3.020, y = -0.102, z = -10.082 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 5007, monster_id = 22040101, pos = { x = -3.042, y = -0.102, z = -10.061 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 5008, monster_id = 22040101, pos = { x = -4.091, y = -0.102, z = -6.931 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 }
}
...
garbages = {
	monsters = {
		{ config_id = 5002, monster_id = 22050101, pos = { x = -2.044, y = -0.102, z = -12.029 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 }
	}
}
...
function action_EVENT_ANY_MONSTER_LIVE_5003(context, evt)
	...
	-- 从233726002的变量TPL_TIME中取出对应值并开启挑战
	  local tpl_time = ScriptLib.GetGroupVariableValueByGroup(context, "TPL_TIME", 233726002)
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 233726005, 6, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
...
function action_EVENT_ANY_MONSTER_DIE_5012(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 233726005, 3)
...
function action_EVENT_CHALLENGE_SUCCESS_5015(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 233726002) then
...
function action_EVENT_CHALLENGE_FAIL_5016(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 233726005, suite = 1 }) then
