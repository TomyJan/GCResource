...
-- 怪物
monsters = {
	{ config_id = 5001, monster_id = 24010401, pos = { x = -0.011, y = -0.102, z = -0.030 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 5186, 5169 } }
}
...
function action_EVENT_ANY_MONSTER_LIVE_5004(context, evt)
	...
	-- 从235736002的变量TPL_TIME中取出对应值并开启挑战
