...
-- 怪物
monsters = {
	{ config_id = 5001, monster_id = 21020801, pos = { x = -10.010, y = -0.102, z = -0.098 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1027 }, isElite = true },
	{ config_id = 5002, monster_id = 21020801, pos = { x = 10.045, y = -0.102, z = -0.110 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, affix = { 6104 }, isElite = true },
	{ config_id = 5005, monster_id = 21020401, pos = { x = -0.025, y = -0.102, z = -10.138 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1029 }, isElite = true },
	{ config_id = 5010, monster_id = 21020401, pos = { x = 0.029, y = -0.102, z = 10.000 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true, affix = { 6101 }, isElite = true }
}
...
function action_EVENT_ANY_MONSTER_LIVE_5004(context, evt)
	...
	-- 从234744002的变量TPL_TIME中取出对应值并开启挑战
