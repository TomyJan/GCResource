...
-- 怪物
monsters = {
	{ config_id = 4007, monster_id = 24040201, pos = { x = 4.071, y = -0.102, z = -7.066 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 1 },
	{ config_id = 4008, monster_id = 24040101, pos = { x = -4.039, y = -0.102, z = -7.021 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 1 },
	{ config_id = 4009, monster_id = 25410201, pos = { x = 0.021, y = -0.102, z = -10.079 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 1 }
}
