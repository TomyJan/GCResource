...
-- 怪物
monsters = {
	{ config_id = 5001, monster_id = 25090301, pos = { x = 4.076, y = -0.102, z = -6.045 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 6101 }, isElite = true },
	{ config_id = 5005, monster_id = 25090401, pos = { x = -0.025, y = -0.102, z = -10.138 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1029 }, isElite = true, pose_id = 1 },
	{ config_id = 5010, monster_id = 25090201, pos = { x = -4.022, y = -0.102, z = -5.987 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 6101 }, isElite = true, pose_id = 1 }
}
...
suites = {
	...
	},
	{
		-- suite_id = 2,
		-- description = suite_2,
		monsters = { 5001, 5005, 5010 },
		gadgets = { 5011 },
		regions = { },
		triggers = { "ANY_MONSTER_LIVE_5004", "ANY_MONSTER_DIE_5008", "CHALLENGE_SUCCESS_5015", "CHALLENGE_FAIL_5016" },
		rand_weight = 100
	},
	{
		-- suite_id = 3,
...
function action_EVENT_ANY_MONSTER_LIVE_5004(context, evt)
	...
	-- 从234746002的变量TPL_TIME中取出对应值并开启挑战
	  local tpl_time = ScriptLib.GetGroupVariableValueByGroup(context, "TPL_TIME", 234746002)
	  ...
	  if 0 ~= ScriptLib.ActiveChallenge(context, 2, 198, tpl_time, 234746005, 3, 0) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : active_challenge_by_remainTime")
	    return -1
	  end
...
function action_EVENT_CHALLENGE_SUCCESS_5015(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "stage", 2, 234746002) then
...
function action_EVENT_CHALLENGE_FAIL_5016(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 234746005, suite = 1 }) then
