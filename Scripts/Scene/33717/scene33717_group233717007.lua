...
-- 怪物
monsters = {
	{ config_id = 7001, monster_id = 20011103, pos = { x = 4.553, y = -0.102, z = -9.507 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7002, monster_id = 20011103, pos = { x = -4.616, y = -0.102, z = -9.483 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7003, monster_id = 20011103, pos = { x = 4.476, y = -0.102, z = 9.488 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7004, monster_id = 21011002, pos = { x = -16.069, y = -0.102, z = -0.050 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7005, monster_id = 21011002, pos = { x = 16.010, y = -0.102, z = -0.064 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7006, monster_id = 20011103, pos = { x = -4.524, y = -0.102, z = 9.489 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7007, monster_id = 20011103, pos = { x = 10.490, y = -0.102, z = -3.502 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7008, monster_id = 20011103, pos = { x = 10.416, y = -0.102, z = 2.481 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7009, monster_id = 20011103, pos = { x = -10.496, y = -0.102, z = -3.491 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7011, monster_id = 21010902, pos = { x = 0.026, y = -0.102, z = -17.006 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7012, monster_id = 21010902, pos = { x = 0.006, y = -0.102, z = 16.032 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7016, monster_id = 20011103, pos = { x = -10.481, y = -0.102, z = 2.534 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7019, monster_id = 21020101, pos = { x = 0.007, y = -0.102, z = -10.087 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 7020, monster_id = 21030303, pos = { x = -13.056, y = -0.102, z = -0.011 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1043 } },
	{ config_id = 7021, monster_id = 21030103, pos = { x = 13.090, y = -0.102, z = -0.064 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true }
}
...
function action_EVENT_ANY_MONSTER_LIVE_7013(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 197, 600, 233717007, 15, 0) then
...
function action_EVENT_CHALLENGE_SUCCESS_7014(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 233717006, 6001, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 233717006, 6001, {176}) then
...
function action_EVENT_CHALLENGE_FAIL_7015(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 233717007, suite = 1 }) then
...
function action_EVENT_ANY_MONSTER_DIE_7017(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 233717007, 3)
...
function action_EVENT_ANY_MONSTER_DIE_7018(context, evt)
	-- 添加suite4的新内容
	    ScriptLib.AddExtraGroupSuite(context, 233717007, 4)
	...
	-- 改变指定group组233717006中， configid为6002的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 233717006, 6002, GadgetState.Action02) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
