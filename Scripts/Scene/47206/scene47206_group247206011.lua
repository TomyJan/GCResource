...
-- 怪物
monsters = {
	{ config_id = 11006, monster_id = 21020201, pos = { x = 181.077, y = 144.022, z = 372.096 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 11007, monster_id = 21010201, pos = { x = 175.606, y = 144.022, z = 366.859 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 11008, monster_id = 21010201, pos = { x = 185.970, y = 144.022, z = 366.877 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 11009, monster_id = 21011201, pos = { x = 181.261, y = 144.022, z = 361.515 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true }
}
...
function action_EVENT_GADGET_CREATE_11002(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 247206011, 11001, {7}) then
...
function action_EVENT_SELECT_OPTION_11003(context, evt)
	...
	-- 创建编号为1（该怪物潮的识别id)的怪物潮，创建怪物总数为4，场上怪物最少4只，最多4只
	ScriptLib.AutoMonsterTide(context, 1, defs.group_1, {11006,11007,11008,11009}, 4, 4, 4)
