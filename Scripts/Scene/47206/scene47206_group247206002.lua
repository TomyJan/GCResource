...
-- 怪物
monsters = {
	{ config_id = 2006, monster_id = 22050101, pos = { x = 243.271, y = 157.136, z = 285.233 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 2007, monster_id = 22040101, pos = { x = 241.857, y = 157.463, z = 287.530 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 2011, monster_id = 22040101, pos = { x = 244.829, y = 157.414, z = 287.532 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 }
}
...
function action_EVENT_SELECT_OPTION_2003(context, evt)
	...
	-- 添加suite2的新内容，刷怪
	    ScriptLib.AddExtraGroupSuite(context, 247206002, 2)
	...
	-- 删除指定group： 247206002 ；指定config：2001；物件身上指定option：7；
...
function action_EVENT_VARIABLE_CHANGE_2005(context, evt)
	...
	-- 改变指定group组247206001中， configid为1018的gadget的state
...
function action_EVENT_ANY_MONSTER_DIE_2012(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 247206002, 3)
