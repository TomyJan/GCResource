...
-- 怪物
monsters = {
	{ config_id = 3007, monster_id = 24020301, pos = { x = 330.220, y = 154.979, z = 362.804 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 100 },
	{ config_id = 3008, monster_id = 24020201, pos = { x = 330.156, y = 154.979, z = 367.269 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 100 }
}
...
function action_EVENT_SELECT_OPTION_3003(context, evt)
	...
	-- 删除指定group： 247207003 ；指定config：3001；物件身上指定option：7；
...
function action_EVENT_VARIABLE_CHANGE_3005(context, evt)
	...
	-- 改变指定group组247207001中， configid为1019的gadget的state
