...
-- 怪物
monsters = {
	{ config_id = 2006, monster_id = 26120201, pos = { x = 243.381, y = 157.414, z = 287.457 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 201 },
	{ config_id = 2007, monster_id = 26090701, pos = { x = 240.472, y = 157.414, z = 287.457 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 2008, monster_id = 26090701, pos = { x = 246.121, y = 157.414, z = 287.554 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 2009, monster_id = 26090501, pos = { x = 237.840, y = 157.485, z = 287.291 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 2010, monster_id = 26090501, pos = { x = 248.632, y = 157.485, z = 287.405 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 2011, monster_id = 20011201, pos = { x = 237.493, y = 157.320, z = 289.782 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 2013, monster_id = 20011201, pos = { x = 249.154, y = 157.320, z = 289.978 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 2014, monster_id = 26091001, pos = { x = 237.493, y = 157.320, z = 292.250 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 2015, monster_id = 26091001, pos = { x = 249.154, y = 157.320, z = 292.447 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 2016, monster_id = 26120301, pos = { x = 243.312, y = 157.136, z = 285.372 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 }
}
...
function action_EVENT_SELECT_OPTION_2003(context, evt)
	...
	-- 刷怪
	    ScriptLib.AutoMonsterTide(context, 1, defs.group_1, {2006,2007,2008,2009,2010,2011,2013,2014,2015,2016}, 10, 5, 5)
	...
	-- 删除指定group： 247207002 ；指定config：2001；物件身上指定option：7；
...
function action_EVENT_VARIABLE_CHANGE_2005(context, evt)
	...
	-- 改变指定group组247207001中， configid为1018的gadget的state
