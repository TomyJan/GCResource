...
-- 怪物
monsters = {
	{ config_id = 10006, monster_id = 25210302, pos = { x = 332.492, y = 179.131, z = 267.135 }, rot = { x = 0.000, y = 315.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 10007, monster_id = 25210401, pos = { x = 330.620, y = 179.017, z = 265.434 }, rot = { x = 0.000, y = 315.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 10008, monster_id = 25210203, pos = { x = 328.984, y = 179.131, z = 263.621 }, rot = { x = 0.000, y = 315.000, z = 0.000 }, level = 1, disableWander = true }
}
...
function action_EVENT_GADGET_CREATE_10002(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 247207010, 10001, {7}) then
...
function action_EVENT_SELECT_OPTION_10003(context, evt)
	...
	ScriptLib.AutoMonsterTide(context, 1, defs.group_1, {10006,10007,10008}, 3, 3, 3)
	...
	-- 删除指定group： 247207010 ；指定config：10001；物件身上指定option：7；
