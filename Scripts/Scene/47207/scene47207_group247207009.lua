...
-- 怪物
monsters = {
	{ config_id = 9006, monster_id = 25030201, pos = { x = 323.080, y = 163.189, z = 482.656 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 9007, monster_id = 25060101, pos = { x = 325.820, y = 163.189, z = 482.542 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 9008, monster_id = 25010201, pos = { x = 320.662, y = 163.189, z = 482.226 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true },
	{ config_id = 9009, monster_id = 25010401, pos = { x = 328.214, y = 163.189, z = 482.241 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true }
}
...
function action_EVENT_GADGET_CREATE_9002(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 247207009, 9001, {7}) then
...
function action_EVENT_SELECT_OPTION_9003(context, evt)
	...
	ScriptLib.AutoMonsterTide(context, 1, defs.group_1, {9006,9007,9008,9009}, 4, 4, 4)
