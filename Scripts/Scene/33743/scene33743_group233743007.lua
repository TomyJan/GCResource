...
-- 怪物
monsters = {
	{ config_id = 7001, monster_id = 20060101, pos = { x = 0.032, y = -0.102, z = -10.087 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 7002, monster_id = 20060401, pos = { x = -2.993, y = -0.102, z = -8.005 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 7003, monster_id = 20060401, pos = { x = 3.023, y = -0.102, z = -8.073 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 7004, monster_id = 20060301, pos = { x = 0.032, y = -0.102, z = -6.075 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 7005, monster_id = 20060201, pos = { x = -8.009, y = -0.102, z = -3.025 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 7006, monster_id = 20060201, pos = { x = -8.000, y = -0.102, z = 4.041 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 7007, monster_id = 20060401, pos = { x = -5.947, y = -0.102, z = -0.002 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 7008, monster_id = 20060101, pos = { x = -9.997, y = -0.102, z = -0.017 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 7009, monster_id = 20060301, pos = { x = 8.023, y = -0.102, z = -3.054 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 7011, monster_id = 20060401, pos = { x = 8.001, y = -0.102, z = 3.063 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 7021, monster_id = 20060201, pos = { x = 10.036, y = -0.102, z = 0.008 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 },
	{ config_id = 7022, monster_id = 20060101, pos = { x = 5.932, y = -0.102, z = 0.002 }, rot = { x = 0.000, y = 270.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 }
}
...
suites = {
	{
		...
		gadgets = { 7010 },
		regions = { },
		triggers = { "MONSTER_TIDE_DIE_7012", "ANY_MONSTER_LIVE_7013", "CHALLENGE_SUCCESS_7014", "CHALLENGE_FAIL_7015" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
		-- description = ,
		monsters = { 7001, 7002, 7003, 7004, 7005, 7006, 7007, 7008, 7009, 7011, 7021, 7022 },
		gadgets = { 7010 },
		regions = { },
		triggers = { },
		rand_weight = 100
...
function action_EVENT_CHALLENGE_SUCCESS_7014(context, evt)
	...
	-- 改变指定group组233743006中， configid为6001的gadget的state
